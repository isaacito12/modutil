classdef uptodateTest_TraceGeneratorApp < matlab.unittest.TestCase
  ...
  methods (Test)
    ...
    function PassingTest_1(~)
      ...
      TraceGeneratorApp_Description_mus1
    end  % function
    ...
    function description_html_is_uptodate(testcase)
      ...
      source_fullpath = mus1.FileUtil.getFileFullPath("TraceGeneratorApp_Description_mus1.mlx");

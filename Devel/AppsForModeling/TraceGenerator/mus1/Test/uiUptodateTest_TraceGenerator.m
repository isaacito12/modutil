classdef uiUptodateTest_TraceGenerator < matlab.uitest.TestCase
  ...
  methods (Test)
    ...
    function app_screenshot_1_dark(testcase)
      ...
      % R2025a or newer
      keyword = "TraceGenerator";
      source_fullpath = mus1.FileUtil.getFileFullPath("mus1.SignalUtil.TraceGeneratorAppMain");
      ...
      if needs_update
        app = mus1.SignalUtil.TraceGeneratorAppMain;  % !screenshot-target

classdef uiTest_TraceGeneratorAppMain < matlab.uitest.TestCase
  ...
  methods (Test)
    ...
    function clean_launch_1(testcase)
      verifyWarningFree(testcase, @mus1.SignalUtil.TraceGeneratorAppMain)
    end  % function
    ...
    function Test_1(testcase)
      ...
      if mus1.TestUtil.isR2024bOrOlder
        ...
        model_name = "TraceGeneratorAppMain_SampleModel_24b";
      else
        % R2025a or newer
        model_name = "TraceGeneratorAppMain_SampleModel";
      end  % if

      app = mus1.SignalUtil.TraceGeneratorAppMain( ...

classdef SignalDesignAppMain < handle
  ...
  properties
    ...
    MatrixTextUI AppUtil1.Component.TextArea
  ...
  properties (Constant, Access=private)
    ...
    name_ui_width = AppUtil1.Constant.Width{"unitwidth"} * 18
  ...
  methods
    ...
    function App = SignalDesignAppMain(NameValuePair)
      ...
      arguments (Output)
        App SignalUtil1.SignalDesignAppMain
      end  % arguments
    ...
    function build_app_gui(App)
      ...
      % -----------------------------------------------------------------------
      row = NewRow(layout, column);
      App.MatrixTextUI = AppUtil1.Component.TextArea(NewSlot(layout, row));
      ...
      App.InterpUI= AppUtil1.Component.DropDown(NewSlot(layout, row));
      ...
      App.ExtrapUI= AppUtil1.Component.DropDown(NewSlot(layout, row));
      ...
      % -----------------------------------------------------------------------
      row = NewRow(layout, column);
      App.AutoRangeUI = AppUtil1.Component.CheckBox(NewSlot(layout, row));
      ...
      % -----------------------------------------------------------------------
      row = NewRow(layout, column);
      App.LowerUI = AppUtil1.Component.PhysicalValueUI(NewSlot(layout, row));
      ...
      % -----------------------------------------------------------------------
      row = NewRow(layout, column);
      App.UpperUI = AppUtil1.Component.PhysicalValueUI(NewSlot(layout, row));
    ...
    function change_design_matrix(App)
      ...
      App.TableGridVectorUI.Value = CodeUtil1.stringify(result.X');
      App.TableValuesUI.Value = CodeUtil1.stringify(result.F');
    ...
    function update_plot(App, NameValuePair)
      ...
      if App.AutoRangeUI.Value
        vec = CodeUtil1.getNumberArrayFromString(App.TableGridVectorUI.Value);
        lb = vec(1);
        ub = vec(end);

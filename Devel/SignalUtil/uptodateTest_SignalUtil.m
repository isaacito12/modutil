classdef uptodateTest_SignalUtil < matlab.unittest.TestCase
  ...
  methods (Test)
    ...
    function html_with_code_is_uptodate_1(testcase)
      ...
      source_fullpath = FileUtil1.getFileFullPath("SignalDesignApp_Description.mlx");
      destination_fullpath = FileUtil1.getFileFullPath("SignalDesignApp_Description.html");
    ...
    function html_with_code_is_uptodate_2(testcase)
      ...
      source_fullpath = FileUtil1.getFileFullPath("TraceGeneratorApp_Description.mlx");

...
arguments (Input)
  ...
  NameValuePair.DataSet mus1.app.AbstractMotorEfficiency.AbstractMotorEfficiencyDataSet {mustBeScalarOrEmpty}
  ...
  NameValuePair.MaxTorque (1,1) simscape.Value ...
    { simscape.mustBeCommensurateUnit(NameValuePair.MaxTorque, "N*m"), mus1.CodeUtil.mustBeSimscapeValuePositiveOrNan } ...
    = simscape.Value(160, "N*m")

  NameValuePair.PlotTorqueUpperBound simscape.Value ...
    { simscape.mustBeCommensurateUnit(NameValuePair.PlotTorqueUpperBound, "N*m"), mus1.CodeUtil.mustBeSimscapeValuePositiveOrNan } ...
  ...
  NameValuePair.MaxAngularSpeed (1,1) simscape.Value ...
    { simscape.mustBeCommensurateUnit(NameValuePair.MaxAngularSpeed, "rad/s"), mus1.CodeUtil.mustBeSimscapeValuePositiveOrNan } ...
  ...
  NameValuePair.PlotAngularSpeedUpperBound simscape.Value ...
    { simscape.mustBeCommensurateUnit(NameValuePair.PlotAngularSpeedUpperBound, "rad/s"), mus1.CodeUtil.mustBeSimscapeValuePositiveOrNan } ...
    = simscape.Value(18000, "rpm")

  % --- power and others

  NameValuePair.MaxPower (1,1) simscape.Value ...
    { simscape.mustBeCommensurateUnit(NameValuePair.MaxPower, "kW"), mus1.CodeUtil.mustBeSimscapeValuePositiveOrNan } ...
  ...
  NameValuePair.MeasuredAngularSpeed (1,1) simscape.Value ...
    { simscape.mustBeCommensurateUnit(NameValuePair.MeasuredAngularSpeed, "rpm"), mus1.CodeUtil.mustBeSimscapeValuePositiveOrNan } ...
    = simscape.Value(2000, "rpm")

  NameValuePair.MeasuredTorque (1,1) simscape.Value ...
    { simscape.mustBeCommensurateUnit(NameValuePair.MeasuredTorque, "N*m"), mus1.CodeUtil.mustBeSimscapeValuePositiveOrNan } ...
    = simscape.Value(50, "N*m")

  NameValuePair.MeasuredIronLosses (1,1) simscape.Value ...
    { simscape.mustBeCommensurateUnit(NameValuePair.MeasuredIronLosses, "W"), mus1.CodeUtil.mustBeSimscapeValueNonnegativeOrNan } ...
    = simscape.Value(55, "W")

  NameValuePair.FixedLosses (1,1) simscape.Value ...
    { simscape.mustBeCommensurateUnit(NameValuePair.FixedLosses, "W"), mus1.CodeUtil.mustBeSimscapeValueNonnegativeOrNan } ...
    = simscape.Value(40, "W")
  ...
  NameValuePair.PlotPowers (1,:) simscape.Value ...
    { simscape.mustBeCommensurateUnit(NameValuePair.PlotPowers, "kW"), mus1.CodeUtil.mustBeSimscapeValueNonnegativeOrNan } ...
...
if NameValuePair.DataSource == "direct"
  ...
  if NameValuePair.ElectricalEfficiencyPercent > NameValuePair.IdealMotorThresholdPercent
    ...
    if measured_copper_losses_W < 0
      ...
      msg = mus1.CodeUtil.i18n("The sum of iron losses and fixed losses cannot be greater than nominal losses.");
      throw(MException(id, msg))
    end
  ...
  if isfield(NameValuePair, "DataSet")
    ...
    DataSet = mus1.app.AbstractMotorEfficiency.AbstractMotorEfficiencyDataSet(Initialization=true);
  end  % if
...
if is_ideal_motor
  ylabel(ax, mus1.CodeUtil.i18n("Torque, \tau, (" + plot_torque_unit_text + ")"), Interpreter="tex")
  title_text = mus1.CodeUtil.i18n("Motor operating region");
  ...
  ylabel(ax, mus1.CodeUtil.i18n("Electrical torque, \tau, (" + plot_torque_unit_text + ")"), Interpreter="tex")

  title_text = mus1.CodeUtil.i18n("Electrical efficiency (%)");

  second_line_text = mus1.CodeUtil.i18n("Measurement point (X): ") ...
...
xlabel(ax, mus1.CodeUtil.i18n("Angular speed, \omega (" + plot_speed_unit_text + ")"), Interpreter="tex")

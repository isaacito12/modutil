classdef Vehicle1DForceModelParameters
  ...
  properties
    ...
    VehicleMass (1,1) simscape.Value ...
      { simscape.mustBeCommensurateUnit(VehicleMass, "kg"), mus1.CodeUtil.mustBeSimscapeValuePositiveOrNan } ...
      = simscape.Value(nan, "kg")

    % Tire rolling radius
    TireRollingRadius (1,1) simscape.Value ...
      { simscape.mustBeCommensurateUnit(TireRollingRadius, "m"), mus1.CodeUtil.mustBeSimscapeValuePositiveOrNan } ...
      = simscape.Value(nan, "m")

    % Tire rolling coefficient
    TireRollingCoefficient (1,1) double { mus1.CodeUtil.mustBePositiveOrNan } = nan

    % Air drag coefficient
    AirDragCoefficient (1,1) double { mus1.CodeUtil.mustBePositiveOrNan } = nan

    % Frontal area
    FrontalArea (1,1) simscape.Value ...
      { simscape.mustBeCommensurateUnit(FrontalArea, "m^2"), mus1.CodeUtil.mustBeSimscapeValuePositiveOrNan } ...
      = simscape.Value(nan, "m^2")

    % Gravitational acceleration
    GravitationalAcceleration (1,1) simscape.Value ...
      { simscape.mustBeCommensurateUnit(GravitationalAcceleration, "m/s^2"), mus1.CodeUtil.mustBeSimscapeValuePositiveOrNan } ...
      = simscape.Value(nan, "m/s^2")

    % Dry air density
    DryAirDensity (1,1) simscape.Value ...
      { simscape.mustBeCommensurateUnit(DryAirDensity, "kg/m^3"), mus1.CodeUtil.mustBeSimscapeValuePositiveOrNan } ...
    ...
    RoadLoadB (1,1) simscape.Value ...
      { simscape.mustBeCommensurateUnit(RoadLoadB, "N/(m/s)"), mus1.CodeUtil.mustBeSimscapeValueNonnegativeOrNan } ...
    ...
    TopSpeed (1,1) simscape.Value ...
      { simscape.mustBeCommensurateUnit(TopSpeed, "m/s"),  mus1.CodeUtil.mustBeSimscapeValuePositiveOrNan } ...
      = simscape.Value(nan, "km/hr")

    % Vehicle's maximum acceleration
    MaxAcceleration (1,1) double { mus1.CodeUtil.mustBePositiveOrNan } = nan
    ...
    MaxClimbPower (1,1) simscape.Value ...
      { simscape.mustBeCommensurateUnit(MaxClimbPower, "kW"), mus1.CodeUtil.mustBeSimscapeValuePositiveOrNan } ...
      = simscape.Value(nan, "kW")

    % Vehicle's maximum driving force
    MaxForce (1,1) simscape.Value ...
      { simscape.mustBeCommensurateUnit(MaxForce, "N"), mus1.CodeUtil.mustBeSimscapeValuePositiveOrNan } ...
    ...
    RoadLoadA (1,1) simscape.Value ...
      { simscape.mustBeCommensurateUnit(RoadLoadA, "N"), mus1.CodeUtil.mustBeSimscapeValuePositiveOrNan } ...
      = simscape.Value(nan, "N")

    % The road-load coefficient C
    RoadLoadC (1,1) simscape.Value ...
      { simscape.mustBeCommensurateUnit(RoadLoadC, "N/(m/s)^2"), mus1.CodeUtil.mustBeSimscapeValuePositiveOrNan } ...

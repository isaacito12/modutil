...
if BlockPath == "" || not(contains(BlockPath, "/"))
  ...
  msg = mus1.CodeUtil.i18n("Empty block path is not allowed.");
...
if block_type ~= "SimscapeBlock" && block_type ~= "SimscapeComponentBlock"
  ...
  msg = mus1.CodeUtil.i18n("Specified block is not a Simscape block: ") + BlockPath;
...
if all(size(mask_params) == [0 0])
  ...
  msg = mus1.CodeUtil.i18n("Selected Simscape block has no parameters.");

classdef FolderSearchResultAppMain < handle
  ...
  methods
    ...
    function App = FolderSearchResultAppMain(NameValuePair)
      ...
      App.Window.Name = mus1.CodeUtil.i18n("Folder search result");
    ...
    function build_app_gui(App)
      ...
      App.NewSearchButtonUI.MainButton.Tooltip = mus1.CodeUtil.i18n("Open the folder search app.");
      ...
      label_ui = mus1.AppUtil.Component.Label(addHorizontalGridLayout(h_container, Width="fit"));
      label_ui.ComponentWidth = App.width_name_ui;
      label_ui.Text = mus1.CodeUtil.i18n("Searched folder name");
      ...
      label_ui = mus1.AppUtil.Component.Label(addHorizontalGridLayout(h_container, Width="fit"));
      label_ui.ComponentWidth = App.width_name_ui;
      label_ui.Text = mus1.CodeUtil.i18n("Top folder");
      ...
      label_ui = mus1.AppUtil.Component.Label(addHorizontalGridLayout(h_container, Width="fit"));
      label_ui.ComponentWidth = App.width_name_ui;
      label_ui.Text = mus1.CodeUtil.i18n("Number of matches");
      ...
      App.RefreshButtonUI = mus1.AppUtil.Component.Button(addHorizontalGridLayout(h_container, Width="fit"));
      App.RefreshButtonUI.ButtonWidth = App.width_button;
      App.RefreshButtonUI.Text = mus1.CodeUtil.i18n("Refresh");
      App.RefreshButtonUI.MainButton.Tooltip = mus1.CodeUtil.i18n("Rerun search and update the result table.");
      ...
      label_ui.Text = mus1.CodeUtil.i18n("Double-click a table row to change to the folder.");
      ...
      if App.SearchResult ~= ""
        ...
        App.TableUI.MainTable.ColumnName = mus1.CodeUtil.i18n("Folder path");
    ...
    function react_NewSearch(App)
      if App.TopFolder ~= "" && App.SearchFolderName ~= ""
        mus1.SearchUtil.FolderSearchAppMain(TopFolder=App.TopFolder, SearchFolderName=App.SearchFolderName)
      else
        mus1.SearchUtil.FolderSearchAppMain
      end  % if
    end  % function

    function react_RefreshButtonPushed(App)
      FolderPath = mus1.SearchUtil.searchFolders(App.SearchFolderName, TopFolder=App.TopFolder);

...
if num_files == 0
  ...
  msg = mus1.CodeUtil.i18n("One or more files must be specified.");
...
if not(isfield(NameValuePair, "TextPattern"))
  ...
  msg = mus1.CodeUtil.i18n("Text pattern must be specified.");
...
if not(isfield(NameValuePair, "NewText"))
  ...
  msg = mus1.CodeUtil.i18n("New text must be specified.");

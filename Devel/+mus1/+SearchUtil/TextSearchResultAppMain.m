classdef TextSearchResultAppMain < handle
  ...
  properties
    TextSearcher (1,1) mus1.SearchUtil.TextSearcher
    SearchResult table
    ...
    NewSearchButtonUI mus1.AppUtil.Component.Button
    CopyReplaceCommandTextUI mus1.AppUtil.Component.Button
    NewTextUI mus1.AppUtil.Component.DropDown
    NumMatchesUI mus1.AppUtil.Component.EditField
    TableUI mus1.AppUtil.Component.Table
  end  % properties
  ...
  methods
    ...
    function App = TextSearchResultAppMain(Searcher, NameValuePair)
      ...
      arguments (Input)
        Searcher (1,1) mus1.SearchUtil.TextSearcher = mus1.SearchUtil.TextSearcher(Initialization="default")
      ...
      if not(ready(Searcher))
        ...
        msg = mus1.CodeUtil.i18n("TextSearcher must be initialized.");
      ...
      App.Window.Name = mus1.CodeUtil.i18n("Text search result");
    ...
    function build_app_gui(App)
      ...
      label_ui = mus1.AppUtil.Component.Label(addHorizontalGridLayout(h_container, Width="fit"));
      label_ui.ComponentWidth = App.width_name_ui;
      label_ui.Text = "\textbf{" + mus1.CodeUtil.i18n("Search conditions") + "}";

      App.NewSearchButtonUI = mus1.AppUtil.Component.Button(addHorizontalGridLayout(h_container));
      App.NewSearchButtonUI.ButtonWidth = App.width_button;
      App.NewSearchButtonUI.HorizontalAlignment = "right";
      App.NewSearchButtonUI.Text = mus1.CodeUtil.i18n("New search");
      App.NewSearchButtonUI.MainButton.Tooltip = mus1.CodeUtil.i18n("Open the text search app.");
      ...
      label_ui = mus1.AppUtil.Component.Label(addHorizontalGridLayout(h_container, Width="fit"));
      label_ui.ComponentWidth = App.width_name_ui;
      label_ui.Text = mus1.CodeUtil.i18n("Searched text");

      editfield_ui = mus1.AppUtil.Component.EditField(addHorizontalGridLayout(h_container));
      ...
      indent_ui = mus1.AppUtil.Component.Label(addHorizontalGridLayout(h_container, Width="fit"));
      indent_ui.ComponentWidth = App.width_name_ui;
      indent_ui.Text = "";

      label_ui = mus1.AppUtil.Component.Label(addHorizontalGridLayout(h_container));
      if App.TextSearcher.States.IgnoreCase
        label_ui.Text = mus1.CodeUtil.i18n("Case ignored");
      else
        label_ui.Text = mus1.CodeUtil.i18n("Case sensitive");
      end  % if
      ...
      if App.TextSearcher.States.MatchWholeWord
        label_ui.Text = mus1.CodeUtil.i18n("Match whole word");
      else
        label_ui.Text = mus1.CodeUtil.i18n("Match anywhere");
      end  % if
      ...
      label_ui = mus1.AppUtil.Component.Label(addHorizontalGridLayout(h_container, Width="fit"));
      label_ui.ComponentWidth = App.width_name_ui;
      label_ui.Text = mus1.CodeUtil.i18n("File types");
      ...
      if App.TextSearcher.States.IncludeSubfolders
        label_ui.Text = mus1.CodeUtil.i18n("Including subfolders");
      else
        label_ui.Text = mus1.CodeUtil.i18n("Excluding subfolders");
      end

      % =======================================================================
      v_layout = addVerticalGridLayout(main_v_container);
      mus1.AppUtil.Component.HorizontalLine(v_layout);
      ...
      label_ui = mus1.AppUtil.Component.Label(addHorizontalGridLayout(h_container, Width="fit"));
      label_ui.ComponentWidth = App.width_name_ui;
      label_ui.Text = "\textbf{" + mus1.CodeUtil.i18n("Replace") + "}";

      App.CopyReplaceCommandTextUI = mus1.AppUtil.Component.Button(addHorizontalGridLayout(h_container));
      App.CopyReplaceCommandTextUI.ButtonWidth = App.width_button;
      App.CopyReplaceCommandTextUI.HorizontalAlignment = "right";
      App.CopyReplaceCommandTextUI.Text = mus1.CodeUtil.i18n("Copy command");
      App.CopyReplaceCommandTextUI.MainButton.Tooltip = mus1.CodeUtil.i18n("Copy the replace command to clipboard.");
      ...
      label_ui = mus1.AppUtil.Component.Label(addHorizontalGridLayout(h_container, Width="fit"));
      label_ui.ComponentWidth = App.width_name_ui;
      label_ui.Text = mus1.CodeUtil.i18n("New text");

      App.NewTextUI = mus1.AppUtil.Component.DropDown(addHorizontalGridLayout(h_container));
      ...
      label_ui = mus1.AppUtil.Component.Label(addHorizontalGridLayout(h_container, Width="fit"));
      label_ui.ComponentWidth = App.width_name_ui;
      label_ui.Text = mus1.CodeUtil.i18n("Number of matched lines");

      App.NumMatchesUI = mus1.AppUtil.Component.EditField(addHorizontalGridLayout(h_container, Width="1x"));
      App.NumMatchesUI.ReadOnly = "on";
      App.NumMatchesUI.Value = string(height(App.SearchResult));

      button_ui = mus1.AppUtil.Component.Button(addHorizontalGridLayout(h_container, Width="fit"));
      button_ui.ButtonWidth = App.width_button;
      button_ui.Text = mus1.CodeUtil.i18n("Refresh");
      button_ui.MainButton.Tooltip = mus1.CodeUtil.i18n("Rerun search and update the result table.");
      ...
      App.TableUI = mus1.AppUtil.Component.Table(v_layout);
      ...
      App.TableUI.MainTable.ColumnName = [mus1.CodeUtil.i18n("File path"), mus1.CodeUtil.i18n("Line number"), mus1.CodeUtil.i18n("Line text")];
    ...
    function react_NewSearch(App)
      mus1.SearchUtil.TextSearchAppMain(StatesSource="external", SearchStates=App.TextSearcher.States)
    end  % function
    ...
    function react_CopyReplaceCommandButtonPushed(App)
      ...
      %   result = mus1.SearchUtil.replaceText(file_paths, DryRun=true, TextPattern="old", NewText="new");
      ...
      assert(iscolumn(file_paths), App.errorID+"InternalError", mus1.CodeUtil.i18n("Internal error"))
      assert(all(isfile(file_paths)), App.errorID+"InternalError", mus1.CodeUtil.i18n("Internal error"))

      code_lines = mus1.SearchUtil.buildReplaceCommandText( ...

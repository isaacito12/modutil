classdef TestResultAppMain < handle
  ...
  properties
    ...
    SelectFileButtonUI mus1.AppUtil.Component.Button
    OpenInEditorButtonUI mus1.AppUtil.Component.Button
    TestResultFileDropDownUI mus1.AppUtil.Component.DropDown

    NumTestsUI mus1.AppUtil.Component.Label
    TotalTimeUI mus1.AppUtil.Component.Label
    MeanTimeUI mus1.AppUtil.Component.Label
    MedianTimeUI mus1.AppUtil.Component.Label

    NumErrorsUI mus1.AppUtil.Component.Label

    RefreshButtonUI mus1.AppUtil.Component.Button

    ResultTableUI mus1.AppUtil.Component.Table

    MessageUI mus1.AppUtil.Component.Label
  end  % properties
  ...
  methods
    ...
    function App = TestResultAppMain(NameValuePair)
      ...
      App.Window.Name = mus1.CodeUtil.i18n("Test result");
      ...
      elseif isfile(NameValuePair.TestResultFileName)
        ...
        msg = mus1.CodeUtil.i18n("Invalid file: ") + NameValuePair.TestResultFileName;
    ...
    function build_app_gui(App)
      ...
      label_ui.ComponentWidth = mus1.AppUtil.Constant.Width{"unitwidth"} * 14;
      label_ui.Text = "\textbf{" + mus1.CodeUtil.i18n("Test result file") + "}";

      row_grid = addHorizontalGridLayout(horizontal_container, Width="fit");
      App.SelectFileButtonUI = mus1.AppUtil.Component.Button(row_grid);
      App.SelectFileButtonUI.ButtonWidth = App.width_button;
      App.SelectFileButtonUI.Text = mus1.CodeUtil.i18n("Select...");
      App.SelectFileButtonUI.MainButton.Tooltip = mus1.CodeUtil.i18n("Select a test result file.");
      App.SelectFileButtonUI.ButtonPushedCallback = @() react_SelectResultFileButtonPushed(App);

      row_grid = addHorizontalGridLayout(horizontal_container, Width="fit");
      App.OpenInEditorButtonUI = mus1.AppUtil.Component.Button(row_grid);
      App.OpenInEditorButtonUI.ButtonWidth = App.width_button;
      App.OpenInEditorButtonUI.Text = mus1.CodeUtil.i18n("Open in editor");
      App.OpenInEditorButtonUI.MainButton.Tooltip = mus1.CodeUtil.i18n("Open the test result file in the editor.");
      ...
      App.TestResultFileDropDownUI = mus1.AppUtil.Component.DropDown(column_grid);
      ...
      App.NumTestsUI = mus1.AppUtil.Component.Label(row_grid);
      App.NumTestsUI.Text = "";
      ...
      row_grid = addHorizontalGridLayout(horizontal_container);
      App.TotalTimeUI = mus1.AppUtil.Component.Label(row_grid);
      App.TotalTimeUI.Text = "";

      row_grid = addHorizontalGridLayout(horizontal_container, Width="fit");
      label_ui = mus1.AppUtil.Component.Label(row_grid);
      label_ui.Text = mus1.CodeUtil.i18n("Mean test time (s)");
      row_grid = addHorizontalGridLayout(horizontal_container);
      App.MeanTimeUI = mus1.AppUtil.Component.Label(row_grid);
      App.MeanTimeUI.Text = "";
      ...
      row_grid = addHorizontalGridLayout(horizontal_container);
      App.MedianTimeUI = mus1.AppUtil.Component.Label(row_grid);
      ...
      row_grid = addHorizontalGridLayout(horizontal_container, Width="fit");
      label_ui = mus1.AppUtil.Component.Label(row_grid);
      label_ui.Text = mus1.CodeUtil.i18n("Number of failures");
      row_grid = addHorizontalGridLayout(horizontal_container);
      App.NumErrorsUI = mus1.AppUtil.Component.Label(row_grid);
      ...
      row_grid = addHorizontalGridLayout(horizontal_container, Width="fit");
      App.RefreshButtonUI = mus1.AppUtil.Component.Button(row_grid);
      App.RefreshButtonUI.Text = mus1.CodeUtil.i18n("Refresh");
      ...
      App.ResultTableUI = mus1.AppUtil.Component.Table(column_grid);
      ...
      App.MessageUI = mus1.AppUtil.Component.Label(column_grid);
      App.MessageUI.Text = mus1.CodeUtil.i18n("Double-click a table row to open the file.");
    ...
    function react_ResultFileNameDropDownChanged(App)
      ...
      if new_styled_path == ""
        ...
        if not(isfile(raw_path))
          msg = mus1.CodeUtil.i18n("Invalid file: " + raw_path);
          if App.GUIReady
    ...
    function react_TableRowDoubleClicked(App, row_number)
      ...
      targetfile_fullpath = mus1.FileUtil.getFileFullPath(targetfile_filename, ReturnIfNotFound=true);

      if targetfile_fullpath == ""
        App.MessageUI.Text = mus1.CodeUtil.i18n("File not found.");
    ...
    function update_ui(App)
      result_table = mus1.TestUtil.getTestResultTable(App.TestResultFile);

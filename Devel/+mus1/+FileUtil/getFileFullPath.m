...
if FileName == ""
  ...
  msg = mus1.CodeUtil.i18n("Empty file name is not allowed.");
...
if numel(found_paths) == 0 || (isscalar(found_paths) && found_paths == "")
  ...
  msg = mus1.CodeUtil.i18n("File was not found: ") + FileName;
...
if ischar(FileFullPath) || (isstring(FileFullPath) && isscalar(FileFullPath))
  ...
  msg = mus1.CodeUtil.i18n("There are two or more matches: ") + numel(FileFullPath);

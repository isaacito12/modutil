classdef Image < mus1.AppUtil.Component.ComponentBase
  % Image component
  %
  ...
  properties
    ...
    ImageClickedCallback {mus1.CodeUtil.mustBeFunctionHandleOrEmpty} = []

    ComponentWidth (1,:) {mus1.CodeUtil.mustBeTextOrPositiveNumber} = "1x"
    ImageWidth (1,:) {mus1.CodeUtil.mustBeTextOrPositiveNumber} = 18
    ...
    ImageHeight (1,:) {mus1.CodeUtil.mustBeTextOrPositiveNumber} = 18

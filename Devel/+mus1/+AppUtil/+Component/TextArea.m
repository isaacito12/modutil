classdef TextArea < mus1.AppUtil.Component.ComponentBase
  % Text area component
  ...
  properties
    ...
    ComponentWidth (1,1) {mus1.CodeUtil.mustBeStringOrPositiveInteger} = "1x"

    ComponentHeight (1,1) {mus1.CodeUtil.mustBeStringOrPositiveInteger} = "fit"

classdef WindowHeader < mus1.AppUtil.Component.ComponentBase
  ...
  properties
    ...
    AppName (1,1) string = mus1.CodeUtil.i18n("App")
    ...
    AppNameUI mus1.AppUtil.Component.Label
    SourceLinkUI mus1.AppUtil.Component.Hyperlink
    AlwaysOnTopUI mus1.AppUtil.Component.CheckBox
  ...
  properties (Constant)
    common_height = mus1.AppUtil.Constant.Height{"oneline++"}
  end  % properties
  ...
  methods (Access=protected)
    ...
    function setup(component)
      ...
      if component.Reporting
        ...
        mus1.FileUtil.displayTimeAndFileLocation("Within setup")
      end  % if
      ...
      component.AppNameUI = mus1.AppUtil.Component.Label(component.base_grid);
      ...
      component.SourceLinkUI = mus1.AppUtil.Component.Hyperlink(component.base_grid);
      ...
      component.AlwaysOnTopUI = mus1.AppUtil.Component.CheckBox(component.base_grid);
    ...
    function regular_update(component)
      ...
      if component.Reporting
        ...
        mus1.FileUtil.displayTimeAndFileLocation("component.AppName: " + component.AppName)
      end  % if

      % AppName can be defined by the user, first as the Name property of mus1.AppUtil.AppWindow.
      % Then it is passed to the AppName property of this class.
      % Because mus1.AppUtil.AppWindow class is a regular MATLAB class, not a child class of
    ...
    function first_update(component)
      ...
      if not(component.UseCheckBoxForAlwaysOnTop)
        if component.Reporting
          mus1.FileUtil.displayTimeAndFileLocation("not creating always-on-top check box")
        end  % if
        checkbox_ui_width = 0;
        ...
        if isempty(component.MainFigure)
          ...
          component.AlwaysOnTopUI.MainCheckBox.Tooltip = mus1.CodeUtil.i18n("Main figure is not defined.");
        else
  ...
  methods
    ...
    function valid = check_AlwaysOnTopUI_IsValid(component)
      ...
      if not(isvalid(component.AlwaysOnTopUI))
        % ignore
        if component.Reporting
          mus1.FileUtil.displayTimeAndFileLocation("invalid because always-on-top check box was not created")
        end  % if
        valid = false;
      ...
      if isempty(component.MainFigure)
        if component.Reporting
          mus1.FileUtil.displayTimeAndFileLocation("invalid because MainFigure is empty")
        end  % if
        valid = false;
    ...
    function configureWindowStyle(component, alwasy_on_top)
      ...
      if alwasy_on_top
        ...
        if component.Reporting
          mus1.FileUtil.displayTimeAndFileLocation("MainFigure.WindowStyle: alwaysontop")
        end  % if
      else
        component.MainFigure.WindowStyle = "normal";
        if component.Reporting
          mus1.FileUtil.displayTimeAndFileLocation("MainFigure.WindowStyle: normal")
        end  % if
      end  % if
    end  % function

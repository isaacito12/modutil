classdef Hyperlink < mus1.AppUtil.Component.ComponentBase
  % Hyperlink component
  ...
  properties
    ...
    HyperlinkClickedCallback {mus1.CodeUtil.mustBeFunctionHandleOrEmpty} = []

    ComponentWidth (1,:) {mus1.CodeUtil.mustBeTextOrPositiveNumber} = "1x";
    HyperlinkWidth (1,:) {mus1.CodeUtil.mustBeTextOrPositiveNumber} = "fit";

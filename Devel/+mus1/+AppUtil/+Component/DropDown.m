classdef DropDown < mus1.AppUtil.Component.ComponentBase
  % Drop down component
  %
  ...
  properties
    ...
    DropDownWidth (1,:) {mus1.CodeUtil.mustBeTextOrPositiveNumber} = "1x"
    ...
    DropDownHeight (1,:) {mus1.CodeUtil.mustBeTextOrPositiveNumber} = mus1.AppUtil.Constant.Height{"oneline+"} - 2

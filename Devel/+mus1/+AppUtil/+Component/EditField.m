classdef EditField < mus1.AppUtil.Component.ComponentBase
  ...
  properties
    ...
    EditFieldHeight (1,:) {mus1.CodeUtil.mustBeTextOrPositiveNumber} = mus1.AppUtil.Constant.Height{"oneline+"}

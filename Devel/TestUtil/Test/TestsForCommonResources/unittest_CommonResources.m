classdef unittest_CommonResources < matlab.uitest.TestCase
  ...
  methods (Test)
    ...
    function test_load_model_1(~)
      model_name = "TestUtil_common_model_empty";
      load_system(model_name)
    end  % function

    function test_load_model_2(~)
      model_name = "TestUtil_common_model_SimscapeBlocks";
      load_system(model_name)
    end  % function

classdef ui_uptodate_test_TestUtil < matlab.uitest.TestCase
  ...
  methods (Test)
    ...
    function app_screenshot_is_uptodate_1_1_dark(testcase)
      %%
      source_fullpath = FileUtil1.getFileFullPath("TestResultApp.m");

      theme_name = "dark";
      destination_filename = "screenshot-TestResultApp-" + theme_name + ".png";
      ...
      if needs_update
        ...
        testcase.App = TestResultApp("sample-test-result.xml");  % !screenshot-target

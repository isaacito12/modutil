  ...
  methods (Test)
    ...
    function Error_1(testcase)
      ...
      function test_target
        mus1.ModelUtil.findSimscapeBlocks  % !test-target
      end  % nested function
    end  % function
    ...
    function Error_2(testcase)
      ...
      function test_target
        mus1.ModelUtil.findSimscapeBlocks("dummy")  % !test-target
      end  % nested function
    end  % function
    ...
    function Error_3(testcase)
      ...
      function test_target
        mus1.ModelUtil.findSimscapeBlocks("EmptyModel_findSimscapeBlocks_24b", "Mass")  % !test-target
      end  % nested function
    end  % function
    ...
    function Error_4(testcase)
      ...
      function test_target
        mus1.ModelUtil.findSimscapeBlocks("DemoModel_findSimscapeBlocks_1_24b", "Inertia")  % !test-target
      end  % nested function
    end  % function
    ...
    function Test_1(testcase)
      ...
      actual_block_paths = mus1.ModelUtil.findSimscapeBlocks(model_name, "Mass");  % !test-target
    ...
    function Test_2(testcase)
      ...
      actual_block_paths = mus1.ModelUtil.findSimscapeBlocks(model_name, ["Mass", "Demo component"]);  % !test-target

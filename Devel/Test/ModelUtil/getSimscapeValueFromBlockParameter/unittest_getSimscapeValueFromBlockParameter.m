classdef unittest_getSimscapeValueFromBlockParameter < matlab.unittest.TestCase
  ...
  methods (Test)
    ...
    function ErrorTest_1(testcase)
      ...
      function test_target()
        mus1.ModelUtil.getSimscapeValueFromBlockParameter
      end  % nested function
    end  % function
    ...
    function ErrorTest_2(testcase)
      ...
      function test_target()
        mus1.ModelUtil.getSimscapeValueFromBlockParameter("dummy_model_name")
      end  % nested function
    end  % function

    function PassingTest_1(~)
      DemoScript_getSimscapeValueFromBlockParameter_24b
    end  % function
    ...
    function PassingTest_2(~)
      ...
      demo_getSimscapeValueFromBlockParameter  % !test-target
    end  % function

  ...
  methods (Test)
    ...
    function ErrorTest_1(testcase)
      ...
      function test_target()
        mus1.ModelUtil.findLookupTable1DBlocks("dummy_model_name")
      end  % nested function
    end  % function
    ...
    function PassingTest_1(~)
      ...
      mus1.ModelUtil.findLookupTable1DBlocks;  % !test-target
    end  % function
    ...
    function PassingTest_2(~)
      ...
      load_system(model_name)
      mus1.ModelUtil.findLookupTable1DBlocks(gcs);  % !test-target
    end  % function
    ...
    function PassingTest_3(~)
      ...
      load_system(model_name)
      mus1.ModelUtil.findLookupTable1DBlocks(gcs + "/Subsystem");  % !test-target
    end  % function
    ...
    function TestDefault(testcase)
      ...
      load_system(model_name)
      blocks = mus1.ModelUtil.findLookupTable1DBlocks;  % !test-target
    ...
    function TestSubsystemPath(testcase)
      ...
      load_system(model_name)
      blocks = mus1.ModelUtil.findLookupTable1DBlocks(gcs + "/Subsystem");  % !test-target
    ...
    function TestSearchDepth(testcase)
      ...
      load_system(model_name)
      blocks = mus1.ModelUtil.findLookupTable1DBlocks(gcs + "/Subsystem", SearchDepth=1);

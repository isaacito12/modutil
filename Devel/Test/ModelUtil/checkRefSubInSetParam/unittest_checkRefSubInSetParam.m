  ...
  methods (Test)
    ...
    function ErrorTest_1(testcase)
      ...
      function test_target()
        ...
        mus1.ModelUtil.checkRefSubInSetParam  % !test-target
      end  % nested function
    end  % function
    ...
    function ErrorTest_2(testcase)
      ...
      function test_target()
        ...
        mus1.ModelUtil.checkRefSubInSetParam( ...
    ...
    function Test_1(testcase)
      result = mus1.ModelUtil.checkRefSubInSetParam("");  % !test-target
      verifyTrue(testcase, isempty(result))
    end  % function

    function Test_2(testcase)
      result = mus1.ModelUtil.checkRefSubInSetParam(repmat("This code text has no matching lines.", 3, 1));
      verifyTrue(testcase, isempty(result))
    end  % function
    ...
    function Test_3(testcase)
      ...
      result = mus1.ModelUtil.checkRefSubInSetParam(code_text);
      if mus1.TestUtil.isR2024bOrOlder

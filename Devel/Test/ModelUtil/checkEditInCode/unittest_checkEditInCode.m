  ...
  methods (Test)
    ...
    function ErrorTest_1(testcase)
      ...
      function test_target()
        ...
        mus1.ModelUtil.checkEditInCode  % !test-target
      end  % nested function
    end  % function
    ...
    function ErrorTest_3(testcase)
      ...
      function test_target()
        ...
        mus1.ModelUtil.checkEditInCode( ...
    ...
    function Test_1(testcase)
      result = mus1.ModelUtil.checkEditInCode(repmat("This code text has no matching lines.", 3, 1));
      verifyTrue(testcase, isempty(result))
    end  % function

    function Test_2(testcase)
      % name-value pair, double quotes
      result = mus1.ModelUtil.checkEditInCode("edit(""demo_checkEditInCode"")");
    ...
    function Test_3(testcase)
      % name-value pair, double quotes
      result = mus1.ModelUtil.checkEditInCode("edit(""mus1.ModelUtil.checkEditInCode"")");
      verifyEqual(testcase, result.ArgumentPassedToEdit, "mus1.ModelUtil.checkEditInCode")
      verifyEqual(testcase, result.Found, true)
    end  % function

  ...
  methods (Test)
    ...
    function Test_error_1(testcase)
      ...
      function test_target
        mus1.FileUtil.mustBeLiveScript  % !test-target
      end  % nested function
    end  % function
    ...
    function Test_error_3(testcase)
      verifyError(testcase, @() test_target, "isLiveScript:NotFile")
      function test_target
        mus1.FileUtil.mustBeLiveScript("unittest_mustBeLiveScript")  % !test-target
      end  % nested function
    end  % function

    function PassingTest_1(~)
      file_1 = mus1.FileUtil.getFileFullPath("sampleScript_mustBeLiveScript_1");
      mus1.FileUtil.mustBeLiveScript(file_1)  % !test-target
    end  % function
    ...
    function PassingTest_2_R2024b(testcase)
      ...
      % R2024b or older
      file_1 = mus1.FileUtil.getFileFullPath("sampleScript_mustBeLiveScript_2");
    ...
    function PassingTest_4_R2024b(testcase)
      ...
      % R2024b or older
      file_1 = mus1.FileUtil.getFileFullPath("sampleScript_mustBeLiveScript_1");
      file_2 = mus1.FileUtil.getFileFullPath("sampleScript_mustBeLiveScript_2");
      verifyError(testcase, @() test_target, "mustBeLiveScript:NotLiveScript")
      function test_target
        mus1.FileUtil.mustBeLiveScript([file_1, file_2])  % !test-target
      end  % nested function
    end  % function

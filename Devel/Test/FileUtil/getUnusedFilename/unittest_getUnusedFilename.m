classdef unittest_getUnusedFilename < matlab.unittest.TestCase
  ...
  methods (Test)
    ...
    function PassingTest_1(~)
      mus1.FileUtil.getUnusedFilename;
    end  % function

    function Test_1(testcase)
      filename = mus1.FileUtil.getUnusedFilename;
      verifyEqual(testcase, filename, "untitled.m")
    end  % function

    function Test_2(testcase)
      filename = mus1.FileUtil.getUnusedFilename("untitled.json");
    ...
    function Test_3(testcase)
      ...
      new_filename = mus1.FileUtil.getUnusedFilename(filename);  % !test-target
    ...
    function Test_4(testcase)
      ...
      new_filename = mus1.FileUtil.getUnusedFilename(filename0, MaxCount=2);  % !test-target

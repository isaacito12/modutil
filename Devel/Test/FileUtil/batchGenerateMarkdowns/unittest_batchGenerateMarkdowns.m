classdef unittest_batchGenerateMarkdowns < matlab.unittest.TestCase
  ...
  methods (Test)
    ...
    function PassingTest_1(~)
      ...
      % 
      % end  % if
      mus1.FileUtil.batchGenerateMarkdowns
    end  % function
    ...
    function Test_1(testcase)
      ...
      try
        ...
        f = mus1.FileUtil.getFolderFullPath("batchGenerateMarkdowns");
      catch exception
      ...
      verifyTrue(testcase, contains(f, "Test" + ("/"|"\") + "FileUtil" + ("/"|"\") + "batchGenerateMarkdowns"))

      target1 = fullfile(f, "sample folder", "subfolder 1");
      target2 = fullfile(f, "sample folder", "subfolder 2");

      num_conv = mus1.FileUtil.batchGenerateMarkdowns( ...
        DryRun=true, LiveScriptFolderNames=[target1, target2], DisplayInfo=false);  % !test-target

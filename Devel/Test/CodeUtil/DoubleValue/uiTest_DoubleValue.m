  ...
  methods (Test)
    ...
    function app_launches_without_warnings_1(testcase)
      ...
      function test_target
        apptest_DoubleValue_1_workspace  % !test-target
      end  % nested function
    end  % function
    ...
    function app_launches_without_warnings_2(testcase)
      verifyWarningFree(testcase, @test_target)
      function test_target
        apptest_DoubleValue_2_watch  % !test-target
      end  % nested function
    end  % function
    ...
    function Gesture_1(testcase)
      app = apptest_DoubleValue_1_workspace;
      type(testcase, app.EditFieldUI.MainEditField, "2")
      x = app.ValueUI.Value;

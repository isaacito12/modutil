classdef unittest_DoubleValue < matlab.unittest.TestCase
  ...
  methods (Test)
    ...
    function Test_ValueText_1_1(testcase)
      % Test ValueText.
      val = 2;
      x = mus1.CodeUtil.DoubleValue(ValueText=val);
    ...
    function Test_workspace_2(testcase)
      ...
      dv_a = mus1.CodeUtil.DoubleValue;
      dv_b = mus1.CodeUtil.DoubleValue;
      dv_c = mus1.CodeUtil.DoubleValue;

classdef unittest_getNumberArrayFromText < matlab.unittest.TestCase
  ...
  methods (Test)
    ...
    function Test_1(testcase)
      x = mus1.CodeUtil.getNumberArrayFromText("0.1");
    ...
    function Test_4(testcase)
      x = mus1.CodeUtil.getNumberArrayFromText(" [ 1, 2 3 ;  4, 5 6 ] ");
    ...
    function Test_5(testcase)
      ...
      x = mus1.CodeUtil.getNumberArrayFromText(1.23);
    ...
    function Test_error_1(testcase)
      ...
      function test_target
        mus1.CodeUtil.getNumberArrayFromText([0 1])
      end  % nested function
    end  % function

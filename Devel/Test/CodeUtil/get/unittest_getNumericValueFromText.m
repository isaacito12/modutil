classdef unittest_getNumericValueFromText < matlab.unittest.TestCase
  ...
  methods (Test)
    ...
    function Test_1(testcase)
      x = mus1.CodeUtil.getNumericValueFromText("0");
      verifyEqual(testcase, x, 0)
    end  % function

    function Test_2(testcase)
      x = mus1.CodeUtil.getNumericValueFromText("-1.23");
    ...
    function Test_workspace_1(testcase)
      ...
      x = mus1.CodeUtil.getNumericValueFromText("x");
    ...
    function Test_workspace_2(testcase)
      ...
      x = mus1.CodeUtil.getNumericValueFromText("s.t");
      verifyTrue(testcase, abs(x - 1.2345) < 1e-8)
    ...
    function Test_workspace_3(testcase)
      ...
      x = mus1.CodeUtil.getNumericValueFromText("p.q.r");
      verifyTrue(testcase, abs(x - 1.2345) < 1e-8)
    ...
    function Test_error_1(testcase)
      ...
      function test_target
        mus1.CodeUtil.getNumericValueFromText([0 1])
      end  % nested function
    end  % function

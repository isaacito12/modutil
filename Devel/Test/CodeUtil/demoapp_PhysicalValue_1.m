...
pvalue_1 = mus1.CodeUtil.PhysicalValue(UnitText="rev/s");  % !test-target
...
app_window.Name = mus1.CodeUtil.i18n("PhysicalValue demo");
...
%%
  ...
  function react_EditField_ValueChanged()
    ...
    value_ui.Value = mus1.CodeUtil.stringify(value(sv));
  end  % nested function

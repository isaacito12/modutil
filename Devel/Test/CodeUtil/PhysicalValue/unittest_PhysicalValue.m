classdef unittest_PhysicalValue < matlab.unittest.TestCase
  ...
  methods (Test)
    ...
    function set_SimscapeValue_Error_2(testcase)
      physval = mus1.CodeUtil.PhysicalValue(UnitAlias="\%");
    ...
    function set_ValueText_constructor_1(testcase)
      ...
      physval = mus1.CodeUtil.PhysicalValue(ValueText="simscape.Value(4, ""N*m"")");
      % Directly get current_simscape_value to avoid any side effects.
      sscval = physval.current_simscape_value;
      verifyEqual(testcase, value(sscval), 4)
      verifyEqual(testcase, string(unit(sscval)), "N*m")
    ...
    function constructor_1_ok(testcase)
      physval = mus1.CodeUtil.PhysicalValue(UnitText="", UnitAlias="", ValueText="");
      verifyFalse(testcase, physval.initialized)
    end  % function
    ...
    function constructor_2_1_error(testcase)
      ...
      function test_target
        mus1.CodeUtil.PhysicalValue(UnitText="s", UnitAlias="\%", ValueText="3");
      end  % function
    end  % function

    function constructor_2_2_ok(testcase)
      physval = mus1.CodeUtil.PhysicalValue(UnitText="1", UnitAlias="\%", ValueText="");
      verifyTrue(testcase, physval.initialized)
    end  % function
    ...
    function constructor_2_3_error(testcase)
      ...
      function test_target
        mus1.CodeUtil.PhysicalValue(UnitText="1", UnitAlias="\%", ValueText="dummy");
      end  % function
    end  % function

    function constructor_2_4_ok(testcase)
      physval = mus1.CodeUtil.PhysicalValue(UnitText="1", UnitAlias="\%", ValueText="5");
      verifyTrue(testcase, physval.initialized)
    end  % function

    function constructor_3_ok(testcase)
      physval = mus1.CodeUtil.PhysicalValue(UnitText="s", UnitAlias="", ValueText="");
      verifyTrue(testcase, physval.initialized)
    end  % function
    ...
    function constructor_5_ok(testcase)
      physval = mus1.CodeUtil.PhysicalValue(UnitText="", UnitAlias="", ValueText="simscape.Value(-2.1, ""N"")");
      verifyTrue(testcase, physval.initialized)
    end  % function
    ...
    function constructor_6_2_ok(testcase)
      physval = mus1.CodeUtil.PhysicalValue(UnitText="1", UnitAlias="", ValueText="simscape.Value(-2.1, ""1"")");
      verifyTrue(testcase, physval.initialized)
    end  % function
    ...
    function constructor_7_1_error(testcase)
      verifyError(testcase, @test_target, "PhysicalValue:processValueText:InvalidValueText")
      function test_target
        mus1.CodeUtil.PhysicalValue(UnitText="", UnitAlias="\%", ValueText="dummy");
      end  % function
    end  % function

    function constructor_7_2_ok(testcase)
      physval = mus1.CodeUtil.PhysicalValue(UnitText="", UnitAlias="\%", ValueText="simscape.Value(-2.1, ""1"")");
      verifyTrue(testcase, physval.initialized)
    end  % function
    ...
    function get_ValueText_Test_2(testcase)
      physval = mus1.CodeUtil.PhysicalValue(ValueText="1 : 2 : 5");
      actual = physval.ValueText;
    ...
    function get_UnitText_Test_2(testcase)
      physval = mus1.CodeUtil.PhysicalValue(UnitText="N*m");
      physval.ValueText = "[3, 4, 5]";
      actual = physval.UnitText;
    ...
    function Test_UnitAlias_3(testcase)
      x = mus1.CodeUtil.PhysicalValue(UnitText="m");
    ...
    function EventListner_1(testcase)
      ...
      x = mus1.CodeUtil.PhysicalValue(UnitText="1");
    ...
    function BaseWorkspace_1(testcase)
      ...
      x = mus1.CodeUtil.PhysicalValue(UnitText="m/s");
    ...
    function BaseWorkspace_3(testcase)
      ...
      pv_a = mus1.CodeUtil.PhysicalValue(ValueText="1", UnitText="mm");
      pv_b = mus1.CodeUtil.PhysicalValue(ValueText="1", UnitText="cm");

      % Derived
      pv_c = mus1.CodeUtil.PhysicalValue(UnitText="m^2");

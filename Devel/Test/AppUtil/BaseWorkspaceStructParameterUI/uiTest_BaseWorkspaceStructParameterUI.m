classdef uiTest_BaseWorkspaceStructParameterUI < matlab.uitest.TestCase
  ...
  methods (Test)
    ...
    function Gesture_2_1(testcase)
      ...
      paramfile1 = mus1.FileUtil.getFileFullPath("BaseWorkspaceStructParameterUI_SampleParams1.m");
      paramfile2 = mus1.FileUtil.getFileFullPath("BaseWorkspaceStructParameterUI_SampleParams2.m");

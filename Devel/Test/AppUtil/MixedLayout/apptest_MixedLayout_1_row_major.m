...
main_vertical_container = mus1.AppUtil.VerticalContainer(main_figure);  % !test-target

% -----------------------------------------------------------------------------
horizontal_container = mus1.AppUtil.HorizontalContainer(addVerticalGridLayout(main_vertical_container));  % !test-target

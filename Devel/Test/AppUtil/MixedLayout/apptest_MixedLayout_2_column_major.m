...
main_horizontal_container = mus1.AppUtil.HorizontalContainer(main_figure);  % !test-target

% -----------------------------------------------------------------------------
vertical_container = mus1.AppUtil.VerticalContainer(addHorizontalGridLayout(main_horizontal_container, Width=left_text_width));  % !test-target
...
% -----------------------------------------------------------------------------
vertical_container = mus1.AppUtil.VerticalContainer(addHorizontalGridLayout(main_horizontal_container));  % !test-target
...
% -----------------------------------------------------------------------------
vertical_container = mus1.AppUtil.VerticalContainer(addHorizontalGridLayout(main_horizontal_container, Width=right_text_width));  % !test-target

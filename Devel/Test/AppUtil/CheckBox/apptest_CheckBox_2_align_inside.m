...
%%
horizontal_container = mus1.AppUtil.HorizontalContainer(grid_layout);

cb = mus1.AppUtil.Component.CheckBox(addHorizontalGridLayout(horizontal_container));  % !test-target
cb.MainFigure = main_figure;
cb.ComponentHeight = mus1.AppUtil.Constant.Height{"oneline"}*4;

...
app_horizontal_container = mus1.AppUtil.HorizontalContainer(main_figure);
...
%%
vertical_container = mus1.AppUtil.VerticalContainer(grid_layout);
for column_count = 1 : 3
  ...
  % left
  ui_1 = mus1.AppUtil.Component.CheckBox(addHorizontalGridLayout(horizontal_container, width=160));  % #test-target
  ui_1.MainFigure = main_figure;
  ui_1.HighlightBackground = hilit(1);

  % center
  ui_2 = mus1.AppUtil.Component.CheckBox(addHorizontalGridLayout(horizontal_container, Width="1x"));  % #test-target
  ui_2.MainFigure = main_figure;
  ui_2.HighlightBackground = hilit(2);

  % right
  ui_3 = mus1.AppUtil.Component.CheckBox(addHorizontalGridLayout(horizontal_container, Width="2x"));  % #test-target

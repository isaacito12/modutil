function runTestForCoverage_PhysicalValueWithUnitDropDown
% Run test and measure code coverage for specified source files.

% Copyright 2026 The MathWorks, Inc.

source_file_1 = fullfile(pwd, "..", "..", "+mus1.AppUtil", "+Component", "PhysicalValueWithUnitDropDown.m");
assert(isfile(source_file_1))

test_file_1 = fullfile(pwd, "uiTest_PhysicalValueWithUnitDropDown.m");

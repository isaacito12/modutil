...
common_height = mus1.AppUtil.Constant.Height{"oneline++"}*3;
...
link_11_ui = mus1.AppUtil.Component.Hyperlink(addHorizontalGridLayout(horizontal_container));  % !test-target
...
link_12_ui = mus1.AppUtil.Component.Hyperlink(addHorizontalGridLayout(horizontal_container));  % !test-target
...
link_13_ui = mus1.AppUtil.Component.Hyperlink(addHorizontalGridLayout(horizontal_container));  % !test-target
...
link_21_ui = mus1.AppUtil.Component.Hyperlink(addHorizontalGridLayout(horizontal_container));  % !test-target
...
link_22_ui = mus1.AppUtil.Component.Hyperlink(addHorizontalGridLayout(horizontal_container));  % !test-target
...
link_23_ui = mus1.AppUtil.Component.Hyperlink(addHorizontalGridLayout(horizontal_container));  % !test-target
...
link_31_ui = mus1.AppUtil.Component.Hyperlink(addHorizontalGridLayout(horizontal_container));  % !test-target
...
link_32_ui = mus1.AppUtil.Component.Hyperlink(addHorizontalGridLayout(horizontal_container));  % !test-target
...
link_33_ui = mus1.AppUtil.Component.Hyperlink(addHorizontalGridLayout(horizontal_container));  % !test-target

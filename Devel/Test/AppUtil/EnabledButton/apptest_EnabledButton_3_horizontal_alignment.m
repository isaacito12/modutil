...
enabled_button_ui_L1 = mus1.AppUtil.Component.EnabledButton(addVerticalGridLayout(app_vertical_container));  % !test-target
...
enabled_button_ui_L2 = mus1.AppUtil.Component.EnabledButton(addVerticalGridLayout(app_vertical_container));  % !test-target
...
enabled_button_ui_R1 = mus1.AppUtil.Component.EnabledButton(addVerticalGridLayout(app_vertical_container));  % !test-target
...
enabled_button_ui_R2 = mus1.AppUtil.Component.EnabledButton(addVerticalGridLayout(app_vertical_container));  % !test-target
...
enabled_button_ui_C1 = mus1.AppUtil.Component.EnabledButton(addVerticalGridLayout(app_vertical_container));  % !test-target
...
enabled_button_ui_C2 = mus1.AppUtil.Component.EnabledButton(addVerticalGridLayout(app_vertical_container));  % !test-target

function App = apptest_EnabledButton_2_fit
...
enabled_button_ui_1 = mus1.AppUtil.Component.EnabledButton(addVerticalGridLayout(app_vertical_container));  % !test-target
...
enabled_button_ui_2 = mus1.AppUtil.Component.EnabledButton(addVerticalGridLayout(app_vertical_container));  % !test-target
...
enabled_button_ui_3 = mus1.AppUtil.Component.EnabledButton(addVerticalGridLayout(app_vertical_container));  % !test-target

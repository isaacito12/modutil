...
common_height = mus1.AppUtil.Constant.Height{"oneline++"}*2;

main_figure = uifigure(Visible="off");
main_figure.Position(3) = 600;  % width
main_figure.Position(4) = 320;  % height

v_container = mus1.AppUtil.VerticalContainer(main_figure);  % !test-target

label_ui = mus1.AppUtil.Component.Label(addVerticalGridLayout(v_container));
...
label_ui = mus1.AppUtil.Component.Label(addVerticalGridLayout(v_container, Height=common_height));
label_ui.MainFigure = main_figure;

...
% -----------------------------------------------------------------------------
h_container = mus1.AppUtil.HorizontalContainer(addVerticalGridLayout(v_container));
...
dropdown_ui = mus1.AppUtil.Component.DropDown(addHorizontalGridLayout(h_container));

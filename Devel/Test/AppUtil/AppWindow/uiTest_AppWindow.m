classdef uiTest_AppWindow < matlab.uitest.TestCase
  ...
  methods (Test)
    ...
    function app_launches_without_warnings_1(testcase)
      verifyWarningFree(testcase, @apptest_AppWindow_1_simplest)
    end  % function

    function app_launches_without_warnings_2(testcase)
      verifyWarningFree(testcase, @apptest_AppWindow_2_vertical_scrollbar)
    end  % function

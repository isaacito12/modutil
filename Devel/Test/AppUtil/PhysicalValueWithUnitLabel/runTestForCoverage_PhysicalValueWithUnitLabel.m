function runTestForCoverage_PhysicalValueWithUnitLabel
% Run test and measure code coverage for specified source files.

% Copyright 2026 The MathWorks, Inc.

source_file_1 = fullfile(pwd, "..", "..", "+mus1.AppUtil", "+Component", "PhysicalValueWithUnitLabel.m");
assert(isfile(source_file_1))

test_file_1 = fullfile(pwd, "uiTest_PhysicalValueWithUnitLabel.m");

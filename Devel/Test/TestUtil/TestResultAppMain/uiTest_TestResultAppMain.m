  ...
  methods (Test)
    ...
    function app_launches_without_warnings_1(testcase)
      ...
      function test_target()
        mus1.TestUtil.TestResultAppMain  % !test-target
      end  % nested function
    end  % function
    ...
    function app_launches_without_warnings_2(testcase)
      verifyWarningFree(testcase, @() test_target())
      function test_target()
        mus1.TestUtil.TestResultAppMain(TestResultFileName="")  % !test-target
      end  % nested function
    end  % function
    ...
    function ErrorCase_1(testcase)
      ...
      function test_target()
        mus1.TestUtil.TestResultAppMain(TestResultFileName="dummy_dummy_dummy")  % !test-target
      end  % nested function
    end  % function
    ...
    function PassingTest_1(~)
      ...
      result_file = mus1.SearchUtil.searchFiles("sample-test-result-TestResultAppMain-1.xml");
      mus1.TestUtil.TestResultAppMain(TestResultFileName=result_file)  % !test-target
    end  % function

    function PassingTest_2(~)
      % Load a test result file to the drop down and the table.
      result_file_1 = mus1.SearchUtil.searchFiles("sample-test-result-TestResultAppMain-1.xml");
      app = mus1.TestUtil.TestResultAppMain;
    ...
    function GestureTest_1(testcase)
      ...
      result_file_1 = mus1.SearchUtil.searchFiles("sample-test-result-TestResultAppMain-1.xml");
      result_file_2 = mus1.SearchUtil.searchFiles("sample-test-result-TestResultAppMain-2.xml");

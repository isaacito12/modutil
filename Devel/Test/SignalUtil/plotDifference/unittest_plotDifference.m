classdef unittest_plotDifference < matlab.unittest.TestCase
  ...
  methods (Test)
    ...
    function PassingTest_1(~)
      mus1.SignalUtil.plotDifference
    end  % function

    function PassingTest_2(~)
      data = [0, 0.1, 0.2, 0.2222, 0.223, 0.24, 0.3, 0.4, 0.5];
      mus1.SignalUtil.plotDifference(data, Title="Title", XLabel="X", XUnitText="x unit", YLabel="Y", YUnitText="y unit")
    end  % function

    function PassingTest_3(~)
      data = [0, 0.1, 0.2, 0.2222, 0.223, 0.24, 0.3, 0.4, 0.5];
      ax = axes(figure);
      mus1.SignalUtil.plotDifference(data, ParentAxes=ax)
    end  % function
    ...
    function PassingTest_4(~)
      ...
      mus1.SignalUtil.plotDifference(data, ParentAxes=ax, NewFigure=true)
      delete(uifig)
    end  % function
    ...
    function PassingTest_5(~)
      ...
      mus1.SignalUtil.plotDifference(data, ParentAxes=ax, NewFigure=false)
      delete(uifig)
    end  % function

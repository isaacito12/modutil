classdef uptodateTest_SignalUtil < matlab.unittest.TestCase
  ...
  methods (Test)
    ...
    function html_with_code_is_uptodate_1(testcase)
      ...
      source_fullpath = mus1.FileUtil.getFileFullPath("SignalDesignApp_Description.mlx");
      destination_fullpath = mus1.FileUtil.getFileFullPath("SignalDesignApp_Description.html");

      % This test uses a conditional branch as a special case because it is practical.
      newer = mus1.FileUtil.sourceFileIsNewer(Source=source_fullpath, Destination=destination_fullpath);
      if newer
      ...
      newer = mus1.FileUtil.sourceFileIsNewer(Source=source_fullpath, Destination=destination_fullpath, DisplayInfo=true);
    ...
    function html_with_code_is_uptodate_2(testcase)
      ...
      source_fullpath = mus1.FileUtil.getFileFullPath("TraceGeneratorApp_Description.mlx");
      destination_fullpath = mus1.FileUtil.getFileFullPath("TraceGeneratorApp_Description.html");

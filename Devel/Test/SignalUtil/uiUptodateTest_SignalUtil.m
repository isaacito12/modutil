classdef uiUptodateTest_SignalUtil < matlab.uitest.TestCase
  ...
  methods (Test)
    ...
    function app_screenshot_is_uptodate_1_1_dark(testcase)
      %%
      source_fullpath = mus1.FileUtil.getFileFullPath("SignalDesignApp.m");
      ...
      if needs_update
        ...
        mus1.FileUtil.sourceFileIsNewer(Source=source_fullpath, Destination=destination_fullpath, DisplayInfo=true);
    ...
    function app_screenshot_is_uptodate_2_1_dark(testcase)
      %%
      source_fullpath = mus1.FileUtil.getFileFullPath("TraceGeneratorApp.m");

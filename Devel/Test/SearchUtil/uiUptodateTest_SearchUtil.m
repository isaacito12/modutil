classdef uiUptodateTest_SearchUtil < matlab.uitest.TestCase
  ...
  methods (Test)
    ...
    function app_screenshot_dark_1(testcase)
      ...
      % R2025a or newer
      source = mus1.FileUtil.getFileFullPath("FileSearchApp.m");
    ...
    function app_screenshot_dark_2(testcase)
      ...
      % R2025a or newer
      source = mus1.FileUtil.getFileFullPath("TextSearchApp.m");
    ...
    function app_screenshot_dark_3(testcase)
      ...
      % R2025a or newer
      source = mus1.FileUtil.getFileFullPath("TextSearchResultApp.m");

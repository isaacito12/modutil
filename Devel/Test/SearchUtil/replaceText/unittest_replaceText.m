  ...
  methods (Test)
    ...
    function Error_1(testcase)
      ...
      function test_target()
        mus1.SearchUtil.replaceText()  % !test-target
      end  % function
    end  % function
    ...
    function Error_2(testcase)
      ...
      function test_target
        mus1.SearchUtil.replaceText(target_file)  % !test-target
      end  % function
    end  % function
    ...
    function Error_3(testcase)
      ...
      function test_target
        mus1.SearchUtil.replaceText(target_file, TextPattern="programmatically")  % !test-target
      end  % function
    end  % function
    ...
    function Test_1(testcase)
      ...
      session = mus1.SearchUtil.replaceText(target_file, DryRun=false, TextPattern="modified", NewText="edited");  % !test-target
      ...
      session = mus1.SearchUtil.replaceText(target_file, DryRun=false, TextPattern="edited", NewText="modified");  % !test-target
      verifyEqual(testcase, height(session.NumLines), 1)
      actual_lines = readlines(target_file);

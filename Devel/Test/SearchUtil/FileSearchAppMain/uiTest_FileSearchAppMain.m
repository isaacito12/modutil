  ...
  methods (Test)
    ...
    function app_launches_without_warnings_1(testcase)
      ...
      function test_target()
        mus1.SearchUtil.FileSearchAppMain  % !test-target
      end  % nested function
    end  % function
    ...
    function Gesture_1(testcase)
      app = mus1.SearchUtil.FileSearchAppMain(SearchFileName="*.m");
    ...
    function Gesture_2(testcase)
      app = mus1.SearchUtil.FileSearchAppMain;
      ...
      verifyTrue(testcase, startsWith(contents, "mus1.SearchUtil.searchFiles("))
    end  % function

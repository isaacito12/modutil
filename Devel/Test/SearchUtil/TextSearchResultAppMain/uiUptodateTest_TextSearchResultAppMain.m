classdef uiUptodateTest_TextSearchResultAppMain < matlab.uitest.TestCase
  ...
  methods (Test)
    ...
    function app_screenshot_dark_1(testcase)
      ...
      % R2025a or newer
      source = mus1.FileUtil.getFileFullPath("mus1.SearchUtil.TextSearchResultAppMain");
      destination = fullfile(pwd, "screenshot-TextSearchResultAppMain-dark-1.png");

      if not(isfile(destination)) || mus1.FileUtil.sourceFileIsNewer(Source=source, Destination=destination)
        app = mus1.SearchUtil.TextSearchResultAppMain;  % !screenshot-target
    ...
    function app_screenshot_light_1(testcase)
      ...
      if isMATLABReleaseOlderThan("R2025a")
        % R2024b
        destination = fullfile(pwd, "screenshot-TextSearchResultAppMain-24b-1.png");
      else
        % R2025a or newer
        destination = fullfile(pwd, "screenshot-TextSearchResultAppMain-light-1.png");
      end  % if

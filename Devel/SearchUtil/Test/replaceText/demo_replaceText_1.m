%[text] # replaceText demo 1
%[text] The `replaceText` function works on specified files to replace text. To replace text for a group of files found by text search, use the `searchAndReplaceText` function.
%[text] This demo shows a case working for a single file.
targetfile_fullpath = which("samplefile_replaceText.txt");
type(targetfile_fullpath) %[output:3f9a2e34]
result = SearchUtil1.replaceText(targetfile_fullpath, DryRun=true, TextPattern="testing", NewText="testing"); %[output:3c13ddab]
...
%---
%[output:940681fc]
%   data: {"dataType":"text","outputData":{"text":"C:\\local\\gh-isaacito12-bev\\bev25b\\Utility\\SearchUtil\\Test\\replaceText\\samplefile_replaceText.txt\n","truncated":false}}
%---
%[output:52d26ff0]
%   data: {"dataType":"text","outputData":{"text":"\nThis file is part of the Search Tool.\nThe contents of this file is modified programatically for testing.\n","truncated":false}}
%---

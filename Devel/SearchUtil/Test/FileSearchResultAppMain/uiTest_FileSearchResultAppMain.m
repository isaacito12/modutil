classdef uiTest_FileSearchResultAppMain < matlab.uitest.TestCase
  ...
  methods (Test)
    ...
    function app_launches_without_warnings_1(testcase)
      ...
      function target()
        SearchUtil1.FileSearchResultAppMain  % !test-target
      end  % nested function
    end  % function
    ...
    function Gesture_1(testcase)
      app = SearchUtil1.FileSearchResultAppMain;
    ...
    function Gesture_2(testcase)
      ...
      verifyTrue(testcase, startsWith(contents, "SearchUtil1.searchFiles("))
    end  % function

classdef uiUptodateTest_TextSearchAppMain < matlab.uitest.TestCase
  ...
  methods (Test)
    ...
    function app_screenshot_dark_1(testcase)
      ...
      % R2025a or newer
      source = FileUtil1.getFileFullPath("SearchUtil1.TextSearchAppMain");
      destination = fullfile(pwd, "screenshot-TextSearchAppMain-dark-1.png");

      if not(isfile(destination)) || FileUtil1.sourceFileIsNewer(Source=source, Destination=destination)
        app = SearchUtil1.TextSearchAppMain;  % !screenshot-target
    ...
    function app_screenshot_light_1(testcase)
      ...
      if isMATLABReleaseOlderThan("R2025a")
        % R2024b
        destination = fullfile(pwd, "screenshot-TextSearchAppMain-24b-1.png");
      else
        % R2025a or newer
        destination = fullfile(pwd, "screenshot-TextSearchAppMain-light-1.png");
      end  % if

classdef unittest_searchFiles < matlab.unittest.TestCase
  ...
  methods (Test)
    ...
    function PassingTest_1(testcase)
      ...
      actual = SearchUtil1.searchFiles(target_file);
    ...
    function PassingTest_2(testcase)
      ...
      result = SearchUtil1.searchFiles(target_file);
    ...
    function PassingTest_4(testcase)
      ...
      actual = SearchUtil1.searchFiles(target_file, TopFolder=top_folder);
      verifyTrue(testcase, not(isempty(actual)))
    end  % function

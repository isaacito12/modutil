classdef uitest_SearchUtilApps < matlab.uitest.TestCase
  ...
  methods (Test)
    ...
    function DarkTheme_1(testcase)
      ...
      save_path = fullfile(pwd, "screenshot-testing-TextSearchApp-dark-1.png");
      exportapp(testcase.App.Window.MainFigure, save_path)
    end  % function
    ...
    function DarkTheme_2(testcase)
      ...
      drawnow
      testcase.App.Window.MainFigure.Theme = "dark";
      save_path = fullfile(pwd, "screenshot-testing-TextSearchResultViewerApp-dark-2.png");
      exportapp(testcase.App.Window.MainFigure, save_path)
    end  % function

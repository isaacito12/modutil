classdef uiuptodatetest_SearchUtil < matlab.uitest.TestCase
  ...
  methods (Test)
    ...
    function app_screenshot_is_uptodate_1_1_dark(testcase)
      %%
      source_fullpath = FileUtil1.getFileFullPath("TextSearchApp.m");

      theme_name = "dark";
      destination_filename = "screenshot-TextSearchApp-" + theme_name + ".png";
      ...
      if needs_update
        ...
        testcase.App = TextSearchApp();  % !screenshot-target
    ...
    function app_screenshot_is_uptodate_2_1_dark(testcase)
      %%
      source_fullpath = FileUtil1.getFileFullPath("TextSearchResultViewerApp.m");

      theme_name = "dark";
      destination_filename = "screenshot-TextSearchResultViewerApp-" + theme_name + ".png";
      destination_fullpath = which(destination_filename);
      ...
      if needs_update
        ...
        testcase.App = TextSearchResultViewerApp();  % !screenshot-target

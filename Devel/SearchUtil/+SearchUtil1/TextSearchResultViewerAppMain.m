classdef TextSearchResultViewerAppMain < handle
  ...
  properties
    TextSearcher (1,1) SearchUtil1.TextSearcher
    SearchResult table
    ...
    CopyReplaceCommandTextUI AppUtil1.Component.Button
    NewTextUI AppUtil1.Component.EditableDropDown
  ...
  methods
    ...
    function App = TextSearchResultViewerAppMain(Searcher, NameValuePair)
      ...
      arguments (Input)
        Searcher (1,1) SearchUtil1.TextSearcher = SearchUtil1.TextSearcher(Initialization="default")
      ...
      if not(ready(Searcher))
        ...
        msg = CodeUtil1.i18n("TextSearcher must be initialized.");
      ...
      App.Window.Name = CodeUtil1.i18n("Text search result");
    ...
    function build_app_gui(App)
      ...
      App.NewSearchButtonUI = AppUtil1.Component.Button(NewSlot(layout, row));
      ...
      App.NewSearchButtonUI.MainButton.Tooltip = CodeUtil1.i18n("Open the text search app.");
      ...
      editfield_ui = AppUtil1.Component.EditField(NewSlot(layout, row));
      ...
      indent_ui = AppUtil1.Component.Label(NewSlot(layout, row, Width="fit"));
      ...
      if App.TextSearcher.States.IgnoreCase
        ...
        label_ui.Text = CodeUtil1.i18n("Case sensitive");
      end  % if
      ...
      if App.TextSearcher.States.MatchWholeWord
        ...
        label_ui.Text = CodeUtil1.i18n("Match anywhere");
      end  % if
      ...
      if App.TextSearcher.States.IncludeSubfolders
        ...
        label_ui.Text = CodeUtil1.i18n("Excluding subfolders");
      end

      % =======================================================================
      row = NewRow(layout, column);
      AppUtil1.Component.HorizontalLine(row);
      ...
      App.CopyReplaceCommandTextUI = AppUtil1.Component.Button(NewSlot(layout, row));
      ...
      App.CopyReplaceCommandTextUI.MainButton.Tooltip = CodeUtil1.i18n("Copy the replace command to clipboard.");
      ...
      App.NewTextUI = AppUtil1.Component.EditableDropDown(NewSlot(layout, row));
      App.NewTextUI.Items = "";
      App.NewTextUI.Value = "";
      ...
      App.NumMatchesUI = AppUtil1.Component.EditField(NewSlot(layout, row, Width="1x"));
      App.NumMatchesUI.ReadOnly = "on";
      App.NumMatchesUI.Value = string(height(App.SearchResult));

      button_ui = AppUtil1.Component.Button(NewSlot(layout, row, Width="fit"));
    ...
    function react_NewSearch(App)
      SearchUtil1.TextSearchAppMain(StatesSource="external", SearchStates=App.TextSearcher.States)
    end  % function
    ...
    function react_CopyReplaceCommandButtonPushed(App)
      ...
      %   result = SearchUtil1.replaceText(file_paths, DryRun=true, TextPattern="old", NewText="new");
      ...
      assert(iscolumn(file_paths), App.errorID+"InternalError", CodeUtil1.i18n("Internal error"))
      assert(all(isfile(file_paths)), App.errorID+"InternalError", CodeUtil1.i18n("Internal error"))

      code_lines = SearchUtil1.buildReplaceCommandText( ...

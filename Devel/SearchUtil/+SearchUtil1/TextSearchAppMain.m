classdef TextSearchAppMain < handle
  ...
  methods
    ...
    function build_app_gui(App)
      ...
      % -----------------------------------------------------------------------
      row = NewRow(layout, column);
      App.IncludeSubfoldersUI = AppUtil1.Component.CheckBox(NewSlot(layout, row));
      ...
      App.SelectFolderUI = AppUtil1.Component.Button(NewSlot(layout, row, Width="fit"));
      ...
      % -----------------------------------------------------------------------
      row = NewRow(layout, column);
      App.TargetFolderUI = AppUtil1.Component.DropDown(NewSlot(layout, row));
      ...
      App.SelectAllUI = AppUtil1.Component.CheckBox(NewSlot(layout, row));
      App.SelectAllUI.Text = CodeUtil1.i18n("Select all");
      App.SelectAllUI.ValueChangedCallback = @() react_SearchAllFileTypesCheckBox(App);

      App.Search_m_UI = AppUtil1.Component.CheckBox(NewSlot(layout, row));
      ...
      App.Search_md_UI = AppUtil1.Component.CheckBox(NewSlot(layout, row));
      ...
      App.Search_mdl_UI = AppUtil1.Component.CheckBox(NewSlot(layout, row));
      ...
      App.Search_ssc_UI = AppUtil1.Component.CheckBox(NewSlot(layout, row));
      ...
      App.Search_svg_UI = AppUtil1.Component.CheckBox(NewSlot(layout, row));
      ...
      App.CustomFileTypesUI = AppUtil1.Component.EditField(NewSlot(layout, row));
      ...
      App.SpecifiedFileTypesUI = AppUtil1.Component.EditField(NewSlot(layout, row));
      ...
      App.ExcludeLiveScriptUI = AppUtil1.Component.CheckBox(NewSlot(layout, row));
      ...
      App.ExcludeMATLABCodeFileUI = AppUtil1.Component.CheckBox(NewSlot(layout, row));
      ...
      App.IgnoreCaseUI = AppUtil1.Component.CheckBox(NewSlot(layout, row, Width="fit"));
      ...
      App.MatchWholeWordUI = AppUtil1.Component.CheckBox(NewSlot(layout, row, Width="fit"));
      ...
      % -----------------------------------------------------------------------
      row = NewRow(layout, column);
      App.SearchTextUI = AppUtil1.Component.EditableDropDown(NewSlot(layout, row));
      ...
      App.CopyCommandButtonUI = AppUtil1.Component.Button(NewSlot(layout, row));
      ...
      App.SearchButtonUI = AppUtil1.Component.Button(NewSlot(layout, row));

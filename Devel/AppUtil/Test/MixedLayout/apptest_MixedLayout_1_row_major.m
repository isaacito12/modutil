...
main_vertical_container = AppUtil1.VerticalContainer(main_figure);  % !test-target

% -----------------------------------------------------------------------------
horizontal_container = AppUtil1.HorizontalContainer(addVerticalGridLayout(main_vertical_container));  % !test-target

classdef uitest_MixedLayout < matlab.uitest.TestCase
  ...
  methods (Test)
    ...
    function app_launches_without_warnings_1(testcase)
      ...
      function target()
        testcase.App = apptest_MixedLayout_1_row_major;  % !test-target
      end  % nested function
    end  % function
    ...
    function app_launches_without_warnings_2(testcase)
      verifyWarningFree(testcase, @() target())
      function target()
        testcase.App = apptest_MixedLayout_2_column_major;  % !test-target
      end  % nested function
    end  % function
    ...
    function LightTheme_1(testcase)
      testcase.App = apptest_MixedLayout_1_row_major;
      drawnow
    ...
    function LightTheme_2(testcase)
      testcase.App = apptest_MixedLayout_2_column_major;
      drawnow
      if not(isMATLABReleaseOlderThan("R2025a"))
        testcase.App.MainFigure.Theme = "light";
      end  % if

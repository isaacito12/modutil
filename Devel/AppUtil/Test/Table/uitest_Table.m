classdef uitest_Table < matlab.uitest.TestCase
  ...
  methods (Test)
    ...
    function app_launches_without_warnings_1(testcase)
      ...
      function target()
        testcase.App = apptest_Table_1_rowdata;  % !test-target
      end  % nested function
    end  % function
    ...
    function Gesture_1(testcase)
      ...
      testcase.App = apptest_Table_1_rowdata;
      choose(testcase, testcase.App.TableUI.MainTable, [2, 1])
      choose(testcase, testcase.App.TableUI.MainTable, [1, 2])
    end  % function

...
label_ui = AppUtil1.Component.Label(addHorizontalGridLayout(h_container, Width=140));
label_ui.MainFigure = main_figure;
label_ui.Text = "test 1";
label_ui.HighlightBackground = "on";

label_ui = AppUtil1.Component.Label(addHorizontalGridLayout(h_container));
label_ui.MainFigure = main_figure;
label_ui.Text = "test 2";
label_ui.HighlightBackground = "off";

label_ui = AppUtil1.Component.Label(addHorizontalGridLayout(h_container, Width=100));
label_ui.MainFigure = main_figure;

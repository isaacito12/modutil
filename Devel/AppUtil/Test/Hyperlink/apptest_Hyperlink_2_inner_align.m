...
link_11_ui = AppUtil1.Component.Hyperlink(NewSlot(main_layout, app_row));  % !test-target
...
link_12_ui = AppUtil1.Component.Hyperlink(NewSlot(main_layout, app_row));  % !test-target
...
link_13_ui = AppUtil1.Component.Hyperlink(NewSlot(main_layout, app_row));  % !test-target
...
link_21_ui = AppUtil1.Component.Hyperlink(NewSlot(main_layout, app_row));  % !test-target
...
link_22_ui = AppUtil1.Component.Hyperlink(NewSlot(main_layout, app_row));  % !test-target
...
link_23_ui = AppUtil1.Component.Hyperlink(NewSlot(main_layout, app_row));  % !test-target
...
link_31_ui = AppUtil1.Component.Hyperlink(NewSlot(main_layout, app_row));  % !test-target
...
link_32_ui = AppUtil1.Component.Hyperlink(NewSlot(main_layout, app_row));  % !test-target
...
link_33_ui = AppUtil1.Component.Hyperlink(NewSlot(main_layout, app_row));  % !test-target

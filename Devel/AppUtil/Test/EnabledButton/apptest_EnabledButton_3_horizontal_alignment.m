...
enabled_button_ui_L1 = AppUtil1.Component.EnabledButton(NewArea(app_layout));  % !test-target
...
enabled_button_ui_L2 = AppUtil1.Component.EnabledButton(NewArea(app_layout));  % !test-target
...
enabled_button_ui_R1 = AppUtil1.Component.EnabledButton(NewArea(app_layout));  % !test-target
...
enabled_button_ui_R2 = AppUtil1.Component.EnabledButton(NewArea(app_layout));  % !test-target
...
enabled_button_ui_C1 = AppUtil1.Component.EnabledButton(NewArea(app_layout));  % !test-target
...
enabled_button_ui_C2 = AppUtil1.Component.EnabledButton(NewArea(app_layout));  % !test-target

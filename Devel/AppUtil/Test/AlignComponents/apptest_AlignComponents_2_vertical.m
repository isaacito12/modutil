...
vertical_container = AppUtil1.VerticalContainer(left_column_grid);
...
link_ui = AppUtil1.Component.Hyperlink(addVerticalGridLayout(vertical_container));
...
checkbox_ui = AppUtil1.Component.CheckBox(addVerticalGridLayout(vertical_container));
...
state_button_ui = AppUtil1.Component.StateButton(addVerticalGridLayout(vertical_container));
...
vertical_container = AppUtil1.VerticalContainer(right_column_grid);

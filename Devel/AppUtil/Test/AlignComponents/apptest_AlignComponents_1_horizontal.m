...
AppUtil1.Component.HorizontalLine(NewSlot(main_layout, app_row));

% -----------------------------------------------------------------------------
app_row = NewRow(main_layout, app_column);

label_1_ui = AppUtil1.Component.Label(NewSlot(main_layout, app_row));
...
link_1_ui = AppUtil1.Component.Hyperlink(NewSlot(main_layout, app_row));
...
if nargout > 0
  ...
  App.Label_1_UI = label_1_ui;
  App.Link_1_UI = link_1_ui;
end  % if
end  % function

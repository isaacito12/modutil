classdef uitest_TextArea < matlab.uitest.TestCase
  ...
  methods (Test)
    ...
    function app_launches_without_warnings_1(testcase)
      ...
      function target()
        testcase.App = apptest_TextArea_1_simplest;  % !test-target
      end  % nested function
    end  % function
    ...
    function Gesture_1(testcase)
      ...
      testcase.App = apptest_TextArea_1_simplest;
      type(testcase, testcase.App.TextAreaUI.MainTextArea, "Testing text area." + newline + "Second line.")
    end  % function

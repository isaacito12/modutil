...
app_component.PhysValUI_1 = AppUtil1.Component.PhysicalValueUI(addVerticalGridLayout(vertical_container));  % !test-target
...
app_component.PhysValUI_2 = AppUtil1.Component.PhysicalValueUI(addVerticalGridLayout(vertical_container));  % !test-target

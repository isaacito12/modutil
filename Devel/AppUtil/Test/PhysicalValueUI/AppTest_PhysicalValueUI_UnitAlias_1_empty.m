function App = AppTest_PhysicalValueUI_UnitAlias_1_empty
...
physval_ui = AppUtil1.Component.PhysicalValueUI(addVerticalGridLayout(vertical_container));
...
info_name_ui_1 = AppUtil1.Component.Label(addHorizontalGridLayout(horizontal_container));
info_name_ui_1.MainFigure = main_figure;
info_name_ui_1.HorizontalAlignment = "right";
info_name_ui_1.Text = "simscape.Value";

info_text_ui = AppUtil1.Component.Label(addHorizontalGridLayout(horizontal_container));

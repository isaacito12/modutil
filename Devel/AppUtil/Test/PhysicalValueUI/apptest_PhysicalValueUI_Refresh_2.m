...
label_ui_1 = AppUtil1.Component.Label(NewRowGrid(row_layout));
...
label_ui_4 = AppUtil1.Component.Label(NewRowGrid(row_layout));
label_ui_4.MainFigure = main_figure;
label_ui_4.Text = "4";

label_ui_5 = AppUtil1.Component.Label(NewRowGrid(row_layout));

function App = apptest_WindowHeader_3
...
window_header_ui = AppUtil1.Component.WindowHeader(layout);  % !test-target
window_header_ui.MainFigure = main_figure;
window_header_ui.AppName = "Test WindowHeader";
window_header_ui.AppSourceName = mfilename;

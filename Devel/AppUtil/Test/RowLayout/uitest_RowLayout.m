classdef uitest_RowLayout < matlab.uitest.TestCase
  ...
  methods (Test)
    ...
    function app_launches_without_warnings_1(testcase)
      ...
      function target()
        testcase.App = apptest_RowLayout_1;  % !test-target
      end  % nested function
    end  % function
    ...
    function app_launches_without_warnings_2(testcase)
      verifyWarningFree(testcase, @() target())
      function target()
        testcase.App = apptest_RowLayout_2;  % !test-target
      end  % nested function
    end  % function
    ...
    function LightTheme_1(testcase)
      testcase.App = apptest_RowLayout_1;
      drawnow
    ...
    function LightTheme_2(testcase)
      testcase.App = apptest_RowLayout_2;
      drawnow
      if not(isMATLABReleaseOlderThan("R2025a"))
        testcase.App.Window.MainFigure.Theme = "light";
      end  % if

classdef uitest_PhysicalValueUIPrototype < matlab.uitest.TestCase
  ...
  methods (Test)
    ...
    function app_launches_without_warnings_1(testcase)
      ...
      function target()
        testcase.App = apptest_PhysicalValueUIPrototype_1_simplest;  % !test-target
      end  % nested function
    end  % function
    ...
    function app_launches_without_warnings_2(testcase)
      verifyWarningFree(testcase, @() target())
      function target()
        testcase.App = apptest_PhysicalValueUIPrototype_Refresh_1;  % !test-target
      end  % nested function
    end  % function
    ...
    function app_launches_without_warnings_3(testcase)
      verifyWarningFree(testcase, @() target())
      function target()
        testcase.App = apptest_PhysicalValueUIPrototype_Refresh_2;  % !test-target
      end  % nested function
    end  % function
    ...
    function app_launches_without_warnings_4(testcase)
      verifyWarningFree(testcase, @() target())
      function target()
        testcase.App = apptest_PhysicalValueUIPrototype_UnitAlias_1_empty;  % !test-target
      end  % nested function
    end  % function
    ...
    function app_launches_without_warnings_5(testcase)
      verifyWarningFree(testcase, @() target())
      function target()
        testcase.App = apptest_PhysicalValueUIPrototype_UnitAlias_2_percent;  % !test-target
      end  % nested function
    end  % function
    ...
    function app_launches_without_warnings_6(testcase)
      verifyWarningFree(testcase, @() target())
      function target()
        testcase.App = apptest_PhysicalValueUIPrototype_UnitItems_1;  % !test-target
      end  % nested function
    end  % function
    ...
    function app_launches_without_warnings_7(testcase)
      verifyWarningFree(testcase, @() target())
      function target()
        testcase.App = apptest_PhysicalValueUIPrototype_UnitText_1;  % !test-target
      end  % nested function
    end  % function
    ...
    function Gesture_UnitAlias_1(testcase)
      testcase.App = apptest_PhysicalValueUIPrototype_UnitAlias_1_empty;
    ...
    function Gesture_UnitAlias_2(testcase)
      testcase.App = apptest_PhysicalValueUIPrototype_UnitAlias_2_percent;
    ...
    function Gesture_UnitItems_1(testcase)
      ...
      testcase.App = apptest_PhysicalValueUIPrototype_UnitItems_1;
    ...
    function LightTheme_1(testcase)
      testcase.App = apptest_PhysicalValueUIPrototype_1_simplest;
      drawnow

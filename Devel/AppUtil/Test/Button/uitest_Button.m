classdef uitest_Button < matlab.uitest.TestCase
  ...
  methods (Test)
    ...
    function app_launches_without_warnings_1(testcase)
      ...
      function target()
        testcase.App = apptest_Button_1_simplest;  % !test-target
      end  % nested function
    end  % function
    ...
    function app_launches_without_warnings_2(testcase)
      verifyWarningFree(testcase, @() target())
      function target()
        testcase.App = apptest_Button_2_align_inside;  % !test-target
      end  % nested function
    end  % function
    ...
    function app_launches_without_warnings_3(testcase)
      verifyWarningFree(testcase, @() target())
      function target()
        testcase.App = apptest_Button_3_icon;  % !test-target
      end  % nested function
    end  % function
    ...
    function app_launches_without_warnings_4(testcase)
      verifyWarningFree(testcase, @() target())
      function target()
        testcase.App = apptest_Button_4_tiling;  % !test-target
      end  % nested function
    end  % function

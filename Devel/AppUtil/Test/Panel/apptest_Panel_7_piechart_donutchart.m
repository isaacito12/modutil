...
graphics_panel_ui_1 = AppUtil1.Graphics.Panel(v_layout);  % !test-target
...
v_layout = addHorizontalGridLayout(horizontal_container);
graphics_panel_ui_2 = AppUtil1.Graphics.Panel(v_layout);  % !test-target
...
v_layout = addHorizontalGridLayout(horizontal_container);
graphics_panel_ui_3 = AppUtil1.Graphics.Panel(v_layout);  % !test-target

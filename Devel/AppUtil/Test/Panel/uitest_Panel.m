classdef uitest_Panel < matlab.uitest.TestCase
  ...
  methods (Test)
    ...
    function app_launches_without_warnings_1(testcase)
      ...
      function target()
        testcase.App = apptest_Panel_1_simplest;  % !test-target
      end  % nested function
    end  % function
    ...
    function app_launches_without_warnings_2(testcase)
      verifyWarningFree(testcase, @() target())
      function target()
        testcase.App = apptest_Panel_2_tiledlayout;  % !test-target
      end  % nested function
    end  % function
    ...
    function app_launches_without_warnings_3(testcase)
      verifyWarningFree(testcase, @() target())
      function target()
        testcase.App = apptest_Panel_3_heatmap;  % !test-target
      end  % nested function
    end  % function
    ...
    function app_launches_without_warnings_4(testcase)
      verifyWarningFree(testcase, @() target())
      function target()
        testcase.App = apptest_Panel_4_heatmap_in_tiledlayout;  % !test-target
      end  % nested function
    end  % function
    ...
    function app_launches_without_warnings_5(testcase)
      verifyWarningFree(testcase, @() target())
      function target()
        testcase.App = apptest_Panel_5_stackedplot;  % !test-target
      end  % nested function
    end  % function
    ...
    function app_launches_without_warnings_6(testcase)
      verifyWarningFree(testcase, @() target())
      function target()
        testcase.App = apptest_Panel_6_parallelplot;  % !test-target
      end  % nested function
    end  % function
    ...
    function app_launches_without_warnings_7(testcase)
      verifyWarningFree(testcase, @() target())
      function target()
        testcase.App = apptest_Panel_7_piechart_donutchart;  % !test-target
      end  % nested function
    end  % function
    ...
    function app_launches_without_warnings_8(testcase)
      verifyWarningFree(testcase, @() target())
      function target()
        testcase.App = apptest_Panel_8_scatterhistogram;  % !test-target
      end  % nested function
    end  % function

classdef uitest_DoubleValueUI < matlab.uitest.TestCase
  ...
  methods (Test)
    ...
    function app_launches_without_warnings_1(testcase)
      ...
      function target()
        testcase.App = apptest_DoubleValueUI_1_simplest;  % !test-target
      end  % nested function
    end  % function
    ...
    function app_launches_without_warnings_2(testcase)
      verifyWarningFree(testcase, @() target())
      function target()
        testcase.App = apptest_DoubleValueUI_2;  % !test-target
      end  % nested function
    end  % function
    ...
    function Gesture_UnitAlias_1(testcase)
      testcase.App = apptest_DoubleValueUI_1_simplest;
      type(testcase, testcase.App.DoubleValueUI.ValueUI.MainEditField, "pi")
    end  % function

classdef uiUptodateTest_Image < matlab.uitest.TestCase
  ...
  methods (Test)
    ...
    % -------------------------------------------------------------------------
    % RotationalFriction1.RotationalFrictionAppMain
    ...
    function app_screenshot_1_dark(testcase)
      ...
      % R2025a or newer
      source_fullpath = FileUtil1.getFileFullPath("DemoApp_Image_2_ver_hor_align");

      destination_folder = fileparts(source_fullpath);

      destination_fullpath = fullfile(destination_folder, "screenshot-DemoApp_Image_2_ver_hor_align-dark-1.png");
      ...
      if needs_update
        app = DemoApp_Image_2_ver_hor_align;  % !screenshot-target
    ...
    function app_screenshot_1_light(testcase)
      ...
      if TestUtil1.isR2024bOrOlder
        destination_fullpath = fullfile(destination_folder, "screenshot-DemoApp_Image_2_ver_hor_align-24b-1.png");
      else
        destination_fullpath = fullfile(destination_folder, "screenshot-DemoApp_Image_2_ver_hor_align-light-1.png");
      end  % if

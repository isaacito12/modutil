classdef uitest_EditField < matlab.uitest.TestCase
  ...
  methods (Test)
    ...
    function app_launches_without_warnings_1(testcase)
      ...
      function target()
        testcase.App = apptest_EditField_1_simplest;  % !test-target
      end  % nested function
    end  % function
    ...
    function Gesture_1(testcase)
      testcase.App = apptest_EditField_1_simplest;
      type(testcase, testcase.App.EditFieldUI.MainEditField, "Testing edit field")
    end  % function

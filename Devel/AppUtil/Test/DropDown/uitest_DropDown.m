classdef uitest_DropDown < matlab.uitest.TestCase
  ...
  methods (Test)
    ...
    function app_launches_without_warnings_1(testcase)
      ...
      function target()
        testcase.App = apptest_DropDown_1_simplest;  % !test-target
      end  % nested function
    end  % function
    ...
    function app_launches_without_warnings_2(testcase)
      verifyWarningFree(testcase, @() target())
      function target()
        testcase.App = apptest_DropDown_2_add_item;  % !test-target
      end  % nested function
    end  % function
    ...
    function Test_1(testcase)
      testcase.App = apptest_DropDown_2_add_item;

      press(testcase, testcase.App.ButtonUI.MainButton)
      items = testcase.App.DropDownUI.Items;
      verifyEqual(testcase, items, ["aa"; "bb"; "cc"; "Added by button"]);

      choose(testcase, testcase.App.DropDownUI.MainDropDown, "bb")
    ...
    function LightTheme_1(testcase)
      testcase.App = apptest_DropDown_1_simplest;
      drawnow

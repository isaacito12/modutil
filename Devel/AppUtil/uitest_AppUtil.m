classdef uitest_AppUtil < matlab.uitest.TestCase
  ...
  methods (Test)
    ...
    function app_launches_without_warnings_1(testcase)
      ...
      function target()
        testcase.App = ColormapApp;  % !test-target
      end  % nested function
    end  % function
    ...
    function test_ColormapApp_LightTheme(testcase)
      % ColormapApp requires MATLAB R2025a or newer.
      if isMATLABReleaseOlderThan("R2025a")
      ...
      testcase.App = ColormapApp;
      drawnow
      testcase.App.Window.MainFigure.Theme = "light";
      save_path = fullfile(pwd, "screenshot-testing-ColormapApp-light-1.png");
      exportapp(testcase.App.Window.MainFigure, save_path)
    end  % function

    function test_ColormapApp_DarkTheme(testcase)
      if isMATLABReleaseOlderThan("R2025a")
      ...
      save_path = fullfile(pwd, "screenshot-testing-ColormapApp-dark-1.png");
      exportapp(testcase.App.Window.MainFigure, save_path)
    end  % function
    ...
    function test_MonitorInfoApp_LightTheme(testcase)
      testcase.App = MonitorInfoApp;
      drawnow
      if not(isMATLABReleaseOlderThan("R2025a"))
        testcase.App.Window.MainFigure.Theme = "light";
      end  % if
      save_path = fullfile(pwd, "screenshot-testing-MonitorInfoApp-light-1.png");
      exportapp(testcase.App.Window.MainFigure, save_path)
    end  % function

    function test_MonitorInfoApp_DarkTheme(testcase)
      if isMATLABReleaseOlderThan("R2025a")
      ...
      drawnow
      testcase.App.Window.MainFigure.Theme = "dark";
      save_path = fullfile(pwd, "screenshot-testing-MonitorInfoApp-dark-1.png");
      exportapp(testcase.App.Window.MainFigure, save_path)
    end  % function

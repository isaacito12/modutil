classdef AppUtilLayout < handle
  ...
  %
  % Area is the top level element of AppUtilLayout.
  % When you create a AppUtilLayout object, a new Area is created.
  % Areas are added from top to bottom in a window as you call NewArea method.
  % An Area can contain Columns or AppUtil1.Component.
  %
  % Column is the second level element of AppUtilLayout.
  ...
  %
  % AppUtilLayout is one of AppUtil1.Component.
  % Any of Area, Column, Row, and Slot can take a AppUtilLayout object.
  % This lets you create a AppUtilLayout within a AppUtilLayout.
  %
  % Documentation
  %
  % - uigridlayout
  ...
  methods
    ...
    function layout = AppUtilLayout(parent)
      %%
    ...
    function newGrid = NewSlot(layout, currentGrid, NameValuePair)
      ...
      arguments (Input)
        ...
        % You can pass values as long as it is supported by ColumnWidth,
        % such as "1x", "2x", "fit", 100, 200 etc.
        NameValuePair.Width (1,:) {CodeUtil1.mustBeStringOrPositiveInteger} = "1x"
      end
      arguments (Output)
        newGrid (1,1) matlab.ui.container.GridLayout
      end

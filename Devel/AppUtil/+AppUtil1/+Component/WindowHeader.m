classdef WindowHeader < AppUtil1.Component.ComponentBase
  ...
  properties
    ...
    AppNameUI AppUtil1.Component.Label
    SourceLinkUI AppUtil1.Component.Hyperlink
    AlwaysOnTopUI AppUtil1.Component.CheckBox
  ...
  properties (Constant)
    common_height = AppUtil1.Constant.Height{"oneline++"}
  end  % properties
  ...
  methods (Access=protected)
    ...
    function setup(component)
      ...
      if component.Reporting
        ...
        FileUtil1.displayTimeAndFileLocation("Within setup")
      end  % if
      ...
      component.AppNameUI = AppUtil1.Component.Label(component.base_grid);
      ...
      component.SourceLinkUI = AppUtil1.Component.Hyperlink(component.base_grid);
      ...
      component.AlwaysOnTopUI = AppUtil1.Component.CheckBox(component.base_grid);
    ...
    function regular_update(component)
      ...
      if component.Reporting
        ...
        FileUtil1.displayTimeAndFileLocation("component.AppName: " + component.AppName)
      end  % if

      % AppName can be defined by the user, first as the Name property of AppUtil1.AppUtilWindow.
      % Then it is passed to the AppName property of this class.
      % Because AppUtil1.AppUtilWindow class is a regular MATLAB class, not a child class of
    ...
    function first_update(component)
      ...
      if not(component.Show_AlwaysOnTop_CheckBox)
        if component.Reporting
          FileUtil1.displayTimeAndFileLocation("not creating always-on-top check box")
        end  % if
        checkbox_ui_width = 0;
  ...
  methods
    ...
    function valid = check_AlwaysOnTopUI_IsValid(component)
      ...
      if not(isvalid(component.AlwaysOnTopUI))
        % ignore
        if component.Reporting
          FileUtil1.displayTimeAndFileLocation("invalid because always-on-top check box was not created")
        end  % if
      ...
      if isempty(component.ParentFigure)
        if component.Reporting
          FileUtil1.displayTimeAndFileLocation("invalid because ParentFigure is empty")
        end  % if
    ...
    function RawSetAlwaysOnTop(component, on_flag)
      ...
      if on_flag
        ...
        if component.Reporting
          FileUtil1.displayTimeAndFileLocation("ParentFigure.WindowStyle: alwaysontop")
        end  % if
      else
        component.ParentFigure.WindowStyle = "normal";
        if component.Reporting
          FileUtil1.displayTimeAndFileLocation("ParentFigure.WindowStyle: normal")
        end  % if
      end  % if
    end  % function

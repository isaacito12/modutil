classdef PhysicalValueUI < AppUtil1.Component.ComponentBase
  ...
  properties
    ...
    NameUIWidth (1,1) double {mustBePositive} = AppUtil1.Constant.Width{"unitwidth"} * 14
    InfoUIWidth (1,1) double {mustBePositive} = AppUtil1.Constant.Width{"unitwidth"} * 10
    UnitUIWidth (1,1) double {mustBePositive} = AppUtil1.Constant.Width{"unitwidth"} * 10
  ...
  properties
    ...
    ValueEditFieldUI AppUtil1.Component.EditField
    ...
    UnitDropDownUI AppUtil1.Component.DropDown
  ...
  methods (Access=protected)
    ...
    function setup(component)
      ...
      component.NameUI = AppUtil1.Component.Label(component.NameColumnContainer);
      ...
      component.ValueEditFieldUI = AppUtil1.Component.EditField(component.ValueColumnContainer);
      ...
      component.InfoUI = AppUtil1.Component.EditField(component.InfoColumnContainer);
      ...
      component.UnitLabelUI = AppUtil1.Component.Label(component.UnitColumnContainer);
      ...
      component.UnitDropDownUI = AppUtil1.Component.DropDown(component.UnitColumnContainer);
  ...
  methods
    ...
    function set.SimscapeValue(component, x)
      ...
      component.Value = CodeUtil1.stringify(component.current_numeric_value);
  ...
  methods (Access=private)
    ...
    function [Result, NotOK] = getNumericValueFromValueUI(component)
      ...
      try
        ...
        Result = CodeUtil1.getDoubleOrSimscapeValueFromString(original_value_ui_string);
      catch exception
        component.HasError = true;
        component.ErrorMessage = exception.message;
        NotOK = true;

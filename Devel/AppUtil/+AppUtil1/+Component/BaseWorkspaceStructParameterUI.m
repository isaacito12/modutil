classdef BaseWorkspaceStructParameterUI < AppUtil1.Component.ComponentBase
  ...
  properties
    ...
    GetParametersFromBaseWorkspaceCallback (:,1) {CodeUtil1.mustBeFunctionHandleOrEmpty}
    ...
    ParameterFileTextUI AppUtil1.Component.Label
    ParameterFileDropDownUI AppUtil1.Component.DropDown
    SelecFileButtonUI AppUtil1.Component.Button
    EditFileButtonUI AppUtil1.Component.Button

    % For the "Variable name" row
    StructNameRow matlab.ui.container.GridLayout
    StructNameTextUI AppUtil1.Component.Label
    StructNameDropDownUI AppUtil1.Component.DropDown
    GetParametersFromBaseWorkspaceUI AppUtil1.Component.Button
    OpenVariablesEditorButtonUI AppUtil1.Component.Button
  ...
  methods
    ...
    function callback_select_and_load_parameter_file(component, NameValuePair)
      ...
      if NameValuePair.ParameterFileFullPath ~= ""
        ...
        if not(isfile(component.ParameterFileFullPath))
          ...
          msg = CodeUtil1.i18n("Invalid file was specified: ") + NameValuePair.ParameterFileFullPath;
      ...
      if component.Reporting
        FileUtil1.displayTimeAndFileLocation("FileDropDownUI.Value: " + component.ParameterFileDropDownUI.Value)
      end  % if
    end  % function
    ...
    function set.ParameterFileFullPath(component, ParameterFilePath)
      ...
      if not(isfile(ParameterFilePath))
        ...
        msg = CodeUtil1.i18n("Invalid parameter file: ") + ParameterFilePath;
    ...
    function callback_change_structname_dropdown(component)
      ...
      try
        ...
        msg = CodeUtil1.i18n("Evaluation failed: ") + selected_struct_name + newline + exception.message;
  ...
  methods (Access=protected)
    ...
    function setup(component)
      ...
      component.ParameterFileTextUI = AppUtil1.Component.Label(component.ParameterFileRow);
      component.ParameterFileTextUI.Layout.Row = 1;
      component.ParameterFileTextUI.Layout.Column = 1;
      component.ParameterFileTextUI.Text = CodeUtil1.i18n("Parameter file");
      component.ParameterFileTextUI.ComponentWidth = component.NameUIWidth;

      component.ParameterFileDropDownUI = AppUtil1.Component.DropDown(component.ParameterFileRow);
      ...
      component.SelecFileButtonUI = AppUtil1.Component.Button(component.ParameterFileRow);
      ...
      component.SelecFileButtonUI.Text = CodeUtil1.i18n("Select file...");
      ...
      component.SelecFileButtonUI.MainButton.Tooltip = ...
        CodeUtil1.i18n("Select an M file containing parameters in a struct. The file is evaluated when selected.");

      component.EditFileButtonUI = AppUtil1.Component.Button(component.ParameterFileRow);
      ...
      component.EditFileButtonUI.Text = CodeUtil1.i18n("Edit");
      component.EditFileButtonUI.MainButton.Enable = "off";
      component.EditFileButtonUI.ButtonPushedCallback = @() edit(replace(component.ParameterFileDropDownUI.Value, " > ", filesep));
      component.EditFileButtonUI.MainButton.Tooltip = CodeUtil1.i18n("Edit the selected file.");
      ...
      component.StructNameTextUI = AppUtil1.Component.Label(component.StructNameRow);
      ...
      component.StructNameTextUI.Text = CodeUtil1.i18n("Variable name");

      component.StructNameDropDownUI = AppUtil1.Component.DropDown(component.StructNameRow);
      ...
      component.StructNameDropDownUI.MainDropDown.Tooltip = ...
        CodeUtil1.i18n("Specify a struct or a class object in the base workspace." + ...
        " To load a struct or a class object, the struct fields or the class properties must match the app's definitions.");

      component.GetParametersFromBaseWorkspaceUI = AppUtil1.Component.Button(component.StructNameRow);
      ...
      component.GetParametersFromBaseWorkspaceUI.Text = CodeUtil1.i18n("Get");
      ...
      component.GetParametersFromBaseWorkspaceUI.MainButton.Tooltip = ...
        CodeUtil1.i18n("Get parameters from the specified struct in the base workspace and load to the app.");

      component.OpenVariablesEditorButtonUI = AppUtil1.Component.Button(component.StructNameRow);
      ...
      component.OpenVariablesEditorButtonUI.Text = CodeUtil1.i18n("Open");
      component.OpenVariablesEditorButtonUI.MainButton.Enable = "off";
      component.OpenVariablesEditorButtonUI.ButtonPushedCallback = @() openvar(component.StructNameDropDownUI.Value);
      component.OpenVariablesEditorButtonUI.MainButton.Tooltip = CodeUtil1.i18n("Open the Variables Editor.");
    ...
    function regular_update(component)
      %%
      if component.Reporting
        FileUtil1.displayTimeAndFileLocation("regular update")
      end  % if

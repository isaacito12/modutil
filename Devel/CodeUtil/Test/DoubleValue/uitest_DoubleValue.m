classdef uitest_DoubleValue < matlab.uitest.TestCase
  ...
  methods (Test)
    ...
    function app_launches_without_warnings_1(testcase)
      ...
      function target()
        testcase.App = apptest_DoubleValue_1_workspace;  % !test-target
      end  % nested function
    end  % function
    ...
    function app_launches_without_warnings_2(testcase)
      verifyWarningFree(testcase, @() target())
      function target()
        testcase.App = apptest_DoubleValue_2_watch;  % !test-target
      end  % nested function
    end  % function
    ...
    function Gesture_1(testcase)
      testcase.App = apptest_DoubleValue_1_workspace;
      type(testcase, testcase.App.EditFieldUI.MainEditField, "2")

      x = testcase.App.ValueUI.Value;
    ...
    function LightTheme_2(testcase)
      testcase.App = apptest_DoubleValue_2_watch;
      drawnow
      if not(isMATLABReleaseOlderThan("R2025a"))
        testcase.App.Window.MainFigure.Theme = "light";
      end  % if

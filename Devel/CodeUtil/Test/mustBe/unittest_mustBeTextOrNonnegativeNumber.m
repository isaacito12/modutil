classdef unittest_mustBeTextOrNonnegativeNumber < matlab.unittest.TestCase
  ...
  methods (Test)
    ...
    function PassingTest_1(~)
      CodeUtil1.mustBeTextOrNonnegativeNumber("test")
    end  % function

    function PassingTest_2(~)
      CodeUtil1.mustBeTextOrNonnegativeNumber(0)
    end  % function

    function PassingTest_3(~)
      CodeUtil1.mustBeTextOrNonnegativeNumber(1.2)
    end  % function
    ...
    function Test_error_1(testcase)
      ...
      function test_target
        CodeUtil1.mustBeTextOrNonnegativeNumber(-1)
      end  % nested function
    end  % function

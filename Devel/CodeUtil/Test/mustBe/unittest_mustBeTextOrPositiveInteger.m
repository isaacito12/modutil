classdef unittest_mustBeTextOrPositiveInteger < matlab.unittest.TestCase
  ...
  methods (Test)
    ...
    function Test_1(~)
      CodeUtil1.mustBeTextOrPositiveInteger("test")
    end  % function

    function Test_2(~)
      CodeUtil1.mustBeTextOrPositiveInteger(1)
    end  % function

    function Test_error_1(testcase)
      verifyError(testcase, @() test_target, "mustBeTextOrPositiveInteger:NotTextNorPositiveInteger")
      function test_target
        CodeUtil1.mustBeTextOrPositiveInteger(0)
      end  % nested function
    end  % function
    ...
    function Test_error_2(testcase)
      verifyError(testcase, @() test_target, "mustBeTextOrPositiveInteger:NotTextNorPositiveInteger")
      function test_target
        CodeUtil1.mustBeTextOrPositiveInteger(0.999)
      end  % nested function
    end  % function

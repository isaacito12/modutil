classdef unittest_getDoubleOrSimscapeValueFromText < matlab.unittest.TestCase
  ...
  methods (Test)
    ...
    function PassingTest_1(~)
      CodeUtil1.getDoubleOrSimscapeValueFromText;
    end  % function

    %% Tests

    function Test_default_1(testcase)
      x = CodeUtil1.getDoubleOrSimscapeValueFromText;
    ...
    function Test_MaxTextLength_1(testcase)
      x = CodeUtil1.getDoubleOrSimscapeValueFromText("1", MaxTextLength=1);
    ...
    function Test_MaxTextLength_2(testcase)
      ...
      function test_target()
        CodeUtil1.getDoubleOrSimscapeValueFromText("12", MaxTextLength=1);  % !test-target
      end  % nested function
    end  % function

    function Test_MaxTextLength_3(testcase)
      x = CodeUtil1.getDoubleOrSimscapeValueFromText("12345", MaxTextLength=5);
    ...
    function Test_MaxTextLength_4(testcase)
      verifyError(testcase, @test_target, "getDoubleOrSimscapeValueFromText:TextIsTooLong")
      function test_target()
        CodeUtil1.getDoubleOrSimscapeValueFromText("123456", MaxTextLength=5);  % !test-target
      end  % nested function
    end  % function
    ...
    function Test_simscapeValue_1(testcase)
      x = CodeUtil1.getDoubleOrSimscapeValueFromText("simscape.Value");
      verifyEqual(testcase, x, simscape.Value)
    end  % function

    function Test_simscapeValue_2(testcase)
      x = CodeUtil1.getDoubleOrSimscapeValueFromText("simscape.Value(2, ""s"")");
      verifyEqual(testcase, x, simscape.Value(2, "s"))
    end  % function

    function Test_simscapeValue_3(testcase)
      x = CodeUtil1.getDoubleOrSimscapeValueFromText("simscape.Value([2 4 6], ""m/s"")");
    ...
    function Test_double_1(testcase)
      ...
      x = CodeUtil1.getDoubleOrSimscapeValueFromText("1.2");
    ...
    function Test_evaluated_1(testcase)
      ...
      x = CodeUtil1.getDoubleOrSimscapeValueFromText("pi");
      verifyEqual(testcase, x, pi)
    end  % function

    function Test_evaluated_2(testcase)
      x = CodeUtil1.getDoubleOrSimscapeValueFromText("1 + 1");
      verifyEqual(testcase, x, 2)
    end  % function

    function Test_evaluated_3(testcase)
      x = CodeUtil1.getDoubleOrSimscapeValueFromText("[1, sqrt(4)].^2");
    ...
    function Test_workspace_1(testcase)
      ...
      x = CodeUtil1.getDoubleOrSimscapeValueFromText("test_base_workspace.a");
      verifyEqual(testcase, x, 1)

...
if expression_string == ""
  ...
  msg = CodeUtil1.i18n("Empty string is not accepted.");
...
if strlength(expression_string) > 10000
  ...
  msg = CodeUtil1.i18n("Passed value as a string is too long. It must be shorter than 10,000 characters.");
...
if expression_string == ""
  id = errorID + "InvalidString";
  msg = CodeUtil1.i18n("Given string was empty.");
...
elseif Result.Type == "simscape.Value"
  ...
  msg = CodeUtil1.i18n("Passed string must evaluate to double or simscape.Value.");

  throw(MException(id, msg))

end  % if

Result.NumericString = CodeUtil1.stringify(Result.NumericValue, WithoutSpace=true);

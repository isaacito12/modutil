  ...
  methods (Test)
    ...
    function app_launches_without_warnings_1(testcase)
      ...
      function test_target
        RotationalFriction1.RotationalFrictionAppMain  % !test-target
      end  % nested function
    end  % function
    ...
    function VisualTest_1_1(~)
      ...
      RotationalFriction1.RotationalFrictionAppMain(PlotTorqueUnit="lbf*ft", PlotVelocityUnit="rad/s")
    end  % function

    function VisualTest_1_2(~)
      % Specify unit options.
      RotationalFrictionApp(PlotTorqueUnit="lbf*ft", PlotVelocityUnit="rad/s")
    end  % function
    ...
    function Test_with_samplemodel_1(~)
      ...
      model_name = "SampleModel_RotationalFriction_refsub_24b";
      RotationalFriction1.RotationalFrictionAppMain(ModelName=model_name)
    end  % function
    ...
    function Test_1(testcase)
      ...
      model_name = "SampleModel_RotationalFriction_refsub_24b";
      app = RotationalFriction1.RotationalFrictionAppMain(ModelName=model_name);
    ...
    function Test_2(testcase)
      ...
      model_name = "SampleModel_RotationalFriction_refsub_24b";
      block_path = model_name + "/Rotational Friction1";
      app = RotationalFriction1.RotationalFrictionAppMain(BlockPath=block_path);
    ...
    function Test_3(testcase)
      ...
      app = RotationalFrictionCustomApp1;

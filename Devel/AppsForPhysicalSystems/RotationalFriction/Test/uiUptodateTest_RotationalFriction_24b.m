classdef uiUptodateTest_RotationalFriction_24b < matlab.uitest.TestCase
  ...
  methods (Test)
    ...
    function app_screenshot_dark_1(testcase)
      ...
      % R2025a or newer
      source = FileUtil1.getFileFullPath("RotationalFriction1.RotationalFrictionAppMain");
      destination = fullfile(pwd, "screenshot-RotationalFrictionAppMain-1-dark.png");

      if not(isfile(destination)) || FileUtil1.sourceFileIsNewer(Source=source, Destination=destination)
        app = RotationalFriction1.RotationalFrictionAppMain;  % !screenshot-target
    ...
    function app_screenshot_light_1(testcase)
      ...
      if isMATLABReleaseOlderThan("R2025a")
        % R2024b
        destination = fullfile(pwd, "screenshot-RotationalFrictionAppMain-1-24b.png");
      else
        % R2025a or newer
        destination = fullfile(pwd, "screenshot-RotationalFrictionAppMain-1-light.png");
      end  % if

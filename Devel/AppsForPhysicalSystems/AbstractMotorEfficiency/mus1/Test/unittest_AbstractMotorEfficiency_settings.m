classdef unittest_AbstractMotorEfficiency_settings < matlab.unittest.TestCase
  ...
  methods (Test)
    ...
    function Test_1(testcase)
      ...
      info = Simulink.MDLInfo("SampleModel_AbstractMotorEfficiency_refsub_24b");
      verifyEqual(testcase, info.ReleaseName, 'R2024b')
    end  % function

    function linked_app_in_live_script_1(testcase)
      %%
      script_fullpath = string( which("AbstractMotorEfficiencyApp_Description_mus1"));

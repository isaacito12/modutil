...
arguments (Input)
  ...
  NameValuePair.MeasuredIronLosses (1,1) simscape.Value ...
    { simscape.mustBeCommensurateUnit(NameValuePair.MeasuredIronLosses, "W"), CodeUtil1.mustBeSimscapeValueNonnegativeOrNan } ...
    = simscape.Value(55, "W")

  NameValuePair.FixedLosses (1,1) simscape.Value ...
    { simscape.mustBeCommensurateUnit(NameValuePair.FixedLosses, "W"), CodeUtil1.mustBeSimscapeValueNonnegativeOrNan } ...
    = simscape.Value(40, "W")
...
xlabel(ax, CodeUtil1.i18n("Angular speed, $\omega$ (" + plot_speed_unit_text + ")"), Interpreter="latex")

ylabel(ax, CodeUtil1.i18n("Torque, $\tau$ (" + plot_torque_unit_text + ")"), Interpreter="latex")

title(ax, [
  CodeUtil1.i18n("Overall power conversion efficiency (%)")

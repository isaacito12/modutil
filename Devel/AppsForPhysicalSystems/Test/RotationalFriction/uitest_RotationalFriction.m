  ...
  methods (Test)
    ...
    function Test_error_1(testcase)
      ...
      function test_target()
        ...
        testcase.App = RotationalFriction1.RotationalFrictionAppMain(ModelName=model_name);  % !test-target
      end  % nested function
    end  % function
    ...
    function Test_error_2(testcase)
      ...
      function test_target()
        ...
        testcase.App = RotationalFriction1.RotationalFrictionAppMain(BlockPath=block_path);  % !test-target
      end  % nested function
    end  % function
    ...
    function Test_samplemodel_1(~)
      ...
      model_name = "samplemodel_RotationalFriction_refsub";

...
namespace_1 = "RotationalFrictionTorque1";

test_file_1 = fullfile(pwd, "uiTest_RotationalFrictionTorque.m");
assert(isfile(test_file_1))
  
test_file_2 = fullfile(pwd, "unittest_RotationalFrictionTorque.m");

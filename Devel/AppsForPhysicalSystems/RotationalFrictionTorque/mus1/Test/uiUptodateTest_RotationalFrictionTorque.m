classdef uiUptodateTest_RotationalFrictionTorque < matlab.uitest.TestCase
  ...
  methods (Test)
    ...
    function app_screenshot_1_dark(testcase)
      ...
      % R2025a or newer
      keyword = "RotationalFrictionTorque";
      ...
      destination_folder = fullfile(destination_folder, "AppsForPhysicalSystems", "RotationalFrictionTorque", "mus1");

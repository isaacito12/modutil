classdef uptodateTest_AbstractMotor < matlab.unittest.TestCase
  ...
  methods (Test)
    ...
    function description_html_is_uptodate(testcase)
      ...
      source_fullpath = FileUtil1.getFileFullPath("AbstractMotor_Description.mlx");

function runTestForCoverage_AbstractMotor
% Run test and measure code coverage for specified source files.

% Copyright 2026 The MathWorks, Inc.

% source_in_namespace_1 = fullfile(pwd, "..", "+AbstractMotor1");
% assert(isfolder(source_in_namespace_1))
namespace_1 = "AbstractMotor1";

test_file_1 = fullfile(pwd, "uiTest_AbstractMotor.m");
assert(isfile(test_file_1))

test_file_2 = fullfile(pwd, "unittest_AbstractMotor.m");

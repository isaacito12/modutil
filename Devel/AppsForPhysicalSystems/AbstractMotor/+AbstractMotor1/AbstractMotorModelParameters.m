classdef AbstractMotorModelParameters < handle
  ...
  properties
    ...
    MaxTorque simscape.Value ...
      { simscape.mustBeCommensurateUnit(MaxTorque, "N*m"), CodeUtil1.mustBeSimscapeValuePositive } ...
      = simscape.Value(nan, "N*m")

    MaxPower simscape.Value ...
      { simscape.mustBeCommensurateUnit(MaxPower, "kW"), CodeUtil1.mustBeSimscapeValuePositive } ...
      = simscape.Value(nan, "kW")

    MeasuredEfficiencyPercent double { mustBeInRange(MeasuredEfficiencyPercent, 0, 100) } = 0

    MeasuredAngularSpeed simscape.Value ...
      { simscape.mustBeCommensurateUnit(MeasuredAngularSpeed, "rpm"), CodeUtil1.mustBeSimscapeValuePositive } ...
      = simscape.Value(nan, "rpm")

    MeasuredTorque simscape.Value ...
      { simscape.mustBeCommensurateUnit(MeasuredTorque, "N*m"), CodeUtil1.mustBeSimscapeValuePositive } ...
      = simscape.Value(nan, "N*m")
    ...
    MeasuredIronLoss simscape.Value ...
      { simscape.mustBeCommensurateUnit(MeasuredIronLoss, "W"), CodeUtil1.mustBeSimscapeValueNonnegative } ...
      = simscape.Value(nan, "W")

    FixedLoss simscape.Value ...
      { simscape.mustBeCommensurateUnit(FixedLoss, "W"), CodeUtil1.mustBeSimscapeValueNonnegative } ...
      = simscape.Value(nan, "W")

    RotorDamping simscape.Value ...
      { simscape.mustBeCommensurateUnit(RotorDamping, "N*m/rpm"), CodeUtil1.mustBeSimscapeValueNonnegative } ...
    ...
    MeasuredNominalLoss simscape.Value ...
      { simscape.mustBeCommensurateUnit(MeasuredNominalLoss, "W"), CodeUtil1.mustBeSimscapeValueNonnegative } ...
      = simscape.Value(nan, "W")
    ...
    MeasuredCopperLoss simscape.Value ...
      { simscape.mustBeCommensurateUnit(MeasuredCopperLoss, "W"), CodeUtil1.mustBeSimscapeValueNonnegative } ...
      = simscape.Value(nan, "W")
    ...
    % is about 10%.
    IronToNominalLossRatioPercent double { mustBeInRange(IronToNominalLossRatioPercent, 0, 100) } = 0

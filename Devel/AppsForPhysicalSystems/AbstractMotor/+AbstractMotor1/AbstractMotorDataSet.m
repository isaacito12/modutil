classdef AbstractMotorDataSet < handle
  ...
  % a Motor & Drive (System-Level) block in a model, use the BlockPath option.
  ...
  properties
    ...
    PlotAngularSpeedMax simscape.Value ...
      {mustBeScalarOrEmpty, simscape.mustBeCommensurateUnit(PlotAngularSpeedMax, "rad/s")} ...
    ...
    MaxAngularSpeed (1,1) simscape.Value ...
      {CodeUtil1.mustBeSimscapeValuePositive} = simscape.Value(nan, "rpm")

    % -------------------------------------------------------------------------
    % Y axis - Motor torque

    % Plot upper bound of torque
    PlotTorqueMax simscape.Value ...
      {mustBeScalarOrEmpty, simscape.mustBeCommensurateUnit(PlotTorqueMax, "N*m")} ...
  ...
  methods
    ...
    function resetCommonSettings(DataSet)
      ...
      DataSet.PlotAngularSpeedMax = simscape.Value(18000, "rpm");

      DataSet.PlotTorqueMax = simscape.Value(200, "N*m");

classdef AbstractMotorEfficiencyAppMain < handle
  ...
  properties
    ...
    MaxAngularSpeedUI AppUtil1.Component.PhysicalValueUI
    MaxTorqueUI AppUtil1.Component.PhysicalValueUI
    MaxPowerUI AppUtil1.Component.PhysicalValueUI

    MeasuredEfficiencyPercentUI AppUtil1.Component.PhysicalValueUI
    MeasuredAngularSpeedUI AppUtil1.Component.PhysicalValueUI
    MeasuredTorqueUI AppUtil1.Component.PhysicalValueUI

    MeasuredIronLossUI AppUtil1.Component.PhysicalValueUI
    FixedLossUI AppUtil1.Component.PhysicalValueUI
    RotorDampingUI AppUtil1.Component.PhysicalValueUI

    % === Derived parameters

    % Nominal loss (rated loss) at efficiency measurement point
    MeasuredNominalLossUI AppUtil1.Component.PhysicalValueUI

    IronToNominalLossRatioPercentUI AppUtil1.Component.PhysicalValueUI

    MeasuredCopperLossUI AppUtil1.Component.PhysicalValueUI

    MeasuredIronLossCoefficientUI AppUtil1.Component.PhysicalValueUI
    MeasuredCopperLossCoefficientUI AppUtil1.Component.PhysicalValueUI
    ...
    ContoursUI AppUtil1.Component.PhysicalValueUI
    PlotAngularSpeedMaxUI AppUtil1.Component.PhysicalValueUI
    PlotTorqueMaxUI AppUtil1.Component.PhysicalValueUI
  ...
  methods
    ...
    function App = AbstractMotorEfficiencyAppMain(NameValuePair)
      ...
      if App.ModelName ~= ""
        ...
        try
          result = ModelUtil1.findSimscapeBlock(App.ModelName, App.TargetSimscapeBlockNames);
        catch exception
      ...
      App.PlotAngularSpeedMaxUI.UnitText = NameValuePair.PlotAngularSpeedUnit;
      App.PlotTorqueMaxUI.UnitText = NameValuePair.PlotTorqueUnit;
    ...
    function build_app_gui(App)
      ...
      App.DescriptionLinkUI.MainFigure = App.MainFigure;
      ...
      App.MaxAngularSpeedUI = AppUtil1.Component.PhysicalValueUI(appleft_v_layout);
      App.MaxAngularSpeedUI.MainFigure = App.MainFigure;
      ...
      App.MaxTorqueUI = AppUtil1.Component.PhysicalValueUI(appleft_v_layout);
      App.MaxTorqueUI.MainFigure = App.MainFigure;
      ...
      App.MaxPowerUI = AppUtil1.Component.PhysicalValueUI(appleft_v_layout);
      App.MaxPowerUI.MainFigure = App.MainFigure;
      ...
      App.MeasuredEfficiencyPercentUI = AppUtil1.Component.PhysicalValueUI(appleft_v_layout);
      App.MeasuredEfficiencyPercentUI.MainFigure = App.MainFigure;
      ...
      App.MeasuredAngularSpeedUI = AppUtil1.Component.PhysicalValueUI(appleft_v_layout);
      App.MeasuredAngularSpeedUI.MainFigure = App.MainFigure;
      ...
      App.MeasuredTorqueUI = AppUtil1.Component.PhysicalValueUI(appleft_v_layout);
      App.MeasuredTorqueUI.MainFigure = App.MainFigure;
      ...
      App.MeasuredIronLossUI = AppUtil1.Component.PhysicalValueUI(appleft_v_layout);
      App.MeasuredIronLossUI.MainFigure = App.MainFigure;
      ...
      App.FixedLossUI = AppUtil1.Component.PhysicalValueUI(appleft_v_layout);
      App.FixedLossUI.MainFigure = App.MainFigure;
      ...
      App.RotorDampingUI = AppUtil1.Component.PhysicalValueUI(appleft_v_layout);
      App.RotorDampingUI.MainFigure = App.MainFigure;
      ...
      App.MeasuredNominalLossUI = AppUtil1.Component.PhysicalValueUI(appleft_v_layout);
      App.MeasuredNominalLossUI.MainFigure = App.MainFigure;
      ...
      App.IronToNominalLossRatioPercentUI = AppUtil1.Component.PhysicalValueUI(appleft_v_layout);
      App.IronToNominalLossRatioPercentUI.MainFigure = App.MainFigure;
      ...
      App.MeasuredCopperLossUI = AppUtil1.Component.PhysicalValueUI(appleft_v_layout);
      App.MeasuredCopperLossUI.MainFigure = App.MainFigure;
      ...
      App.MeasuredIronLossCoefficientUI = AppUtil1.Component.PhysicalValueUI(appleft_v_layout);
      App.MeasuredIronLossCoefficientUI.MainFigure = App.MainFigure;
      ...
      App.MeasuredCopperLossCoefficientUI = AppUtil1.Component.PhysicalValueUI(appleft_v_layout);
      App.MeasuredCopperLossCoefficientUI.MainFigure = App.MainFigure;
      ...
      App.PlotButtonUI.MainFigure = App.MainFigure;
      % App.PlotButtonUI.ComponentWidth = "fit";
      ...
      App.OpenInFigureWindowUI.MainFigure = App.MainFigure;
      ...
      App.AxesUI.MainFigure = App.MainFigure;
      App.AxesUI.ComponentHeight = App.PlotUIHeight;

      % -----------------------------------------------------------------------
      appright_v_layout = addVerticalGridLayout(appright_v_container);

      App.ContoursUI = AppUtil1.Component.PhysicalValueUI(appright_v_layout);
      App.ContoursUI.MainFigure = App.MainFigure;
      ...
      App.ContoursUI.ValueChangedCallback = @() updateContours;
      function updateContours
        App.DataSet.ContourLevelsPercent = App.ContoursUI.SimscapeValue;
      ...
      App.PlotAngularSpeedMaxUI = AppUtil1.Component.PhysicalValueUI(appright_v_layout);
      App.PlotAngularSpeedMaxUI.MainFigure = App.MainFigure;
      App.PlotAngularSpeedMaxUI.NameUIWidth = App.width_unit * 20;
      App.PlotAngularSpeedMaxUI.UnitUIWidth = App.physical_unit_ui_width;
      App.PlotAngularSpeedMaxUI.NameText = CodeUtil1.i18n("Plot speed upper bound");
      App.PlotAngularSpeedMaxUI.UnitItems = App.angular_speed_unit_items;
      App.PlotAngularSpeedMaxUI.UnitText = "rpm";
      App.PlotAngularSpeedMaxUI.ValueText = "18000";

      App.PlotAngularSpeedMaxUI.ValueChangedCallback = @() updatePlotAngularSpeedMax;
      App.PlotAngularSpeedMaxUI.UnitChangedCallback = @() updatePlotAngularSpeedMax;
      function updatePlotAngularSpeedMax
        App.DataSet.PlotAngularSpeedMax = App.PlotAngularSpeedMaxUI.SimscapeValue;
        auto_update_plot(App)
      end  % nested function
      ...
      App.PlotTorqueMaxUI = AppUtil1.Component.PhysicalValueUI(appright_v_layout);
      App.PlotTorqueMaxUI.MainFigure = App.MainFigure;
      App.PlotTorqueMaxUI.NameUIWidth = App.width_unit * 20;
      App.PlotTorqueMaxUI.UnitUIWidth = App.physical_unit_ui_width;
      App.PlotTorqueMaxUI.NameText = CodeUtil1.i18n("Plot torque upper bound");
      App.PlotTorqueMaxUI.UnitItems = App.torque_unit_items;
      App.PlotTorqueMaxUI.UnitText = "N*m";
      App.PlotTorqueMaxUI.ValueText = "200";

      App.PlotTorqueMaxUI.ValueChangedCallback = @() updatePlotTorqueMax;
      App.PlotTorqueMaxUI.UnitChangedCallback = @() updatePlotTorqueMax;
      function updatePlotTorqueMax
        App.DataSet.PlotTorqueMax = App.PlotTorqueMaxUI.SimscapeValue;
        auto_update_plot(App)
      end  % nested function

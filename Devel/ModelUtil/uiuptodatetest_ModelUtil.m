classdef uiuptodatetest_ModelUtil < matlab.uitest.TestCase
  ...
  methods (Test)
    ...
    function app_screenshot_is_uptodate_1_dark(testcase)
      %%
      model_name = "samplemodel_LookupTable1DBlockPlotApp";
      modelfile_fullpath = FileUtil1.getFileFullPath(model_name);

      source_fullpath = FileUtil1.getFileFullPath("LookupTable1DBlockPlotApp.m");

      theme_name = "dark";
      destination_filename = "screenshot-LookupTable1DBlockPlotApp-" + theme_name + ".png";
    ...
    function app_screenshot_is_uptodate_2_light(testcase)
      %%
      model_name = "samplemodel_LookupTable1DBlockPlotApp";
      modelfile_fullpath = FileUtil1.getFileFullPath(model_name);

...
%
% If the ModelUtil folder is the current folder, start tests as follows.
%{
buildtool -verbosity Verbose Test
%}
% If the Devel folder is the current folder which contains the ModelUtil folder,
% start tests as follows.
%{
buildtool -buildFile ModelUtil/buildfile.m -verbosity Verbose Test
%}
%

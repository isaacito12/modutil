...
if FullpathToBlock == ""
  ...
  msg = CodeUtil1.i18n("Block path must be specified.");
...
if ParameterName == ""
  ...
  msg = CodeUtil1.i18n("Block parameter name must be specified.");
...
if isnan(v)
  ...
  if not(isnumeric(evaluation_result))
    ...
    msg = CodeUtil1.i18n("Specified parameter must be numeric or evaluated to numeric.");

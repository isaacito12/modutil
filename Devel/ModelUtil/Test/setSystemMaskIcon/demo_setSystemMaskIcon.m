...
refsub_name = ModelUtil1.setSystemMaskIcon;
...
ModelUtil1.setSystemMaskIcon(refsub_name, "New Text")
%[text] Open the model and see the updated block icon in the System Mask Editor.
%%
%[text] Clean up.
target_filename = refsub_name + ".mdl";
target_filefullpath = FileUtil1.getFileFullPath(target_filename, ReturnIfNotFound=true);
if target_filefullpath == ""
  target_filename = refsub_name + ".slx";
  target_filefullpath = FileUtil1.getFileFullPath(target_filename);
end  % if
...
%---
%[output:35e9223a]
%   data: {"dataType":"text","outputData":{"text":"Created: <a href=\"matlab:default_refsub\">default_refsub<\/a>\n","truncated":false}}
%---
%[output:422926e8]
%   data: {"dataType":"text","outputData":{"text":"Deleting: default_refsub.mdl\n","truncated":false}}
%---

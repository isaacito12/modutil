...
blocks = ModelUtil1.findLookupTable1DBlocks(model_name);
disp(blocks) %[output:90318ad7]
%[text] 
blocks = ModelUtil1.findLookupTable1DBlocks(model_name, SearchDepth=1);
disp(blocks) %[output:0326a7ad]
%[text] 
blocks = ModelUtil1.findLookupTable1DBlocks(model_name+"/Subsystem", SearchDepth=1);

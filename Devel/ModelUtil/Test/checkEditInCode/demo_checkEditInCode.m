...
result = ModelUtil1.checkEditInCode("edit(""demo_checkEditInCallbackButton"")", DisplayInfo=true); %[output:769dd1df]
disp(result) %[output:61a579a5]
%%
result = ModelUtil1.checkEditInCode("edit(""test1"")" + newline + "edit(""test2"")", DisplayInfo=true); %[output:33331f47]

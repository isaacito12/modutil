  ...
  methods (Test)
    ...
    function Test_error_1(testcase)
      ...
      function test_target
        ModelUtil1.getModelFileFullPath
      end  % nested function
    end  % function
    ...
    function Test_error_3(testcase)
      ...
      function test_target
        ModelUtil1.getModelFileFullPath("test-test-test")
      end  % nested function
    end  % function
    ...
    function Test_error_4(testcase)
      ...
      function test_target
        ModelUtil1.getModelFileFullPath("samplemodel_getModelFileFullPath_3")
      end  % nested function
    end  % function
    ...
    function PassingTest_1(~)
      ModelUtil1.getModelFileFullPath("samplemodel_getModelFileFullPath_1");
    end  % function

    function PassingTest_2(~)
      ModelUtil1.getModelFileFullPath("samplemodel_getModelFileFullPath_1.mdl");
    end  % function

    function PassingTest_3(~)
      ModelUtil1.getModelFileFullPath("samplemodel_getModelFileFullPath_2");
    end  % function

    function PassingTest_4(~)
      ModelUtil1.getModelFileFullPath("samplemodel_getModelFileFullPath_2.slx");
    end  % function

  ...
  methods (Test)
    ...
    function ErrorTest_1(testcase)
      ...
      function test_target()
        ModelUtil1.getDoubleValueFromBlockParameter
      end  % nested function
    end  % function
    ...
    function ErrorTest_2(testcase)
      ...
      function test_target()
        ModelUtil1.getDoubleValueFromBlockParameter("dummy_model_name")
      end  % nested function
    end  % function
    ...
    function Test_1(testcase)
      ...
      actual = ModelUtil1.getDoubleValueFromBlockParameter(block_path, "Value");
      expected = 1.23;
    ...
    function Test_2(testcase)
      ...
      actual = ModelUtil1.getDoubleValueFromBlockParameter(block_path, "BreakpointsForDimension1");
      expected = -5 : 5;
      verifyEqual(testcase, actual, expected)

      actual = ModelUtil1.getDoubleValueFromBlockParameter(block_path, "Table");
      expected = tanh(-5 : 5);
      verifyEqual(testcase, actual, expected)
    end  % function
    ...
    function Test_3(testcase)
      ...
      actual = ModelUtil1.getDoubleValueFromBlockParameter(block_path, "eff");
      expected = 100;
      verifyEqual(testcase, actual, expected)
    end  % function

  ...
  methods (Test)
    ...
    function Test_1(testcase)
      ...
      function test_target
        FileUtil1.getLinkedCommandFromText
      end  % nested function
    end  % function

    function Test_2(testcase)
      result = FileUtil1.getLinkedCommandFromText("no linked command in the text");
      verifyTrue(testcase, isempty(result))
    end  % function

    function Test_3(testcase)
      target_text = "[Linked text 1](matlab:command1)";
      result = FileUtil1.getLinkedCommandFromText(target_text);

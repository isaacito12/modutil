  ...
  methods (Test)
    ...
    function PassingTest_1(testcase)
      ...
      function test_target
        FileUtil1.isPlainTextLiveScript  % !test-target
      end  % nested function
    end  % function
    ...
    function Test_LiveScript_1_R2025a_or_newer(testcase)
      ...
      true_or_false = FileUtil1.isPlainTextLiveScript(mfiles);  % !test-target
    ...
    function Test_LiveScript_4_R2025a_or_newer(testcase)
      ...
      mfiles = paths(collection)';
      result= FileUtil1.isPlainTextLiveScript(mfiles);  % !test-target

...
% To force generate a new Markdown, set true to the ForceExport option.
...
arguments (Input)
  ...
  LiveScriptFilenames (:,1) string {FileUtil1.mustBeLiveScript} = "MyLiveScript.mlx"
...
for idx = 1 : numSourceFiles
  ...
  do_generate = FileUtil1.sourceFileIsNewer( ...
    Source = src, ...
    Destination = dst, ...

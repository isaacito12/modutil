classdef uiUptodateTest_FileListApp < matlab.uitest.TestCase
  ...
  methods (Test)
    ...
    function app_screenshot_1_dark(testcase)
      ...
      destination_folder = fullfile(destination_folder, "Devel", "BasicApps", "FileList", "mus1");
      ...
      destination_fullpath = fullfile(destination_folder, "screenshot-FileListApp-dark-1.png");
      ...
      if needs_update
        source_fullpath = mus1.FileUtil.getFileFullPath("uiUptodateTest_FileListApp.m");
        ...
        app = mus1_FileListApp(target_table, TopFolder=targetfolder_fullpath);  % !screenshot-target
    ...
    function app_screenshot_1_light(testcase)
      ...
      if mus1.TestUtil.isR2024bOrOlder
        ...
        destination_fullpath = fullfile(destination_folder, "screenshot-FileListApp-light-1.png");
      end  % if

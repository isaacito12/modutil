classdef uiUptodateTest_FolderSearchResultAppMain < matlab.uitest.TestCase
  ...
  methods (Test)
    ...
    function app_screenshot_1_dark(testcase)
      ...
      source_fullpath = mus1.FileUtil.getFileFullPath("mus1.SearchUtil.FolderSearchResultAppMain");
      ...
      destination_fullpath = fullfile(destination_folder, "screenshot-FolderSearchResultAppMain-dark-1.png");
      ...
      if needs_update
        app = mus1.SearchUtil.FolderSearchResultAppMain;  % !screenshot-target
    ...
    function app_screenshot_1_light(testcase)
      ...
      if mus1.TestUtil.isR2024bOrOlder
        destination_fullpath = fullfile(destination_folder, "screenshot-FolderSearchResultAppMain-24b.png");
      else
        destination_fullpath = fullfile(destination_folder, "screenshot-FolderSearchResultAppMain-light-1.png");
      end  % if

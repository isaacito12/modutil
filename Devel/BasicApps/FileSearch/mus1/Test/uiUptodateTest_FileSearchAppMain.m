classdef uiUptodateTest_FileSearchAppMain < matlab.uitest.TestCase
  ...
  methods (Test)
    ...
    function app_screenshot_1_dark(testcase)
      ...
      % R2025a or newer
      keyword = "FileSearch";
      source_fullpath = mus1.FileUtil.getFileFullPath("mus1.SearchUtil.FileSearchAppMain");
      ...
      destination_fullpath = fullfile(destination_folder, "screenshot-FileSearchAppMain-dark-1.png");
    ...
    function app_screenshot_1_light(testcase)
      ...
      if mus1.TestUtil.isR2024bOrOlder
        destination_fullpath = fullfile(destination_folder, "screenshot-FileSearchAppMain-24b.png");
      else
        destination_fullpath = fullfile(destination_folder, "screenshot-FileSearchAppMain-light-1.png");
      end  % if

classdef uiUptodateTest_TextSearchAppMain < matlab.uitest.TestCase
  ...
  methods (Test)
    ...
    function app_screenshot_1_dark(testcase)
      ...
      destination_fullpath = fullfile(destination_folder, "screenshot-TextSearchAppMain-dark.png");
    ...
    function app_screenshot_1_light(testcase)
      ...
      if mus1.TestUtil.isR2024bOrOlder
        ...
        destination_fullpath = fullfile(destination_folder, "screenshot-TextSearchAppMain-light.png");
      end  % if

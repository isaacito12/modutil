classdef uiTest_TextSearchResultAppMain < matlab.uitest.TestCase
  ...
  methods (Test)
    ...
    function clean_launch_1_1(testcase)
      verifyWarningFree(testcase, @mus1.SearchUtil.TextSearchResultAppMain)
    end  % function
    ...
    function Gesture_1(testcase)
      app = mus1.SearchUtil.TextSearchResultAppMain;

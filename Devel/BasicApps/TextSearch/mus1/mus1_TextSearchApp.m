function App = mus1_TextSearchApp(NameValuePair)
...
% Example:
%
%   mus1_TextSearchApp(TargetFolder=pwd, SearchText="hello", IgnoreCase=true)
%
...
%   mus1_TextSearchApp(StatesSource="external", SearchStates=states)
%

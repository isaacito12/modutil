...
releasing_file = fullfile(source_folder, "screenshot-LookupTable1DBlockPlotApp-dark-1.png");
safe_copyfile(releasing_file, destination_media_folder, NameValuePair.DryRun)

releasing_file = fullfile(source_folder, "screenshot-LookupTable1DBlockPlotApp-light-1.png");
safe_copyfile(releasing_file, destination_media_folder, NameValuePair.DryRun)

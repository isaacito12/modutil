...
% First, use the SearchUtil1.searchText to do a text search.
%
...
arguments (Output)
  App SearchUtil1.TextSearchResultViewerAppMain {mustBeScalarOrEmpty}
end  % arguments
...
app_main = SearchUtil1.TextSearchResultViewerAppMain(Searcher, SearchResult = result);

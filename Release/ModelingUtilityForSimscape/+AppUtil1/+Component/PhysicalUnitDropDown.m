classdef PhysicalUnitDropDown < AppUtil1.Component.ComponentBase
  ...
  properties
    ...
    DropDownUI AppUtil1.Component.DropDown
  ...
  methods (Access=protected)
    ...
    function setup(component)
      ...
      component.DropDownUI = AppUtil1.Component.DropDown(component.main_h_layout);
    ...
    function regular_update(component)
      ...
      if component.HighlightBackground
        ...
        if component.Reporting
          FileUtil1.displayTimeAndFileLocation("2:ThemeNameForBackGroundHighlight=" + component.ThemeNameForBackGroundHighlight)
        end  % if
  ...
  methods
    ...
    function set.UnitItems(component, NewUnitItems)
      ...
      arguments (Input)
        component
        NewUnitItems (1,:) string %{ CodeUtil1.mustBeAllCommensurateUnit }
      end  % arguments
      if component.Reporting
        FileUtil1.displayTimeAndFileLocation("1")
      end  % if
      ...
      if component.UnitSpecified
        ...
        msg = CodeUtil1.i18n("UnitItems can be defined only once.");
      ...
      try
        CodeUtil1.mustBePhysicalUnit(NewUnitItems)
        CodeUtil1.mustBeAllCommensurateUnit(NewUnitItems)
      catch exception
        ...
        if main_figure.Visible
          ...
          if component.Reporting
            FileUtil1.displayTimeAndFileLocation("3")
          end  % if
    ...
    function set.UnitText(component, NewUnitText)
      ...
      if component.Editable
        ...
        try
          CodeUtil1.mustBePhysicalUnit(NewUnitText)
        catch exception
        ...
        if component.UnitSpecified
          ...
          if not(ismember(NewUnitText, current_unit_items))
            if component.Reporting
              FileUtil1.displayTimeAndFileLocation("2:add:" + NewUnitText)
            end  % if
          ...
          if component.Reporting
            FileUtil1.displayTimeAndFileLocation("3:new:" + NewUnitText)
          end  % if

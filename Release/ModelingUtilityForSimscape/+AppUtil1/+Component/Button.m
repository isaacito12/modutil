classdef Button < AppUtil1.Component.ComponentBase
  % Button component
  %
  ...
  properties
    ...
    ButtonPushedCallback {CodeUtil1.mustBeFunctionHandleOrEmpty} = []

    ComponentWidth (1,:) {CodeUtil1.mustBeTextOrPositiveNumber} = "1x"
    ButtonWidth (1,:) {CodeUtil1.mustBeTextOrPositiveNumber} = AppUtil1.Constant.Width{"unitwidth"} * 10
    ...
    ButtonHeight (1,:) {CodeUtil1.mustBeTextOrPositiveNumber} = AppUtil1.Constant.Height{"oneline+"}

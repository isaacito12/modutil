classdef Hyperlink < AppUtil1.Component.ComponentBase
  % Hyperlink component
  ...
  properties
    ...
    HyperlinkClickedCallback {CodeUtil1.mustBeFunctionHandleOrEmpty} = []

    ComponentWidth (1,:) {CodeUtil1.mustBeTextOrPositiveNumber} = "1x";
    HyperlinkWidth (1,:) {CodeUtil1.mustBeTextOrPositiveNumber} = "fit";

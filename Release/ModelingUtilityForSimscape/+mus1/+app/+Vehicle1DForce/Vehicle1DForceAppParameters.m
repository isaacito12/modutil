classdef Vehicle1DForceAppParameters
  ...
  properties
    ...
    TireRollingCoefficient (1,1) double { mus1.CodeUtil.mustBePositiveOrNan } = 0.0136

    AirDragCoefficient (1,1) double { mus1.CodeUtil.mustBePositiveOrNan } = 0.31
    ...
    MaxAcceleration (1,1) double { mus1.CodeUtil.mustBePositiveOrNan } = 0.4
    ...
    PlotGrades (1,:) double { mus1.CodeUtil.mustBeNonnegativeOrNan } = [0, 5, 10, 20, 35]

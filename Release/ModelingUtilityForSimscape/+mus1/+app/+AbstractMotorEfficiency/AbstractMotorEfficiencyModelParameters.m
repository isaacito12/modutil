classdef AbstractMotorEfficiencyModelParameters
  ...
  properties
    ...
    MaxTorque simscape.Value ...
      { simscape.mustBeCommensurateUnit(MaxTorque, "N*m"), mus1.CodeUtil.mustBeSimscapeValuePositiveOrNan } ...
      = simscape.Value(nan, "N*m")

    MaxPower simscape.Value ...
      { simscape.mustBeCommensurateUnit(MaxPower, "kW"), mus1.CodeUtil.mustBeSimscapeValuePositiveOrNan } ...
    ...
    MeasuredAngularSpeed simscape.Value ...
      { simscape.mustBeCommensurateUnit(MeasuredAngularSpeed, "rpm"), mus1.CodeUtil.mustBeSimscapeValuePositiveOrNan } ...
      = simscape.Value(nan, "rpm")

    MeasuredTorque simscape.Value ...
      { simscape.mustBeCommensurateUnit(MeasuredTorque, "N*m"), mus1.CodeUtil.mustBeSimscapeValuePositiveOrNan } ...
      = simscape.Value(nan, "N*m")
    ...
    MeasuredIronLosses simscape.Value ...
      { simscape.mustBeCommensurateUnit(MeasuredIronLosses, "W"), mus1.CodeUtil.mustBeSimscapeValueNonnegativeOrNan } ...
      = simscape.Value(nan, "W")

    FixedLosses simscape.Value ...
      { simscape.mustBeCommensurateUnit(FixedLosses, "W"), mus1.CodeUtil.mustBeSimscapeValueNonnegativeOrNan } ...
      = simscape.Value(nan, "W")

    RotorDampingCoefficient simscape.Value ...
      { simscape.mustBeCommensurateUnit(RotorDampingCoefficient, "N*m/rpm"), mus1.CodeUtil.mustBeSimscapeValueNonnegativeOrNan } ...
    ...
    MeasuredNominalLosses simscape.Value ...
      { simscape.mustBeCommensurateUnit(MeasuredNominalLosses, "W"), mus1.CodeUtil.mustBeSimscapeValueNonnegativeOrNan } ...
      = simscape.Value(nan, "W")
    ...
    MeasuredCopperLosses simscape.Value ...
      { simscape.mustBeCommensurateUnit(MeasuredCopperLosses, "W"), mus1.CodeUtil.mustBeSimscapeValueNonnegativeOrNan } ...
      = simscape.Value(nan, "W")
  ...
  methods
    ...
    function ModelParams = updateDerivedParameters(ModelParams)
      ...
      if ModelParams.MaxTorque < ModelParams.MeasuredTorque
        ...
        msg = mus1.CodeUtil.i18n("Torque at measurement point cannot be greater than max torque.");
      ...
      if ModelParams.MaxPower / ModelParams.MaxTorque < ModelParams.MeasuredAngularSpeed
        ...
        msg = mus1.CodeUtil.i18n("MeasuredAngularSpeed cannot be higher than the speed determined from max power and max torque.");
      ...
      if measured_nominal_losses <= ModelParams.MeasuredIronLosses
        ...
        msg = mus1.CodeUtil.i18n("Iron losses cannot be higher than nominal losses.");

...
arguments (Input)
  ...
  NameValuePair.RotorDamping (1,1) simscape.Value ...
      { simscape.mustBeCommensurateUnit(NameValuePair.RotorDamping, "N*m/rpm"), mus1.CodeUtil.mustBeSimscapeValueNonnegativeOrNan } ...
...
xlabel(ax, mus1.CodeUtil.i18n("Angular speed, $\omega$ (" + plot_speed_unit_text + ")"), Interpreter="latex")

ylabel(ax, mus1.CodeUtil.i18n("Torque, $\tau$ (" + plot_torque_unit_text + ")"), Interpreter="latex")

title(ax, [
  mus1.CodeUtil.i18n("Overall power conversion efficiency (%)")
  mus1.CodeUtil.i18n("Measured point (x): ") ...

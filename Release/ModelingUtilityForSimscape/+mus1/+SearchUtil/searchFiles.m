...
% 
%   mus1.SearchUtil.searchFile("*.ssc", TopFolder=fullfile(matlabroot, "toolbox", "physmod", "simscape", "library", "m", "+foundation"))
...
if Filename == ""
  ...
  msg = mus1.CodeUtil.i18n("Empty filename is not allowed.");

classdef EnabledButton < mus1.AppUtil.Component.ComponentBase
  ...
  properties
    ButtonPushedCallback {mus1.CodeUtil.mustBeFunctionHandleOrEmpty} = []

    CheckBoxValueChangedCallback {mus1.CodeUtil.mustBeFunctionHandleOrEmpty} = []
    ...
    ButtonUIWidth (1,:) {mus1.CodeUtil.mustBeTextOrPositiveNumber} = mus1.AppUtil.Constant.Width{"unitwidth"} * 11
    ButtonWidth (1,:) {mus1.CodeUtil.mustBeTextOrPositiveNumber} = mus1.AppUtil.Constant.Width{"unitwidth"} * 10
    ButtonHeight (1,:) {mus1.CodeUtil.mustBeTextOrPositiveNumber} = mus1.AppUtil.Constant.Height{"oneline+"}

    CheckBoxUIWidth (1,:) {mus1.CodeUtil.mustBeTextOrPositiveNumber} = "fit"
    CheckBoxWidth (1,:) {mus1.CodeUtil.mustBeTextOrPositiveNumber} = "fit"
    % There is no CheckBoxHeight property.
    % The height of the main check box is fixed by uicheckbox.

    ButtonUI mus1.AppUtil.Component.Button
    CheckBoxUI mus1.AppUtil.Component.CheckBox {mustBeScalarOrEmpty}
  ...
  methods (Access=protected)
    ...
    function setup(component)
      ...
      % -----------------------------------------------------------------------
      % Button
      component.ButtonUI = mus1.AppUtil.Component.Button(component.composite_grid);
      ...
      % -----------------------------------------------------------------------
      % Check box
      component.CheckBoxUI = mus1.AppUtil.Component.CheckBox(component.composite_grid);

classdef DoubleValueUI < mus1.AppUtil.Component.ComponentBase
  ...
  properties
    ...
    double_value (1,:) mus1.CodeUtil.DoubleValue
  ...
  properties
    ...
    SideNoteUIWidth (1,:) {mus1.CodeUtil.mustBeTextOrPositiveNumber} = 1
    ...
    SideNoteUI mus1.AppUtil.Component.Label
  ...
  methods (Access=protected)
    ...
    function setup(component)
      ...
      component.double_value = mus1.CodeUtil.DoubleValue;
      ...
      component.NameUI.Text = mus1.CodeUtil.i18n("Double value");
      ...
      component.SideNoteUI = mus1.AppUtil.Component.Label(component.sidenote_layout);
  ...
  methods
    ...
    function updateInfoUI(component)
      ...
      squashed_value_text = mus1.CodeUtil.squashCodeText(mus1.CodeUtil.stringify(dbl_val));

classdef SignalDesignAppMain < handle
  ...
  methods
    ...
    function App = SignalDesignAppMain(NameValuePair)
      ...
      App.Window.Name = CodeUtil1.i18n("Signal Design App");
    ...
    function change_design_matrix(App)
      ...
      App.TableGridVectorUI.ValueText = CodeUtil1.stringify(result.X');
      App.TableValuesUI.ValueText = CodeUtil1.stringify(result.F');
    ...
    function update_plot(App, NameValuePair)
      ...
      if App.AutoRangeUI.Value
        vec = CodeUtil1.getNumberArrayFromText(App.TableGridVectorUI.ValueText);
        lb = vec(1);
        ub = vec(end);

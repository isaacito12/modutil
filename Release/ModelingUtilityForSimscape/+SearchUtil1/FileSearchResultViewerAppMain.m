classdef FileSearchResultViewerAppMain < handle
  ...
  properties (Access=private, Constant)
    errorID (1,1) string = "FileSearchResultViewerAppMain:"
  end  % properties
  ...
  methods
    ...
    function App = FileSearchResultViewerAppMain(NameValuePair)
      %%
    ...
    function build_app_gui(App)
      ...
      label_ui = AppUtil1.Component.Label(NewRowGrid(row_layout, Width="fit"));
      label_ui.ComponentWidth = App.width_name_ui;
      label_ui.Text = CodeUtil1.i18n("Searched filename");

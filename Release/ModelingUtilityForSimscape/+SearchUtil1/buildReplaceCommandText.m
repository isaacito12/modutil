...
if not(isfield(NameValuePair, "FilePaths"))
  ...
  msg = CodeUtil1.i18n("FilePaths must be specified.");
...
if not(isfield(NameValuePair, "TextPattern"))
  ...
  msg = CodeUtil1.i18n("TextPattern must be specified.");
...
if not(isfield(NameValuePair, "IgnoreCase"))
  ...
  msg = CodeUtil1.i18n("IgnoreCase must be specified.");
...
if not(isfield(NameValuePair, "MatchWholeWord"))
  ...
  msg = CodeUtil1.i18n("MatchWholeWord must be specified.");
...
if not(isfield(NameValuePair, "NewText"))
  ...
  msg = CodeUtil1.i18n("NewText must be specified.");
...
if isempty(which(NameValuePair.CommandName))
  ...
  msg = CodeUtil1.i18n("The command specified for CommandName must be on MATLAB path: ") + NameValuePair.CommandName;
...
if pat_str == ""
  ...
  msg = CodeUtil1.i18n("TextPattern must be non-empty.");
...
if new_text == ""
  ...
  msg = CodeUtil1.i18n("NewText must be non-empty.");

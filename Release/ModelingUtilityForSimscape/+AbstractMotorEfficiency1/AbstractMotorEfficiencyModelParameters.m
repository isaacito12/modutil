classdef AbstractMotorEfficiencyModelParameters
  ...
  properties
    ...
    MeasuredIronLosses simscape.Value ...
      { simscape.mustBeCommensurateUnit(MeasuredIronLosses, "W"), CodeUtil1.mustBeSimscapeValueNonnegativeOrNan } ...
      = simscape.Value(nan, "W")

    FixedLosses simscape.Value ...
      { simscape.mustBeCommensurateUnit(FixedLosses, "W"), CodeUtil1.mustBeSimscapeValueNonnegativeOrNan } ...
      = simscape.Value(nan, "W")

    RotorDampingCoefficient simscape.Value ...
      { simscape.mustBeCommensurateUnit(RotorDampingCoefficient, "N*m/rpm"), CodeUtil1.mustBeSimscapeValueNonnegativeOrNan } ...
    ...
    MeasuredNominalLosses simscape.Value ...
      { simscape.mustBeCommensurateUnit(MeasuredNominalLosses, "W"), CodeUtil1.mustBeSimscapeValueNonnegativeOrNan } ...
      = simscape.Value(nan, "W")
    ...
    MeasuredCopperLosses simscape.Value ...
      { simscape.mustBeCommensurateUnit(MeasuredCopperLosses, "W"), CodeUtil1.mustBeSimscapeValueNonnegativeOrNan } ...
      = simscape.Value(nan, "W")
  ...
  methods
    ...
    function ModelParams = updateDerivedParameters(ModelParams)
      ...
      if ModelParams.MaxTorque < ModelParams.MeasuredTorque
        ...
        msg = CodeUtil1.i18n("Torque at measurement point cannot be greater than max torque.");
      ...
      if ModelParams.MaxPower / ModelParams.MaxTorque < ModelParams.MeasuredAngularSpeed
        ...
        msg = CodeUtil1.i18n("MeasuredAngularSpeed cannot be higher than the speed determined from max power and max torque.");
      ...
      if measured_nominal_losses <= ModelParams.MeasuredIronLosses
        ...
        msg = CodeUtil1.i18n("Iron losses cannot be higher than nominal losses.");

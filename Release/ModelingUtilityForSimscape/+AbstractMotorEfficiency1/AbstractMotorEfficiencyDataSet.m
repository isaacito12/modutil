classdef AbstractMotorEfficiencyDataSet
  ...
  properties
    ...
    ModelParams (1,1) AbstractMotorEfficiency1.AbstractMotorEfficiencyModelParameters
  ...
  methods
    ...
    function DataSet = AbstractMotorEfficiencyDataSet(NameValuePair)
      ...
      DataSet.ModelParams = AbstractMotorEfficiency1.AbstractMotorEfficiencyModelParameters;

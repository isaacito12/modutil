...
arguments (Input)
  ...
  NameValuePair.DataSet AbstractMotorEfficiency1.AbstractMotorEfficiencyDataSet {mustBeScalarOrEmpty}
...
if NameValuePair.DataSource == "direct"
  ...
  if isfield(NameValuePair, "DataSet")
    ...
    DataSet = AbstractMotorEfficiency1.AbstractMotorEfficiencyDataSet(Initialization=true);
  end  % if

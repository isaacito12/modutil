classdef AbstractMotorEfficiencyAppMain < handle
  ...
  properties
    ...
    DataSet (1,1) AbstractMotorEfficiency1.AbstractMotorEfficiencyDataSet
  ...
  methods
    ...
    function App = AbstractMotorEfficiencyAppMain(NameValuePair)
      ...
      App.DataSet = AbstractMotorEfficiency1.AbstractMotorEfficiencyDataSet(Initialization=true);
    ...
    function callback_get_parameters(App)
      ...
      try
        App.DataSet = AbstractMotorEfficiency1.AbstractMotorEfficiencyDataSet(BlockPath=block_path);
      catch exception

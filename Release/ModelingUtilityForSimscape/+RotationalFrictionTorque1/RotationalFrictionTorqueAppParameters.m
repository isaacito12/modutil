classdef RotationalFrictionTorqueAppParameters
  ...
  properties
    ...
    BreakawayTorque (1,1) simscape.Value ...
      { simscape.mustBeCommensurateUnit(BreakawayTorque, "N*m"), CodeUtil1.mustBeSimscapeValuePositiveOrNan } ...
      = simscape.Value(25, "N*m")

    BreakawayVelocity (1,1) simscape.Value ...
      { simscape.mustBeCommensurateUnit(BreakawayVelocity, "rad/s"), CodeUtil1.mustBeSimscapeValuePositiveOrNan } ...
      = simscape.Value(0.1, "rad/s")

    CoulombTorque (1,1) simscape.Value ...
      { simscape.mustBeCommensurateUnit(CoulombTorque, "N*m"), CodeUtil1.mustBeSimscapeValuePositiveOrNan } ...
      = simscape.Value(20, "N*m")

    ViscousCoefficient (1,1) simscape.Value ...
      { simscape.mustBeCommensurateUnit(ViscousCoefficient, "N*m*s/rad"), CodeUtil1.mustBeSimscapeValuePositiveOrNan } ...

...
arguments (Input)
  ...
  NameValuePair.VehicleMass (1,1) simscape.Value ...
    { simscape.mustBeCommensurateUnit(NameValuePair.VehicleMass, "kg"), CodeUtil1.mustBeSimscapeValuePositiveOrNan } ...
  ...
  NameValuePair.FrontalArea (1,1) simscape.Value ...
    { simscape.mustBeCommensurateUnit(NameValuePair.FrontalArea, "m^2"), CodeUtil1.mustBeSimscapeValuePositiveOrNan } ...
    = simscape.Value(2.3, "m^2")

  NameValuePair.GravitationalAcceleration (1,1) simscape.Value ...
    { simscape.mustBeCommensurateUnit(NameValuePair.GravitationalAcceleration, "m/s^2"), CodeUtil1.mustBeSimscapeValuePositiveOrNan } ...
    = simscape.Value(9.81, "m/s^2")

  NameValuePair.DryAirDensity (1,1) simscape.Value ...
    { simscape.mustBeCommensurateUnit(NameValuePair.DryAirDensity, "kg/m^3"), CodeUtil1.mustBeSimscapeValuePositiveOrNan } ...
    = simscape.Value(1.184, "kg/m^3")

  NameValuePair.RoadLoadB (1,1) simscape.Value ...
    { simscape.mustBeCommensurateUnit(NameValuePair.RoadLoadB, "N/(km/hr)"), CodeUtil1.mustBeSimscapeValueNonnegativeOrNan } ...
    = simscape.Value(0, "N/(km/hr)")

  NameValuePair.TopSpeed (1,1) simscape.Value ...
    { simscape.mustBeCommensurateUnit(NameValuePair.TopSpeed, "km/hr"), CodeUtil1.mustBeSimscapeValuePositiveOrNan } ...
  ...
  NameValuePair.PlotPowers (1,:) simscape.Value ...
    { simscape.mustBeCommensurateUnit(NameValuePair.PlotPowers, "kW"), CodeUtil1.mustBeSimscapeValueNonnegativeOrNan } ...
  ...
  NameValuePair.PlotSpeedUpperBound (1,1) simscape.Value ...
    { simscape.mustBeCommensurateUnit(NameValuePair.PlotSpeedUpperBound, "km/hr"), CodeUtil1.mustBeSimscapeValuePositiveOrNan } ...
  ...
  NameValuePair.PlotForceUpperBound (1,1) simscape.Value ...
    {simscape.mustBeCommensurateUnit(NameValuePair.PlotForceUpperBound, "N"), CodeUtil1.mustBeSimscapeValuePositiveOrNan } ...

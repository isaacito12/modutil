...
arguments (Input)
  ...
  NameValuePair.VehicleMass (1,1) simscape.Value ...
    { simscape.mustBeCommensurateUnit(NameValuePair.VehicleMass, "kg"), mus1.CodeUtil.mustBeSimscapeValuePositiveOrNan } ...
  ...
  NameValuePair.FrontalArea (1,1) simscape.Value ...
    { simscape.mustBeCommensurateUnit(NameValuePair.FrontalArea, "m^2"), mus1.CodeUtil.mustBeSimscapeValuePositiveOrNan } ...
    = simscape.Value(2.3, "m^2")

  NameValuePair.GravitationalAcceleration (1,1) simscape.Value ...
    { simscape.mustBeCommensurateUnit(NameValuePair.GravitationalAcceleration, "m/s^2"), mus1.CodeUtil.mustBeSimscapeValuePositiveOrNan } ...
    = simscape.Value(9.81, "m/s^2")

  NameValuePair.DryAirDensity (1,1) simscape.Value ...
    { simscape.mustBeCommensurateUnit(NameValuePair.DryAirDensity, "kg/m^3"), mus1.CodeUtil.mustBeSimscapeValuePositiveOrNan } ...
    = simscape.Value(1.184, "kg/m^3")

  NameValuePair.RoadLoadB (1,1) simscape.Value ...
    { simscape.mustBeCommensurateUnit(NameValuePair.RoadLoadB, "N/(km/hr)"), mus1.CodeUtil.mustBeSimscapeValueNonnegativeOrNan } ...
    = simscape.Value(0, "N/(km/hr)")

  NameValuePair.TopSpeed (1,1) simscape.Value ...
    { simscape.mustBeCommensurateUnit(NameValuePair.TopSpeed, "km/hr"), mus1.CodeUtil.mustBeSimscapeValuePositiveOrNan } ...
  ...
  NameValuePair.PlotSpeedUpperBound (1,1) simscape.Value ...
    { simscape.mustBeCommensurateUnit(NameValuePair.PlotSpeedUpperBound, "km/hr"), mus1.CodeUtil.mustBeSimscapeValuePositiveOrNan } ...
  ...
  NameValuePair.PlotForceUpperBound (1,1) simscape.Value ...
    {simscape.mustBeCommensurateUnit(NameValuePair.PlotForceUpperBound, "N"), mus1.CodeUtil.mustBeSimscapeValuePositiveOrNan } ...

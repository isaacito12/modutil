classdef AbstractMotorEfficiencyAppMain < handle
  ...
  properties
    ...
    DataSet (1,1) mus1.app.AbstractMotorEfficiency.AbstractMotorEfficiencyDataSet
    ...
    ElectricalEfficiencyPercentUI mus1.AppUtil.Component.PhysicalValueWithUnitLabel
  ...
  properties (Constant, Access=private)
    ...
    name_ui_width = mus1.AppUtil.Constant.Width{"unitwidth"} * 27
  ...
  methods
    ...
    function App = AbstractMotorEfficiencyAppMain(NameValuePair)
      ...
      App.DataSet = mus1.app.AbstractMotorEfficiency.AbstractMotorEfficiencyDataSet(Initialization=true);
    ...
    function build_app_gui(App)
      ...
      App.DescriptionLinkUI.HyperlinkClickedCallback = @() web("AbstractMotorEfficiencyApp_Description_mus1.html");
      ...
      App.ElectricalEfficiencyPercentUI = mus1.AppUtil.Component.PhysicalValueWithUnitLabel(appleft_v_layout);
      ...
      App.ElectricalEfficiencyPercentUI.NameText = mus1.CodeUtil.i18n("Overall electrical efficiency, $\eta(\omega_{m}, \tau_{m})$");
      ...
      App.MeasuredAngularSpeedUI.NameText = mus1.CodeUtil.i18n("Speed at measurement point, $\omega_{m}$");
      ...
      App.MeasuredTorqueUI.NameText = mus1.CodeUtil.i18n("Torque at measurement point, $\tau_{m}$");
      ...
      App.MeasuredIronLossesUI.NameText = mus1.CodeUtil.i18n("Iron losses at measurement point, $P_{iron,m}$");
      ...
      label_ui.Text = mus1.CodeUtil.i18n("$P_{nom,m} = \left( 100/\eta - 1  \right) \tau_{m} \cdot \omega_{m}$");
      ...
      label_ui = mus1.AppUtil.Component.Label(h_layout);
      label_ui.ComponentHeight = App.oneline_height;
      label_ui.Text = mus1.CodeUtil.i18n("$P_{copper,m} = P_{nom,m} - P_{iron,m} - P_{fixed}$");
      ...
      label_ui = mus1.AppUtil.Component.Label(h_layout);
      label_ui.ComponentHeight = App.oneline_height;
      label_ui.Text = mus1.CodeUtil.i18n("$ = k_{copper} \cdot \tau_{m}^2$");
      ...
      label_ui = mus1.AppUtil.Component.Label(h_layout);
      label_ui.ComponentHeight = App.oneline_height;
      label_ui.Text = mus1.CodeUtil.i18n("$k_{iron} = P_{iron,m} / \omega_{m}^2$");
      ...
      label_ui = mus1.AppUtil.Component.Label(h_layout);
      label_ui.ComponentHeight = App.oneline_height;
      label_ui.Text = mus1.CodeUtil.i18n("$k_{copper} = P_{copper,m} / \tau_{m}^2$");
    ...
    function callback_get_parameters(App)
      ...
      try
        App.DataSet = mus1.app.AbstractMotorEfficiency.AbstractMotorEfficiencyDataSet(BlockPath=block_path);
      catch exception

classdef AbstractMotorEfficiencyDataSet
  ...
  properties
    ...
    ModelParams (1,1) mus1.app.AbstractMotorEfficiency.AbstractMotorEfficiencyModelParameters
  ...
  methods
    ...
    function DataSet = AbstractMotorEfficiencyDataSet(NameValuePair)
      ...
      DataSet.ModelParams = mus1.app.AbstractMotorEfficiency.AbstractMotorEfficiencyModelParameters;
      ...
      if DataSet.ModelName == ""
        ...
        DataSet.ModelParams.ElectricalEfficiencyPercent = mus1.ModelUtil.getDoubleValueFromBlockParameter(DataSet.BlockPath, "eff");

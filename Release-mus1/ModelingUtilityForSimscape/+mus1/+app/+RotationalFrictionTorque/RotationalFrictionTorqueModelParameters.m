classdef RotationalFrictionTorqueModelParameters
  ...
  properties
    ...
    BreakawayTorque (1,1) simscape.Value ...
      { simscape.mustBeCommensurateUnit(BreakawayTorque, "N*m"), mus1.CodeUtil.mustBeSimscapeValuePositiveOrNan } ...
      = simscape.Value(nan, "N*m")

    BreakawayVelocity (1,1) simscape.Value ...
      { simscape.mustBeCommensurateUnit(BreakawayVelocity, "rad/s"), mus1.CodeUtil.mustBeSimscapeValuePositiveOrNan } ...
      = simscape.Value(nan, "rad/s")

    CoulombTorque (1,1) simscape.Value ...
      { simscape.mustBeCommensurateUnit(CoulombTorque, "N*m"), mus1.CodeUtil.mustBeSimscapeValuePositiveOrNan } ...
      = simscape.Value(nan, "N*m")

    ViscousCoefficient (1,1) simscape.Value ...
      { simscape.mustBeCommensurateUnit(ViscousCoefficient, "N*m*s/rad"), mus1.CodeUtil.mustBeSimscapeValuePositiveOrNan } ...

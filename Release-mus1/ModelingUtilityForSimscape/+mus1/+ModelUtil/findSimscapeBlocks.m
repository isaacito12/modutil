...
if ModelName == ""
  ...
  msg = mus1.CodeUtil.i18n("Model name must be specified.");
...
if SimscapeBlockNames == ""
  ...
  msg = mus1.CodeUtil.i18n("Simscape block name must be specified.");

  throw(MException(id, msg))

end  % if

blocks_table = mus1.ModelUtil.findAllSimscapeBlocks(ModelName);

if isempty(blocks_table)
  id = errorID + "SimscapeBlockNotFound";
  msg = mus1.CodeUtil.i18n("Specified model does not have any Simscape blocks.");

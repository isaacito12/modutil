classdef PhysicalValue < handle
  ...
  % For example,
  %{
        physval = mus1.CodeUtil.PhysicalValue;
        physval.UnitText = "kg";
  ...
  methods
    ...
    function physval = PhysicalValue(NameValuePair)
      ...
      if (NameValuePair.UnitText == "") && (NameValuePair.UnitAlias == "") && (NameValuePair.ValueText == "")
        if physval.Reporting
          mus1.FileUtil.displayTimeAndFileLocation("1:ok")
        end  % if
        return
      ...
      elseif (NameValuePair.UnitText ~= "") && (NameValuePair.UnitAlias ~= "")
        ...
        if NameValuePair.UnitText ~= "1"
          if physval.Reporting
            mus1.FileUtil.displayTimeAndFileLocation("2.1:error")
          end  % if
          id = physval.classID + functionID + "InvalidUnitTextForUnitAlias";
          msg = mus1.CodeUtil.i18n("UnitText must be ""1"" when UnitAlias is specified.");
        ...
        if NameValuePair.ValueText == ""
          if physval.Reporting
            mus1.FileUtil.displayTimeAndFileLocation("2.2:ok")
          end  % if
          return
          ...
          try
            ...
            if physval.Reporting
              mus1.FileUtil.displayTimeAndFileLocation("2.3:error")
            end  % if
          ...
          if physval.Reporting
            mus1.FileUtil.displayTimeAndFileLocation("2.4:ok")
          end  % if
        end  % if
        return
      ...
      elseif (NameValuePair.UnitText ~= "") && (NameValuePair.UnitAlias == "") && (NameValuePair.ValueText == "")
        if physval.Reporting
          mus1.FileUtil.displayTimeAndFileLocation("3:ok")
        end  % if
      ...
      elseif (NameValuePair.UnitText == "") && (NameValuePair.UnitAlias ~= "") && (NameValuePair.ValueText == "")
        if physval.Reporting
          mus1.FileUtil.displayTimeAndFileLocation("4:ok")
        end  % if
        physval.UnitAlias = NameValuePair.UnitAlias;
        return
      ...
      elseif (NameValuePair.UnitText == "") && (NameValuePair.UnitAlias == "") && (NameValuePair.ValueText ~= "")
        if physval.Reporting
          mus1.FileUtil.displayTimeAndFileLocation("5:ok")
        end  % if
        physval.ValueText = NameValuePair.ValueText;
        return
      ...
      elseif (NameValuePair.UnitText ~= "") && (NameValuePair.UnitAlias == "") && (NameValuePair.ValueText ~= "")
        ...
        try
          ...
          if physval.Reporting
            mus1.FileUtil.displayTimeAndFileLocation("6.1:error")
          end  % if
        ...
        if physval.Reporting
          mus1.FileUtil.displayTimeAndFileLocation("6.2:ok")
        end  % if
        return
      ...
      elseif (NameValuePair.UnitText == "") && (NameValuePair.UnitAlias ~= "") && (NameValuePair.ValueText ~= "")
        ...
        try
          ...
          if physval.Reporting
            mus1.FileUtil.displayTimeAndFileLocation("7.1:error")
          end  % if
        ...
        if physval.Reporting
          mus1.FileUtil.displayTimeAndFileLocation("7.2:ok")
        end  % if
        return
    ...
    function processValueText(physval, value_text)
      ...
      if physval.initialized && isscalar(value_text) && (value_text == "")
        if physval.Reporting
          mus1.FileUtil.displayTimeAndFileLocation("2:nan:" + physval.current_unit_text)
        end  % if
      ...
      if not(isnan(x))
        if physval.Reporting
          mus1.FileUtil.displayTimeAndFileLocation("3:numeric:" + physval.current_unit_text)
        end  % if
      ...
      try
        ...
        result = mus1.CodeUtil.getDoubleOrSimscapeValueFromText(value_text);
      catch exception
        id = functionID + "InvalidValueText";
        msg = mus1.CodeUtil.i18n("Invalid ValueText. ") + exception.message;
      ...
      if isa(result, "double")
        if physval.Reporting
          mus1.FileUtil.displayTimeAndFileLocation("4:numeric:" + physval.current_unit_text)
        end  % if
        physval.ValueTextIsSimscapeValue = false;
        ...
        if physval.Reporting
          mus1.FileUtil.displayTimeAndFileLocation("5:simscape.Value:" + new_unit)
        end  % if
        if physval.initialized && not(simscape.isCommensurateUnit(new_unit, physval.current_unit_text))
          ...
          msg = mus1.CodeUtil.i18n("Unit must be commensurate with the currently defined unit.");
    ...
    function set.UnitText(physval, NewUnitText)
      ...
      try
        ...
        msg = mus1.CodeUtil.i18n("Invalid unit: ") + exception.message;
      ...
      if physval.initialized && not(simscape.isCommensurateUnit(NewUnitText, physval.current_unit_text))
        id = functionID + "UnitIsNotCommensurate";
        msg = mus1.CodeUtil.i18n("New unit must be commensurate with the currently defined unit.");
    ...
    function set.UnitAlias(physval, NewUnitAlias)
      ...
      if physval.initialized && (physval.current_unit_text ~= "1")
        ...
        msg = mus1.CodeUtil.i18n("Unit alias is allowed only if UnitText is ""1"".");
    ...
    function set.SimscapeValue(physval, x)
      ...
      if physval.current_unit_alias ~= "" && new_unit_text ~= "1"
        ...
        msg = mus1.CodeUtil.i18n("The unit must be ""1"" because unit alias is defined.");
      ...
      if not(simscape.isCommensurateUnit(new_unit_text, physval.current_unit_text))
        id = functionID + "UnitIsNotCommensurate";
        msg = mus1.CodeUtil.i18n("The unit of the specified SimscapeValue is not commensurate with the current unit.");

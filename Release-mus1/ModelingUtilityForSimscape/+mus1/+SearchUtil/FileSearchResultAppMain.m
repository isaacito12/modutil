classdef FileSearchResultAppMain < handle
  ...
  methods
    ...
    function App = FileSearchResultAppMain(NameValuePair)
      ...
      App.Window.Name = mus1.CodeUtil.i18n("File search result");
    ...
    function build_app_gui(App)
      ...
      App.NewSearchButtonUI = mus1.AppUtil.Component.Button(addHorizontalGridLayout(horizontal_container));
      ...
      App.NewSearchButtonUI.MainButton.Tooltip = mus1.CodeUtil.i18n("Open the file search app.");
      ...
      label_ui = mus1.AppUtil.Component.Label(addHorizontalGridLayout(horizontal_container, Width="fit"));
      label_ui.ComponentWidth = App.width_name_ui;
      label_ui.Text = mus1.CodeUtil.i18n("Searched file name");
      ...
      App.NumMatchesUI = mus1.AppUtil.Component.EditField(addHorizontalGridLayout(horizontal_container, Width="1x"));
      ...
      App.RefreshButtonUI = mus1.AppUtil.Component.Button(addHorizontalGridLayout(horizontal_container, Width="fit"));
      ...
      App.TableUI = mus1.AppUtil.Component.Table(column_grid);
      App.TableUI.ComponentHeight = "fit";
      if App.SearchResult ~= ""
        App.TableUI.MainTable.Data = table(App.SearchResult);
        App.TableUI.MainTable.ColumnName = mus1.CodeUtil.i18n("File path");
    ...
    function react_NewSearch(App)
      if App.TopFolder ~= "" && App.SearchFileName ~= ""
        mus1.SearchUtil.FileSearchAppMain(TopFolder=App.TopFolder, SearchFileName=App.SearchFileName)
      else
        mus1.SearchUtil.FileSearchAppMain
      end  % if
    end  % function

    function react_RefreshButtonPushed(App)
      FilePath = mus1.SearchUtil.searchFiles(App.SearchFileName, TopFolder=App.TopFolder);

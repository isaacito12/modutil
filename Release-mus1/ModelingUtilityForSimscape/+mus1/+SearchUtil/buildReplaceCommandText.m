...
%     "/path/to/file2"
%     ];
%   result = mus1.SearchUtil.replaceText( ...
%     file_paths, ...
%     DryRun = true, ...
%     TextPattern = "old",
%     IgnoreCase = true, ...
...
arguments (Input)
  ...
  NameValuePair.CommandName (1,1) string = "mus1.SearchUtil.replaceText"
...
if not(isfield(NameValuePair, "FilePaths"))
  ...
  msg = mus1.CodeUtil.i18n("FilePaths must be specified.");
...
if not(isfield(NameValuePair, "TextPattern"))
  ...
  msg = mus1.CodeUtil.i18n("TextPattern must be specified.");
...
if not(isfield(NameValuePair, "IgnoreCase"))
  ...
  msg = mus1.CodeUtil.i18n("IgnoreCase must be specified.");
...
if not(isfield(NameValuePair, "MatchWholeWord"))
  ...
  msg = mus1.CodeUtil.i18n("MatchWholeWord must be specified.");
...
if not(isfield(NameValuePair, "NewText"))
  ...
  msg = mus1.CodeUtil.i18n("NewText must be specified.");
...
if isempty(which(NameValuePair.CommandName))
  ...
  msg = mus1.CodeUtil.i18n("The command specified for CommandName must be on MATLAB path: ") + NameValuePair.CommandName;
...
if pat_str == ""
  ...
  msg = mus1.CodeUtil.i18n("TextPattern must be non-empty.");
...
if new_text == ""
  ...
  msg = mus1.CodeUtil.i18n("NewText must be non-empty.");

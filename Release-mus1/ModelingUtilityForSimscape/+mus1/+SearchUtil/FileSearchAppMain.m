classdef FileSearchAppMain < handle
  ...
  properties
    ...
    SearchFileNameUI mus1.AppUtil.Component.DropDown
  ...
  methods
    ...
    function App = FileSearchAppMain(NameValuePair)
      ...
      App.Window.Name = mus1.CodeUtil.i18n("File search");
    ...
    function build_app_gui(App)
      ...
      label_ui.Text = "\textbf{" + mus1.CodeUtil.i18n("File name to search") + "}";

      % -----------------------------------------------------------------------
      column_grid = addVerticalGridLayout(main_vertical_container);

      App.SearchFileNameUI = mus1.AppUtil.Component.DropDown(column_grid);
      ...
      App.TopFolderUI = mus1.AppUtil.Component.DropDown(column_grid);
    ...
    function update_SearcherStatesFromUIComponents(App)
      ...
      if App.SearchFileNameUI.Value == ""
        ...
        App.CommandText = "mus1.SearchUtil.searchFiles(""" + App.SearchFileNameUI.Value + """, TopFolder=""" + top_folder + """)";
      end  % if
    end  % function
    ...
    function react_SearchButtonPushed(App)
      ...
      top_folder = replace(App.TopFolderUI.Value, " > ", filesep);
      App.SearchResult = mus1.SearchUtil.searchFiles(App.SearchFileNameUI.Value, TopFolder=top_folder);

      if isempty(App.SearchResult)
        uialert(App.Window.MainFigure, mus1.CodeUtil.i18n("File was not found."), mus1.CodeUtil.i18n("Not found"))

        return

      end  % if

      mus1.SearchUtil.FileSearchResultAppMain( ...

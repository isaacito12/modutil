classdef TextSearchAppMain < handle
  ...
  properties
    ...
    TextSearcher (1,1) mus1.SearchUtil.TextSearcher = mus1.SearchUtil.TextSearcher
    SearchResult table
    ...
    SearchTextUI mus1.AppUtil.Component.DropDown
    IgnoreCaseUI mus1.AppUtil.Component.CheckBox
    MatchWholeWordUI mus1.AppUtil.Component.CheckBox

    TargetFolderUI mus1.AppUtil.Component.DropDown
    IncludeSubfoldersUI mus1.AppUtil.Component.CheckBox
    SelectFolderUI mus1.AppUtil.Component.Button

    SelectAllUI mus1.AppUtil.Component.CheckBox
    Search_m_UI mus1.AppUtil.Component.CheckBox
    Search_md_UI mus1.AppUtil.Component.CheckBox
    Search_mdl_UI mus1.AppUtil.Component.CheckBox
    Search_ssc_UI mus1.AppUtil.Component.CheckBox
    Search_svg_UI mus1.AppUtil.Component.CheckBox
    CustomFileTypesUI mus1.AppUtil.Component.EditField

    % SpecifiedFileTypesUI is read-only.
    SpecifiedFileTypesUI mus1.AppUtil.Component.EditField

    ExcludeLiveScriptUI mus1.AppUtil.Component.CheckBox
    ExcludeMATLABCodeFileUI mus1.AppUtil.Component.CheckBox

    CopyCommandButtonUI mus1.AppUtil.Component.Button
    SearchButtonUI mus1.AppUtil.Component.Button
  ...
  properties (Constant, Access=private)
    ...
    width_name_ui = mus1.AppUtil.Constant.Width{"unitwidth"} * 18
    width_unit_ui = mus1.AppUtil.Constant.Width{"unitwidth"} * 8
    width_button = mus1.AppUtil.Constant.Width{"unitwidth"} * 12

    height_oneline = mus1.AppUtil.Constant.Height{"oneline"}
  ...
  methods
    ...
    function App = TextSearchAppMain(NameValuePair)
      ...
      App.Window.Name = mus1.CodeUtil.i18n("Text search");
      ...
      switch NameValuePair.StatesSource
        ...
        case "external"
          if not(isfield(NameValuePair, "SearchStates"))
            ...
            msg = mus1.CodeUtil.i18n("For external initial states, SearchStates must be specified.");
    ...
    function build_app_gui(App)
      ...
      label_ui.Text = "\textbf{" + mus1.CodeUtil.i18n("Text to search") + "}";

      App.IgnoreCaseUI = mus1.AppUtil.Component.CheckBox(addHorizontalGridLayout(horizontal_container, Width="fit"));
      App.IgnoreCaseUI.Text = mus1.CodeUtil.i18n("Ignore case");
      App.IgnoreCaseUI.ValueChangedCallback = @() update_SearcherStatesFromUIComponents(App);

      App.MatchWholeWordUI = mus1.AppUtil.Component.CheckBox(addHorizontalGridLayout(horizontal_container, Width="fit"));
      App.MatchWholeWordUI.Text = mus1.CodeUtil.i18n("Match whole word");
      App.MatchWholeWordUI.ValueChangedCallback = @() update_SearcherStatesFromUIComponents(App);

      % -----------------------------------------------------------------------
      column_grid = addVerticalGridLayout(main_vertical_container);

      App.SearchTextUI = mus1.AppUtil.Component.DropDown(column_grid);
      ...
      label_ui = mus1.AppUtil.Component.Label(row_grid);
      label_ui.ComponentWidth = App.width_name_ui;
      label_ui.Text = "\textbf{" + mus1.CodeUtil.i18n("Target folder") + "}";

      row_grid = addHorizontalGridLayout(horizontal_container, Width="fit");
      App.IncludeSubfoldersUI = mus1.AppUtil.Component.CheckBox(row_grid);
      App.IncludeSubfoldersUI.Text = mus1.CodeUtil.i18n("Include subfolders");
      App.IncludeSubfoldersUI.ValueChangedCallback = @() update_SearcherStatesFromUIComponents(App);

      row_grid = addHorizontalGridLayout(horizontal_container, Width="fit");
      App.SelectFolderUI = mus1.AppUtil.Component.Button(row_grid);
      App.SelectFolderUI.ButtonWidth = App.width_button;
      App.SelectFolderUI.Text = mus1.CodeUtil.i18n("Select...");
      App.SelectFolderUI.MainButton.Tooltip = mus1.CodeUtil.i18n("Select a target folder and add to the drop down.");
      App.SelectFolderUI.ButtonPushedCallback = @() react_SelectFolderButtonPushed(App);

      % -----------------------------------------------------------------------
      column_grid = addVerticalGridLayout(main_vertical_container);

      App.TargetFolderUI = mus1.AppUtil.Component.DropDown(column_grid);
      ...
      label_ui.Text = "\textbf{" + mus1.CodeUtil.i18n("File types") + "}";

      % -----------------------------------------------------------------------
      column_grid = addVerticalGridLayout(main_vertical_container);
      horizontal_container = mus1.AppUtil.HorizontalContainer(column_grid);

      App.SelectAllUI = mus1.AppUtil.Component.CheckBox(addHorizontalGridLayout(horizontal_container));
      App.SelectAllUI.Text = mus1.CodeUtil.i18n("Select all");
      App.SelectAllUI.ValueChangedCallback = @() react_SearchAllFileTypesCheckBox(App);

      App.Search_m_UI = mus1.AppUtil.Component.CheckBox(addHorizontalGridLayout(horizontal_container));
      App.Search_m_UI.Text = mus1.CodeUtil.i18n("*.m");
      App.Search_m_UI.MainCheckBox.Tooltip = mus1.CodeUtil.i18n("MATLAB files");
      App.Search_m_UI.ValueChangedCallback = @() update_FileTypes(App);

      App.Search_md_UI = mus1.AppUtil.Component.CheckBox(addHorizontalGridLayout(horizontal_container));
      App.Search_md_UI.Text = mus1.CodeUtil.i18n("*.md");
      App.Search_md_UI.MainCheckBox.Tooltip = mus1.CodeUtil.i18n("Markdown files");
      App.Search_md_UI.ValueChangedCallback = @() update_FileTypes(App);

      App.Search_mdl_UI = mus1.AppUtil.Component.CheckBox(addHorizontalGridLayout(horizontal_container));
      App.Search_mdl_UI.Text = mus1.CodeUtil.i18n("*.mdl");
      App.Search_mdl_UI.MainCheckBox.Tooltip = mus1.CodeUtil.i18n("Simulink model files");
      App.Search_mdl_UI.ValueChangedCallback = @() update_FileTypes(App);

      App.Search_ssc_UI = mus1.AppUtil.Component.CheckBox(addHorizontalGridLayout(horizontal_container));
      App.Search_ssc_UI.Text = mus1.CodeUtil.i18n("*.ssc");
      App.Search_ssc_UI.MainCheckBox.Tooltip = mus1.CodeUtil.i18n("Simscape source files");
      App.Search_ssc_UI.ValueChangedCallback = @() update_FileTypes(App);

      App.Search_svg_UI = mus1.AppUtil.Component.CheckBox(addHorizontalGridLayout(horizontal_container));
      App.Search_svg_UI.Text = mus1.CodeUtil.i18n("*.svg");
      App.Search_svg_UI.MainCheckBox.Tooltip = mus1.CodeUtil.i18n("Scalable vector graphics files");
      ...
      label_ui = mus1.AppUtil.Component.Label(addHorizontalGridLayout(horizontal_container, Width="fit"));
      label_ui.Text = mus1.CodeUtil.i18n("Custom file types");
      label_ui.ComponentWidth = App.width_name_ui;

      App.CustomFileTypesUI = mus1.AppUtil.Component.EditField(addHorizontalGridLayout(horizontal_container));
      App.CustomFileTypesUI.MainEditField.Tooltip = mus1.CodeUtil.i18n("Specify a comma-separated list of file types. Example: demo*.m, *.txt");
      ...
      label_ui = mus1.AppUtil.Component.Label(addHorizontalGridLayout(horizontal_container, Width="fit"));
      label_ui.Text = mus1.CodeUtil.i18n("Specified file types");
      label_ui.ComponentWidth = App.width_name_ui;

      App.SpecifiedFileTypesUI = mus1.AppUtil.Component.EditField(addHorizontalGridLayout(horizontal_container));
      ...
      App.ExcludeLiveScriptUI = mus1.AppUtil.Component.CheckBox(addHorizontalGridLayout(horizontal_container, Width="fit"));
      App.ExcludeLiveScriptUI.Text = mus1.CodeUtil.i18n("Exclude Live Script files from *.m");
      App.ExcludeLiveScriptUI.ValueChangedCallback = @() update_FileTypes(App);

      App.ExcludeMATLABCodeFileUI = mus1.AppUtil.Component.CheckBox(addHorizontalGridLayout(horizontal_container, Width="fit"));
      App.ExcludeMATLABCodeFileUI.Text = mus1.CodeUtil.i18n("Exclude MATLAB code files from *.m");
      ...
      App.CopyCommandButtonUI = mus1.AppUtil.Component.Button(addHorizontalGridLayout(horizontal_container));
      App.CopyCommandButtonUI.Text = mus1.CodeUtil.i18n("Copy command");
      App.CopyCommandButtonUI.MainButton.Tooltip = mus1.CodeUtil.i18n("Copy the search command to clipboard.");
      ...
      App.SearchButtonUI = mus1.AppUtil.Component.Button(addHorizontalGridLayout(horizontal_container));
      App.SearchButtonUI.Text = mus1.CodeUtil.i18n("Search");
    ...
    function update_SearcherStatesFromUIComponents(App)
      ...
      if not(ready(App.TextSearcher))
        ...
        App.CommandText = "mus1.SearchUtil.searchText(" + getCommandArgumentText(App.TextSearcher) + ")";
      end  % if
    end  % function
    ...
    function react_SearchButtonPushed(App)
      ...
      if isempty(App.SearchResult)
        uialert(App.MainFigure, mus1.CodeUtil.i18n("Nothing matched."), mus1.CodeUtil.i18n("No match"))

        return

      end  % if

      mus1.SearchUtil.TextSearchResultAppMain(App.TextSearcher, SearchResult=App.SearchResult)

classdef FolderSearchAppMain < handle
  ...
  properties
    ...
    TopFolderUI mus1.AppUtil.Component.DropDown
    SelectFolderUI mus1.AppUtil.Component.Button

    SearchFolderNameUI mus1.AppUtil.Component.DropDown
  ...
  methods
    ...
    function App = FolderSearchAppMain(NameValuePair)
      ...
      App.Window.Name = mus1.CodeUtil.i18n("Folder search");
    ...
    function build_app_gui(App)
      ...
      label_ui.Text = "\textbf{" + mus1.CodeUtil.i18n("Folder name to search") + "}";

      % -----------------------------------------------------------------------
      v_layout = addVerticalGridLayout(main_v_container);

      App.SearchFolderNameUI = mus1.AppUtil.Component.DropDown(v_layout);
      ...
      label_ui.Text = "\textbf{" + mus1.CodeUtil.i18n("Top folder") + "}";
      ...
      App.TopFolderUI = mus1.AppUtil.Component.DropDown(v_layout);
      ...
      App.CopyCommandButtonUI = mus1.AppUtil.Component.Button(addHorizontalGridLayout(h_container));
      ...
      App.SearchButtonUI = mus1.AppUtil.Component.Button(addHorizontalGridLayout(h_container));
    ...
    function update_SearcherStatesFromUIComponents(App)
      ...
      if App.SearchFolderNameUI.Value == ""
        ...
        App.CommandText = "mus1.SearchUtil.searchFolders(""" + App.SearchFolderNameUI.Value + """, TopFolder=""" + top_folder + """)";
      end  % if
    end  % function
    ...
    function react_SearchButtonPushed(App)
      ...
      top_folder = replace(App.TopFolderUI.Value, " > ", filesep);
      App.SearchResult = mus1.SearchUtil.searchFolders(App.SearchFolderNameUI.Value, TopFolder=top_folder);

      if isempty(App.SearchResult)
        uialert(App.Window.MainFigure, mus1.CodeUtil.i18n("Folder was not found."), mus1.CodeUtil.i18n("Not found"))

        return

      end  % if

      mus1.SearchUtil.FolderSearchResultAppMain( ...

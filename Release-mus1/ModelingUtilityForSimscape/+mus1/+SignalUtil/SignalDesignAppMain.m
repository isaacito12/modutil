classdef SignalDesignAppMain < handle
  ...
  properties
    ...
    MatrixTextUI mus1.AppUtil.Component.TextArea
    InterpUI mus1.AppUtil.Component.DropDown
    ExtrapUI mus1.AppUtil.Component.DropDown

    TableGridVectorUI mus1.AppUtil.Component.PhysicalValueWithUnitLabel
    TableValuesUI mus1.AppUtil.Component.PhysicalValueWithUnitLabel
    ...
    IntervalUI mus1.AppUtil.Component.PhysicalValueWithUnitLabel
    AutoRangeUI mus1.AppUtil.Component.CheckBox
    LowerUI mus1.AppUtil.Component.PhysicalValueWithUnitLabel
    UpperUI mus1.AppUtil.Component.PhysicalValueWithUnitLabel
  ...
  properties (Constant, Access=private)
    ...
    name_ui_width = mus1.AppUtil.Constant.Width{"unitwidth"} * 18
    unit_ui_width = mus1.AppUtil.Constant.Width{"unitwidth"} * 8
  ...
  methods
    ...
    function App = SignalDesignAppMain(NameValuePair)
      ...
      arguments (Output)
        App mus1.SignalUtil.SignalDesignAppMain
      end  % arguments
      ...
      App.Window.Name = mus1.CodeUtil.i18n("Signal Design App");
    ...
    function build_app_gui(App)
      ...
      html_file = "SignalDesignApp_Description_mus1.html";
      ...
      App.MatrixTextUI = mus1.AppUtil.Component.TextArea(left_column_grid);
      ...
      % -----------------------------------------------------------------------
      left_column_grid = addVerticalGridLayout(left_vertical_container);
      horizontal_container = mus1.AppUtil.HorizontalContainer(left_column_grid);
      ...
      App.InterpUI= mus1.AppUtil.Component.DropDown(row_grid);
      ...
      row_grid = addHorizontalGridLayout(horizontal_container);
      App.ExtrapUI= mus1.AppUtil.Component.DropDown(row_grid);
      ...
      % -----------------------------------------------------------------------
      left_column_grid = addVerticalGridLayout(left_vertical_container);
      App.TableGridVectorUI = mus1.AppUtil.Component.PhysicalValueWithUnitLabel(left_column_grid);
      ...
      % -----------------------------------------------------------------------
      left_column_grid = addVerticalGridLayout(left_vertical_container);
      App.TableValuesUI = mus1.AppUtil.Component.PhysicalValueWithUnitLabel(left_column_grid);
      ...
      % -----------------------------------------------------------------------
      right_column_grid = addVerticalGridLayout(right_vertical_container);
      App.IntervalUI = mus1.AppUtil.Component.PhysicalValueWithUnitLabel(right_column_grid);
      ...
      % -----------------------------------------------------------------------
      right_column_grid = addVerticalGridLayout(right_vertical_container);
      App.AutoRangeUI = mus1.AppUtil.Component.CheckBox(right_column_grid);
      ...
      % -----------------------------------------------------------------------
      right_column_grid = addVerticalGridLayout(right_vertical_container);
      App.LowerUI = mus1.AppUtil.Component.PhysicalValueWithUnitLabel(right_column_grid);
      ...
      % -----------------------------------------------------------------------
      right_column_grid = addVerticalGridLayout(right_vertical_container);
      App.UpperUI = mus1.AppUtil.Component.PhysicalValueWithUnitLabel(right_column_grid);
    ...
    function change_design_matrix(App)
      ...
      result = mus1.SignalUtil.getVectorsFromSignalDesignMatrix(design_matrix);

      App.TableGridVectorUI.ValueText = mus1.CodeUtil.stringify(result.X');
      App.TableValuesUI.ValueText = mus1.CodeUtil.stringify(result.F');
    ...
    function check_design_matrix(App)
      ...
      result = mus1.SignalUtil.checkSignalDesignMatrix(design_matrix);
    ...
    function getParam(App)
      ...
      try
        ...
        mus1.SignalUtil.getSignalDesignMatrixFromBlockDescription(block_path);
      catch exception
        % Restore the previous plot auto-update setting.
        App.UpdateButtonUI.CheckBoxUI.Value = previous_auto_plot_state;
        if App.Window.MainFigure.Visible
    ...
    function update_plot(App, NameValuePair)
      ...
      if App.AutoRangeUI.Value
        vec = mus1.CodeUtil.getNumberArrayFromText(App.TableGridVectorUI.ValueText);
        lb = vec(1);
        ub = vec(end);

classdef PhysicalUnitDropDown < mus1.AppUtil.Component.ComponentBase
  ...
  properties
    ...
    DropDownUI mus1.AppUtil.Component.DropDown
    ...
    ComponentWidth (1,:) {mus1.CodeUtil.mustBeTextOrPositiveNumber} = "1x"
  ...
  methods (Access=protected)
    ...
    function setup(component)
      ...
      component.DropDownUI = mus1.AppUtil.Component.DropDown(component.main_h_layout);
    ...
    function regular_update(component)
      ...
      % component.DropDownUI.DropDownHeight = mus1.AppUtil.Constant.Height{"oneline+"} - 2;

      if component.HighlightBackground
        component.DropDownUI.HighlightBackground = "on";
        if component.Reporting
          mus1.FileUtil.displayTimeAndFileLocation("2:ThemeNameForBackGroundHighlight=" + component.ThemeNameForBackGroundHighlight)
        end  % if
  ...
  methods
    ...
    function set.UnitItems(component, NewUnitItems)
      ...
      arguments (Input)
        component
        NewUnitItems (1,:) string %{ mus1.CodeUtil.mustBeAllCommensurateUnit }
      end  % arguments
      if component.Reporting
        mus1.FileUtil.displayTimeAndFileLocation("1")
      end  % if
      ...
      if component.UnitSpecified
        ...
        msg = mus1.CodeUtil.i18n("UnitItems can be defined only once.");
      ...
      try
        mus1.CodeUtil.mustBePhysicalUnit(NewUnitItems)
        mus1.CodeUtil.mustBeAllCommensurateUnit(NewUnitItems)
      catch exception
        ...
        if main_figure.Visible
          ...
          if component.Reporting
            mus1.FileUtil.displayTimeAndFileLocation("3")
          end  % if
    ...
    function set.UnitText(component, NewUnitText)
      ...
      if component.Editable
        ...
        try
          mus1.CodeUtil.mustBePhysicalUnit(NewUnitText)
        catch exception
        ...
        if component.UnitSpecified
          if not(simscape.isCommensurateUnit(NewUnitText, current_unit_items{:}))
            ...
            msg = mus1.CodeUtil.i18n("New unit must be commensurate with the defined units.");
            main_figure = ancestor(component, "figure");
            if main_figure.Visible
              window_title = mus1.CodeUtil.i18n("Error");
              uialert(main_figure, msg, window_title)
          ...
          if not(ismember(NewUnitText, current_unit_items))
            if component.Reporting
              mus1.FileUtil.displayTimeAndFileLocation("2:add:" + NewUnitText)
            end  % if
          ...
          if component.Reporting
            mus1.FileUtil.displayTimeAndFileLocation("3:new:" + NewUnitText)
          end  % if
        ...
        if not(component.UnitSpecified)
          msg = mus1.CodeUtil.i18n("UnitItems must be defined before assigning a value to UnitText.");
          main_figure = ancestor(component, "figure");
          if main_figure.Visible
            window_title = mus1.CodeUtil.i18n("Error");
            uialert(main_figure, msg, window_title)
        ...
        if not(ismember(NewUnitText, current_unit_items))
          ...
          if not(match_found)
            msg = mus1.CodeUtil.i18n("UnitText must be one of UnitItems: ") + NewUnitText;
            main_figure = ancestor(component, "figure");
            if main_figure.Visible
              window_title = mus1.CodeUtil.i18n("Error");
              uialert(main_figure, msg, window_title)

classdef PhysicalValueWithUnitDropDown < mus1.AppUtil.Component.ComponentBase
  ...
  % Physical units are selectable from a read-only or editable drop-down list.
  ...
  properties
    ...
    physical_value mus1.CodeUtil.PhysicalValue
  ...
  properties
    ComponentHeight (1,:) {mus1.CodeUtil.mustBeTextOrPositiveNumber} = mus1.AppUtil.Constant.Height{"oneline++"}

    NameUIWidth (1,:) {mus1.CodeUtil.mustBeTextOrPositiveNumber} = mus1.AppUtil.Constant.Width{"unitwidth"} * 14
    AlertUIWidth (1,:) {mus1.CodeUtil.mustBeTextOrPositiveNumber} = 30
    ValueUIWidth (1,:) {mus1.CodeUtil.mustBeTextOrPositiveNumber} = "1x"
    InfoUIWidth (1,:) {mus1.CodeUtil.mustBeTextOrPositiveNumber} = mus1.AppUtil.Constant.Width{"unitwidth"} * 10
    UnitUIWidth (1,:) {mus1.CodeUtil.mustBeTextOrPositiveNumber} = mus1.AppUtil.Constant.Width{"unitwidth"} * 10

    NameUI mus1.AppUtil.Component.Label
    AlertUI mus1.AppUtil.Graphics.Image
    ValueTextUI mus1.AppUtil.Component.EditField
    InfoUI mus1.AppUtil.Component.EditField
    UnitDropDownUI mus1.AppUtil.Component.PhysicalUnitDropDown

    Editable (1,1) matlab.lang.OnOffSwitchState = "off"

    ValueChangedCallback {mus1.CodeUtil.mustBeFunctionHandleOrEmpty} = []
    UnitChangedCallback {mus1.CodeUtil.mustBeFunctionHandleOrEmpty} = []
  end  % properties
  properties

    main_h_container mus1.AppUtil.HorizontalContainer
  ...
  methods (Access=protected)
    ...
    function setup(component)
      ...
      component.physical_value = mus1.CodeUtil.PhysicalValue;

      component.main_h_container = mus1.AppUtil.HorizontalContainer(component.main_grid);
      ...
      component.NameUI = mus1.AppUtil.Component.Label(component.name_layout);
      component.NameUI.ComponentHeight = component.ComponentHeight;
      component.NameUI.ComponentWidth = component.NameUIWidth;
      component.NameUI.Text = mus1.CodeUtil.i18n("Physical value");
      ...
      component.AlertUI = mus1.AppUtil.Graphics.Image(component.alert_layout);
      ...
      component.ValueTextUI = mus1.AppUtil.Component.EditField(component.value_layout);
      ...
      component.InfoUI = mus1.AppUtil.Component.EditField(component.info_layout);
      ...
      component.UnitDropDownUI = mus1.AppUtil.Component.PhysicalUnitDropDown(component.unit_layout);
  ...
  methods
    ...
    function set.SimscapeValue(component, x)
      ...
      component.ValueText = mus1.CodeUtil.stringify(value(x));
    ...
    function set.ValueText(component, str)
      ...
      try
        ...
        if isempty(main_fig)
          ...
          component.AlertUI.MainImage.Tooltip = msg + mus1.CodeUtil.i18n(" (Click the icon to copy the message to clipboard.)");
  ...
  methods
    ...
    function updateInfoAndUnitUIs(component)
      ...
      squashed_value_text = mus1.CodeUtil.squashCodeText(mus1.CodeUtil.stringify(value(sscval)));
      ...
      if component.physical_value.ValueTextIsSimscapeValue
        ...
        squashed_current_value_text = mus1.CodeUtil.squashCodeText(component.ValueTextUI.MainEditField.Value);
    ...
    function set.UnitItems(component, NewUnitItems)
      ...
      try
        if component.Reporting
          mus1.FileUtil.displayTimeAndFileLocation("2:UnitDropDownUI.UnitItems")
        end  % if
        component.UnitDropDownUI.UnitItems = NewUnitItems;        
      catch exception
        if component.Reporting
          mus1.FileUtil.displayTimeAndFileLocation("3:exception:" + exception.message)
        end  % if
    ...
    function set.UnitText(component, NewUnitText)
      ...
      if not(component.initialized)
        ...
        if component.Reporting
          mus1.FileUtil.displayTimeAndFileLocation("2:reset")
        end  % if
        component.physical_value.initialized = false;
      end  % if
      try
        if component.Reporting
          mus1.FileUtil.displayTimeAndFileLocation("3:UnitDropDownUI.UnitText:" + NewUnitText)
        end  % if
        component.UnitDropDownUI.UnitText = NewUnitText;
      catch exception
        if component.Reporting
          mus1.FileUtil.displayTimeAndFileLocation("5:exception:" + exception.message)
        end  % if
      ...
      if component.Reporting
        mus1.FileUtil.displayTimeAndFileLocation("6")
      end  % if
      component.AlertUI.MainImage.Visible = "off";
      component.AlertUI.MainImage.Tooltip = "";

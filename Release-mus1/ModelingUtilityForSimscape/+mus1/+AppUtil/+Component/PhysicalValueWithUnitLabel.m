classdef PhysicalValueWithUnitLabel < mus1.AppUtil.Component.ComponentBase
  ...
  properties
    ...
    physical_value mus1.CodeUtil.PhysicalValue % = mus1.CodeUtil.PhysicalValue
  ...
  properties
    ...
    UnitLabelUI mus1.AppUtil.Component.PhysicalUnitLabel
  ...
  methods (Access=protected)
    ...
    function setup(component)
      ...
      component.UnitLabelUI = mus1.AppUtil.Component.PhysicalUnitLabel(component.unit_layout);
  ...
  methods
    ...
    function set.UnitText(component, NewUnitText)
      ...
      try
        if component.Reporting
          mus1.FileUtil.displayTimeAndFileLocation("3:UnitLabelUI.UnitText:" + NewUnitText)
        end  % if
    ...
    function set.UnitAlias(component, NewUnitAlias)
      ...
      if component.Reporting
        mus1.FileUtil.displayTimeAndFileLocation("3:UnitLabelUI.UnitAlias:" + NewUnitAlias)
      end  % if

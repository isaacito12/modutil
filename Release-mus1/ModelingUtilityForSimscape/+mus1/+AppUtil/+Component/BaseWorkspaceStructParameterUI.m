classdef BaseWorkspaceStructParameterUI < mus1.AppUtil.Component.ComponentBase
  ...
  properties
    ...
    GetParametersFromBaseWorkspaceCallback (:,1) {mus1.CodeUtil.mustBeFunctionHandleOrEmpty}
    ...
    ParameterFileTextUI mus1.AppUtil.Component.Label
    ParameterFileDropDownUI mus1.AppUtil.Component.DropDown
    SelecFileButtonUI mus1.AppUtil.Component.Button
    EditFileButtonUI mus1.AppUtil.Component.Button

    % For the "Variable name" row
    StructNameRow matlab.ui.container.GridLayout
    StructNameTextUI mus1.AppUtil.Component.Label
    StructNameDropDownUI mus1.AppUtil.Component.DropDown
    GetParametersFromBaseWorkspaceUI mus1.AppUtil.Component.Button
    OpenVariablesEditorButtonUI mus1.AppUtil.Component.Button
  ...
  methods
    ...
    function callback_select_and_load_parameter_file(component, NameValuePair)
      ...
      if NameValuePair.ParameterFileFullPath ~= ""
        ...
        if not(isfile(component.ParameterFileFullPath))
          ...
          msg = mus1.CodeUtil.i18n("Invalid file was specified: ") + NameValuePair.ParameterFileFullPath;
      ...
      if component.Reporting
        mus1.FileUtil.displayTimeAndFileLocation("FileDropDownUI.Value: " + component.ParameterFileDropDownUI.Value)
      end  % if
    end  % function
    ...
    function set.ParameterFileFullPath(component, ParameterFilePath)
      ...
      if not(isfile(ParameterFilePath))
        ...
        msg = mus1.CodeUtil.i18n("Invalid parameter file: ") + ParameterFilePath;
    ...
    function callback_change_structname_dropdown(component)
      %%
      if component.Reporting
        mus1.FileUtil.displayTimeAndFileLocation("1")
      end  % if
      ...
      try
        ...
        msg = mus1.CodeUtil.i18n("Evaluation failed: ") + selected_struct_name + newline + exception.message;
      ...
      if component.Reporting
        mus1.FileUtil.displayTimeAndFileLocation("2")
      end  % if
    end  % function
  ...
  methods (Access=protected)
    ...
    function setup(component)
      ...
      component.ParameterFileTextUI = mus1.AppUtil.Component.Label(component.ParameterFileRow);
      component.ParameterFileTextUI.Layout.Row = 1;
      component.ParameterFileTextUI.Layout.Column = 1;
      component.ParameterFileTextUI.Text = mus1.CodeUtil.i18n("Parameter file");
      component.ParameterFileTextUI.ComponentWidth = component.NameUIWidth;

      component.ParameterFileDropDownUI = mus1.AppUtil.Component.DropDown(component.ParameterFileRow);
      ...
      component.SelecFileButtonUI = mus1.AppUtil.Component.Button(component.ParameterFileRow);
      ...
      component.SelecFileButtonUI.Text = mus1.CodeUtil.i18n("Select file...");
      ...
      component.SelecFileButtonUI.MainButton.Tooltip = ...
        mus1.CodeUtil.i18n("Select an M file containing parameters in a struct. The file is evaluated when selected.");

      component.EditFileButtonUI = mus1.AppUtil.Component.Button(component.ParameterFileRow);
      ...
      component.EditFileButtonUI.Text = mus1.CodeUtil.i18n("Edit");
      component.EditFileButtonUI.MainButton.Enable = "off";
      component.EditFileButtonUI.ButtonPushedCallback = @() edit(replace(component.ParameterFileDropDownUI.Value, " > ", filesep));
      component.EditFileButtonUI.MainButton.Tooltip = mus1.CodeUtil.i18n("Edit the selected file.");
      ...
      component.StructNameTextUI = mus1.AppUtil.Component.Label(component.StructNameRow);
      ...
      component.StructNameTextUI.Text = mus1.CodeUtil.i18n("Variable name");

      component.StructNameDropDownUI = mus1.AppUtil.Component.DropDown(component.StructNameRow);
      ...
      component.StructNameDropDownUI.MainDropDown.Tooltip = ...
        mus1.CodeUtil.i18n("Specify a struct or a class object in the base workspace." + ...
        " To load a struct or a class object, the struct fields or the class properties must match the app's definitions.");

      component.GetParametersFromBaseWorkspaceUI = mus1.AppUtil.Component.Button(component.StructNameRow);
      ...
      component.GetParametersFromBaseWorkspaceUI.Text = mus1.CodeUtil.i18n("Get");
      ...
      component.GetParametersFromBaseWorkspaceUI.MainButton.Tooltip = ...
        mus1.CodeUtil.i18n("Get parameters from the specified struct in the base workspace and load to the app.");

      component.OpenVariablesEditorButtonUI = mus1.AppUtil.Component.Button(component.StructNameRow);
      ...
      component.OpenVariablesEditorButtonUI.Text = mus1.CodeUtil.i18n("Open");
      component.OpenVariablesEditorButtonUI.MainButton.Enable = "off";
      component.OpenVariablesEditorButtonUI.ButtonPushedCallback = @() openvar(component.StructNameDropDownUI.Value);
      component.OpenVariablesEditorButtonUI.MainButton.Tooltip = mus1.CodeUtil.i18n("Open the Variables Editor.");

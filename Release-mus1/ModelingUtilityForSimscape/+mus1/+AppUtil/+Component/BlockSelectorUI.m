classdef BlockSelectorUI < mus1.AppUtil.Component.ComponentBase
  ...
  properties
    ...
    %
    % mus1.AppUtil.Utility.find1DLookupTableBlocks function can be used for FindBlockCallback.
    % It adds Simulink 1-D Lookup Table blocks in the Block Path drop down.
    FindBlockCallback {mus1.CodeUtil.mustBeFunctionHandleOrEmpty}
    ...
    SetParametersToBlockCallback (:,1) {mus1.CodeUtil.mustBeFunctionHandleOrEmpty}

    GetParametersFromBlockCallback (:,1) {mus1.CodeUtil.mustBeFunctionHandleOrEmpty}
    ...
    NameUIWidth (1,1) {mustBeInteger, mustBePositive} = mus1.AppUtil.Constant.Width{"unitwidth"} * 14

    ButtonUIWidth (1,1) {mustBeInteger, mustBePositive} = mus1.AppUtil.Constant.Width{"unitwidth"} * 12
    MainButtonWidth (1,1) {mustBeInteger, mustBePositive} = mus1.AppUtil.Constant.Width{"unitwidth"} * 11
    ...
    ModelFileTextUI mus1.AppUtil.Component.Label
    ModelFileDropDownUI mus1.AppUtil.Component.DropDown
    OpenModelUI mus1.AppUtil.Component.Button

    % For the "Block path"
    BlockRow matlab.ui.container.GridLayout
    BlockPathTextUI mus1.AppUtil.Component.Label
    BlockPathDropDownUI mus1.AppUtil.Component.DropDown
    HilitBlockUI mus1.AppUtil.Component.StateButton
    GetParametersFromBlockUI mus1.AppUtil.Component.Button
    SetParametersToBlockUI mus1.AppUtil.Component.Button
  ...
  properties (Constant, Access=private)
    ...
    common_ui_height = mus1.AppUtil.Constant.Height{"oneline++"}

    % unit_ui_width = mus1.AppUtil.Constant.Width{"unitwidth"}
  ...
  methods
    ...
    function set.ModelFileFullPath(component, ModelFilePath)
      ...
      if component.Reporting
        mus1.FileUtil.displayTimeAndFileLocation()
      end  % if
      ...
      if not(isfile(ModelFilePath))
        ...
        msg = mus1.CodeUtil.i18n("Invalid model file: ") + ModelFilePath;
    ...
    function set.BlockPath(component, block_path)
      ...
      if not(any(component.BlockPathDropDownUI.Items == styled_block_path))
        ...
        msg = mus1.CodeUtil.i18n("Specified block path is not in the block path drop down items: ") + block_path;
    ...
    function callback_change_modelfile_dropdown(component)
      ...
      if component.Reporting
        mus1.FileUtil.displayTimeAndFileLocation(pwd)
      end  % if
      ...
      if component.TargetSimscapeBlockNames == ""
        ...
        try
          result_table = mus1.ModelUtil.findAllSimscapeBlocks(component.ModelName);
        catch exception
          if component.MainFigure.Visible
      ...
      if not(isempty(component.FindBlockCallback)) && isa(component.FindBlockCallback, 'function_handle')
        ...
        if not(iscolumn(block_paths_from_callback) && class(block_paths_from_callback) == "string")
          msg = mus1.CodeUtil.i18n("FindBlockCallback must return a scalar or a column vector containing block paths as string.");
          if component.MainFigure.Visible
            title_word = mus1.CodeUtil.i18n("Error");
            uialert(component.MainFigure, msg, title_word)
      ...
      if num_blocks == 0
        msg = mus1.CodeUtil.i18n("Block was not found: ") + component.TargetSimscapeBlockNames;
        if component.MainFigure.Visible
          title_word = mus1.CodeUtil.i18n("Error");
          uialert(component.MainFigure, msg, title_word)
    ...
    function subcallback_make_block_path_ready(component)
      ...
      if component.BlockPathDropDownUI.Value == ""
        ...
        msg = mus1.CodeUtil.i18n("BlockPath must be specified.");
    ...
    function callback_open_model(component, NameValuePair)
      ...
      if NameValuePair.ModelFileFullPath ~= ""
        ...
        if not(isfile(component.ModelFileFullPath))
          ...
          msg = mus1.CodeUtil.i18n("Invalid file was specified: ") + NameValuePair.ModelFileFullPath;
      ...
      if component.Reporting
        mus1.FileUtil.displayTimeAndFileLocation("ModelFileDropDownUI.Value: " + component.ModelFileDropDownUI.Value)
      end  % if
    end  % function
    ...
    function callback_change_blockpath_dropdown(component)
      %%
      if component.Reporting
        mus1.FileUtil.displayTimeAndFileLocation("Start")
      end  % if

      if component.ModelFileDropDownUI.Value == ""
        if component.Reporting
          mus1.FileUtil.displayTimeAndFileLocation("Selected empty model file.")
        end  % if
      ...
      if getSimulinkBlockHandle(block_path) <= 0
        msg = mus1.CodeUtil.i18n("Block was not found: " + block_path);
        title_word = mus1.CodeUtil.i18n("Error");
        uialert(component.MainFigure, msg, title_word)
      ...
      if component.Reporting
        mus1.FileUtil.displayTimeAndFileLocation("End")
      end  % if
    end  % function
    ...
    function callback_hilit(component)
      ...
      if component.ModelFileDropDownUI.Value == ""
        ...
        msg = mus1.CodeUtil.i18n("To highlight a block, model file must be non-empty.");
      ...
      if selected_block_display_path == ""
        id = component.errorID + "InvalidBlockPath";
        msg = mus1.CodeUtil.i18n("To highlight a block, block path must be non-empty.");
      ...
      if component.HilitBlockUI.Value
        ...
        if component.Reporting
          mus1.FileUtil.displayTimeAndFileLocation("Hilit")
        end  % if
        ...
        if getSimulinkBlockHandle(block_path) <= 0
          ...
          msg = mus1.CodeUtil.i18n("Specified block is invalid: " + block_path);
  ...
  methods (Access=protected)
    ...
    function setup(component)
      %%
      setup@mus1.AppUtil.Component.ComponentBase(component)
      ...
      component.ModelFileTextUI = mus1.AppUtil.Component.Label(component.ModelRow);
      component.ModelFileTextUI.Layout.Row = 1;
      component.ModelFileTextUI.Layout.Column = 1;
      component.ModelFileTextUI.Text = mus1.CodeUtil.i18n("Model file");
      component.ModelFileTextUI.ComponentWidth = component.NameUIWidth;

      component.ModelFileDropDownUI = mus1.AppUtil.Component.DropDown(component.ModelRow);
      ...
      component.OpenModelUI = mus1.AppUtil.Component.Button(component.ModelRow);
      ...
      component.OpenModelUI.Text = mus1.CodeUtil.i18n("Open model...");
      ...
      component.BlockPathTextUI = mus1.AppUtil.Component.Label(component.BlockRow);
      ...
      component.BlockPathTextUI.Text = mus1.CodeUtil.i18n("Block path");

      component.BlockPathDropDownUI = mus1.AppUtil.Component.DropDown(component.BlockRow);
      ...
      component.HilitBlockUI = mus1.AppUtil.Component.StateButton(component.BlockRow);
      ...
      component.HilitBlockUI.Text = mus1.CodeUtil.i18n("Highlight");
      component.HilitBlockUI.MainButton.Icon = fullfile(matlabroot, "toolbox", "matlab", "icons", "demoicon.gif");
      component.HilitBlockUI.MainButton.Tooltip = mus1.CodeUtil.i18n("Open the model, and highlight or dehighlight the selected block.");
      component.HilitBlockUI.MainButton.Enable = "off";
      component.HilitBlockUI.ValueChangedCallback = @() callback_hilit(component);

      component.GetParametersFromBlockUI = mus1.AppUtil.Component.Button(component.BlockRow);
      ...
      component.GetParametersFromBlockUI.Text = mus1.CodeUtil.i18n("Get");
      component.GetParametersFromBlockUI.MainButton.Icon = fullfile(matlabroot, "toolbox", "matlab", "icons", "greencircleicon.gif");
      component.GetParametersFromBlockUI.MainButton.Tooltip = mus1.CodeUtil.i18n("Get parameters from the selected block.");
      component.GetParametersFromBlockUI.MainButton.Enable = "off";
      component.GetParametersFromBlockUI.ButtonPushedCallback = @() callback_get_parameters(component);

      component.SetParametersToBlockUI = mus1.AppUtil.Component.Button(component.BlockRow);
      ...
      component.SetParametersToBlockUI.Text = mus1.CodeUtil.i18n("Set");
      component.SetParametersToBlockUI.MainButton.Icon = fullfile(matlabroot, "toolbox", "matlab", "icons", "greenarrowicon.gif");
      component.SetParametersToBlockUI.MainButton.Tooltip = mus1.CodeUtil.i18n("Set parameters to the selected block.");
      component.SetParametersToBlockUI.MainButton.Enable = "off";
    ...
    function update(component)
      %%
      update@mus1.AppUtil.Component.ComponentBase(component)
    ...
    function regular_update(component)
      %%
      if component.Reporting
        mus1.FileUtil.displayTimeAndFileLocation("regular update")
      end  % if
      ...
      if component.AutoGet
        component.GetParametersFromBlockUI.MainButton.Enable = "off";
        component.GetParametersFromBlockUI.MainButton.Tooltip = mus1.CodeUtil.i18n("Auto-get is enabled.");
      end  % if
    end  % function
    ...
    function first_update(component)
      ...
      if component.Reporting
        mus1.FileUtil.displayTimeAndFileLocation("first update")
      end  % if

      if component.GetOnly && component.SetOnly
        id = component.errorID + "InvalidButtonSetting";
        msg = mus1.CodeUtil.i18n("GetOnly and SetOnly options cannot be true at the same time.");

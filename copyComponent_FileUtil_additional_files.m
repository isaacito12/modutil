function copyComponent_FileUtil_additional_files(NameValuePair)
...
source_folder = fullfile(repo_top_folder, "Devel", "FileUtil");
...
file_to_copy = fullfile(source_folder, "FileListApp.m");
safe_copyfile(file_to_copy, destination_top_folder, NameValuePair.DryRun)

% -----------------------------------------------------------------------------
% Copy screenshot images to the media folder.
safe_mkdir(fullfile(destination_top_folder, "media"), NameValuePair.DryRun)

file_to_copy = fullfile(source_folder, "screenshot-FileListApp-24b-1.png");
safe_copyfile(file_to_copy, fullfile(destination_top_folder, "media"), NameValuePair.DryRun)
